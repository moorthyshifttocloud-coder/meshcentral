...
module.exports.CreateAmtScriptEngine = function () {
  ...
  o.script_blocksToScript = function (script_BuildingBlocks, script_BlockScript) {
    ...
    if (script_BuildingBlocks) {
      if (script_BuildingBlocks['_start']) {
      ...
      for (var i in script_BlockScript) {
        ...
        for (var j in script_BlockScript[i]['vars']) {
          code = code.split('%%%' + j + '%%%').join(script_BlockScript[i]['vars'][j]['value']);
        }
        script +=
          '##### Block: ' +
          script_BlockScript[i]['name'] +
          ' #####\r\nHighlightBlock __t ' +
          i +
          '\r\n' +
          code +
