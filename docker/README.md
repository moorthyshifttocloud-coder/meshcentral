...
And if you ever change the port on which MeshCentral _INTERNALLY_ runs on please also change the healthcheck either in your compose or self-compiled Dockerfile.<br>
