...
try {
  ...
  console.log('Missing module "minimist", type "npm install minimist" to install it.');
  return;
}
try {
  require('ws');
} catch (ex) {
  console.log('Missing module "ws", type "npm install ws" to install it.');
  return;
}
...
if (args.proxy != null) {
  try {
    ...
    console.log('Missing module "https-proxy-agent", type "npm install https-proxy-agent" to install it.');
    return;
  }
}
...
if (args['_'].length == 0) {
  ...
  console.log(
    '  GroupToast                  - Display a toast notification on remote devices in a specific device group.'
  );
  ...
  if (possibleCommands.indexOf(settings.cmd) == -1 && settings.cmd != 'help') {
    console.log('Invalid command. Possible commands are: ' + possibleCommands.join(', ') + '.');
    return;
  }
  ...
  switch (settings.cmd) {
    case 'config': {
      performConfigOperations(args);
      return;
    }
    case 'indexagenterrorlog': {
      indexAgentErrorLog();
      return;
    }
    case 'serverinfo': {
    ...
    case 'editdevice': {
      if (args.id == null) {
        console.log(winRemoveSingleQuotes("Missing device id, use --id '[deviceid]'"));
      } else {
        ok = true;
      }
      break;
    ...
    case 'addlocaldevice': {
      if (args.id == null) {
        console.log(winRemoveSingleQuotes("Missing device id, use --id '[deviceid]'"));
      } else if (args.devicename == null) {
        console.log(winRemoveSingleQuotes('Missing devicename, use --devicename [devicename]'));
      } else if (args.hostname == null) {
        console.log(winRemoveSingleQuotes('Missing hostname, use --hostname [hostname]'));
      } else {
        ok = true;
      }
      break;
    ...
    case 'addamtdevice': {
      if (args.id == null) {
        ...
        console.log(winRemoveSingleQuotes('Missing user, use --user [user]'));
      } else if (args.pass == null) {
        console.log(winRemoveSingleQuotes('Missing pass, use --pass [pass]'));
      } else {
        ok = true;
      }
      break;
    ...
    case 'addusertodevicegroup': {
      if (args.id == null && args.group == null) {
        console.log(
          winRemoveSingleQuotes("Device group identifier missing, use --id '[groupid]' or --group [groupname]")
        );
      } else if (args.userid == null) {
        console.log('Add user to group missing useid, use --userid [userid]');
      } else {
        ok = true;
      }
      break;
    ...
    case 'removeuserfromdevicegroup': {
      if (args.id == null && args.group == null) {
        ...
        console.log('Remove user from group missing useid, use --userid [userid]');
      } else {
        ok = true;
      }
      break;
    ...
    case 'addusertodevice': {
      if (args.userid == null) {
        console.log('Add user to device missing userid, use --userid [userid]');
      } else if (args.id == null) {
        console.log(winRemoveSingleQuotes("Add user to device missing device id, use --id '[deviceid]'"));
      } else {
        ok = true;
      }
      break;
    ...
    case 'removeuserfromdevice': {
      if (args.userid == null) {
        console.log('Remove user from device missing userid, use --userid [userid]');
      } else if (args.id == null) {
        console.log(winRemoveSingleQuotes("Remove user from device missing device id, use --id '[deviceid]'"));
      } else {
        ok = true;
      }
      break;
    ...
    case 'adddevicegroup': {
      if (args.name == null) {
        console.log('Message group name, use --name [name]');
      } else {
        ok = true;
      }
      break;
    ...
    case 'movetodevicegroup': {
      ...
      } else if (args.devid == null) {
        console.log(winRemoveSingleQuotes("Device identifier missing, use --devid '[deviceid]'"));
      } else {
        ok = true;
      }
      break;
    ...
    case 'broadcast': {
      if (args.msg == null) {
        console.log('Message missing, use --msg [message]');
      } else {
        ok = true;
      }
      break;
    ...
    case 'adduser': {
      if (args.user == null) {
        console.log('New account name missing, use --user [name]');
      } else if (args.pass == null && args.randompass == null) {
        console.log('New account password missing, use --pass [password] or --randompass');
      } else {
        ok = true;
      }
      break;
    ...
    case 'edituser': {
      if (args.userid == null) {
        console.log('Edit account user missing, use --userid [id]');
      } else {
        ok = true;
      }
      break;
    ...
    case 'removeuser': {
      if (args.userid == null) {
        console.log('Remove account userid missing, use --userid [id]');
      } else {
        ok = true;
      }
      break;
    ...
    case 'addusergroup': {
      if (args.name == null) {
        console.log('New user group name missing, use --name [name]');
      } else {
        ok = true;
      }
      break;
    ...
    case 'removeusergroup': {
      if (args.groupid == null) {
        console.log(winRemoveSingleQuotes("Remove user group id missing, use --groupid '[id]'"));
      } else {
        ok = true;
      }
      break;
    ...
    case 'addtousergroup': {
      if (args.groupid == null) {
        console.log(winRemoveSingleQuotes("Group id missing, use --groupid '[id]'"));
      }
      if (args.id == null) {
        console.log(winRemoveSingleQuotes('Missing identifier to add, use --id [id]'));
      } else {
        ok = true;
      }
      break;
    ...
    case 'removefromusergroup': {
      ...
      if (args.id == null) {
        console.log(winRemoveSingleQuotes('Missing identifier to remove, use --id [id]'));
      } else {
        ok = true;
      }
      break;
    ...
    case 'sendinviteemail': {
      if (args.id == null && args.group == null) {
        console.log("Device group identifier missing, use --id '[groupid]' or --group [groupname]");
      } else if (args.email == null) {
        console.log('Device email is missing, use --email [email]');
      } else {
        ok = true;
      }
      break;
    ...
    case 'generateinvitelink': {
      if (args.id == null && args.group == null) {
        ...
        console.log('Invitation validity period missing, use --hours [hours]');
      } else {
        ok = true;
      }
      break;
    ...
    case 'runcommand': {
      if (args.id == null) {
        ...
        console.log('Missing run, use --run "command"');
      } else {
        ok = true;
      }
      break;
    ...
    case 'devicesharing': {
      if (args.id == null) {
        console.log(winRemoveSingleQuotes("Missing device id, use --id '[deviceid]'"));
      } else if (args.daily != null && args.weekly != null) {
        console.log(winRemoveSingleQuotes("Can't specify both --daily and --weekly at the same time."));
      } else {
        ok = true;
      }
      break;
    ...
    case 'agentdownload': {
      if (args.type == null) {
        console.log(winRemoveSingleQuotes('Missing device type, use --type [agenttype]'));
      } else if (
        parseInt(args.type) == null ||
        isNaN(parseInt(args.type)) ||
        parseInt(args.type) < 1 ||
        parseInt(args.type) > 11000
      ) {
        console.log(winRemoveSingleQuotes('Invalid agent type, must be a number.'));
      } else if (args.id == null) {
        console.log(winRemoveSingleQuotes("Missing device id, use --id '[meshid]'"));
      } else if (typeof args.id != 'string' || args.id.length != 64) {
        console.log(winRemoveSingleQuotes('Invalid meshid.'));
      } else {
        ok = true;
      }
      break;
    ...
    case 'upload': {
      if (args.id == null) {
        ...
        console.log('Local file missing, use --file [file] specify the file to upload');
      } else if (args.target == null) {
        console.log('Remote target path missing, use --target [path] to specify the remote location');
      } else if (require('fs').existsSync(args.file) == false) {
        console.log('Local file does not exists, check --file');
      } else {
        ok = true;
      }
      break;
    ...
    case 'download': {
      if (args.id == null) {
        ...
        console.log('Remote file missing, use --file [file] specify the remote file to download');
      } else if (args.target == null) {
        console.log('Target path missing, use --target [path] to specify the local download location');
      } else {
        ok = true;
      }
      break;
    ...
    case 'webrelay': {
      if (args.id == null) {
        ...
        console.log(winRemoveSingleQuotes('Missing protocol type, use --type [http,https]'));
      } else {
        ok = true;
      }
      break;
    ...
    case 'deviceopenurl': {
      if (args.id == null) {
        console.log(winRemoveSingleQuotes("Missing device id, use --id '[deviceid]'"));
      } else if (args.openurl == null) {
        console.log('Remote URL, use --openurl [url] specify the link to open.');
      } else {
        ok = true;
      }
      break;
    ...
    case 'devicemessage': {
      if (args.id == null) {
        console.log(winRemoveSingleQuotes("Missing device id, use --id '[deviceid]'"));
      } else if (args.msg == null) {
        console.log('Remote message, use --msg "[message]" specify a remote message.');
      } else {
        ok = true;
      }
      break;
    ...
    case 'groupmessage': {
      if (args.id == null) {
        console.log(winRemoveSingleQuotes("Missing device group id, use --id '[devicegroupid]'"));
      } else if (args.msg == null) {
        console.log('Remote message, use --msg "[message]" specify a remote message.');
      } else {
        ok = true;
    ...
    case 'report': {
      if (args.type == null) {
        console.log(winRemoveSingleQuotes("Missing report type, use --type '[reporttype]'"));
      } else {
        ok = true;
      }
      break;
    ...
    case 'help': {
      if (args['_'].length < 2) {
        ...
        switch (args['_'][1].toLowerCase()) {
          ...
          case 'sendinviteemail': {
            console.log(
              'Send invitation email with instructions on how to install the mesh agent for a specific device group. Example usage:\r\n'
            );
            console.log(
              winRemoveSingleQuotes(
                '  MeshCtrl SendInviteEmail --id \'groupid\' --message "msg" --email user@sample.com'
              )
            );
            console.log(
              winRemoveSingleQuotes(
                '  MeshCtrl SendInviteEmail --group "My Computers" --name "Jack" --email user@sample.com'
              )
            );
            console.log('\r\nRequired arguments:\r\n');
          ...
          case 'adduser': {
            ...
            console.log(
              '     manageusers,serverbackup,serverrestore,serverupdate,fileaccess,locked,nonewgroups,notools,usergroups,recordings,locksettings,allevents,nonewdevices'
            );
            break;
          }
          case 'edituser': {
          ...
          case 'editdevicegroup': {
            ...
            console.log(
              winRemoveSingleQuotes('  MeshCtrl EditDeviceGroup --id \'groupid\' --desc "Description" --consent 63')
            );
            console.log(
              winRemoveSingleQuotes(
          ...
          case 'addusertodevicegroup': {
            ...
            console.log(
              winRemoveSingleQuotes("  MeshCtrl AddUserToDeviceGroup --id 'groupid' --userid userid --fullrights")
            );
            ...
            if (args.limiteddesktop) {
              meshrights |= 4096;
            }
            if (args.limitedevents) {
              meshrights |= 8192;
            }
            if (args.chatnotify) {
              meshrights |= 16384;
          ...
          case 'addusertodevice': {
            ...
            console.log(
              winRemoveSingleQuotes("  MeshCtrl AddUserToDevice --id 'deviceid' --userid userid --fullrights")
            );
            console.log(
              winRemoveSingleQuotes("  MeshCtrl AddUserToDevice --id 'deviceid' --userid userid --remotecontrol")
            );
            console.log('\r\nRequired arguments:\r\n');
            if (process.platform == 'win32') {
              console.log('  --id [deviceid]        - The device identifier.');
          ...
          case 'devicesharing': {
            ...
            console.log(
              winRemoveSingleQuotes(
                "  MeshCtrl DeviceSharing --id 'deviceid' --add Guest --start " + localISOTime + ' --duration 30'
              )
            );
            console.log(
              winRemoveSingleQuotes(
                "  MeshCtrl DeviceSharing --id 'deviceid' --add Guest --start " +
                  localISOTime +
                  ' --duration 30 --daily'
              )
            );
            ...
            console.log(
              winRemoveSingleQuotes("  MeshCtrl DeviceSharing --id 'deviceid' --add Guest --type http --port 80")
            );
            console.log('\r\nRequired arguments:\r\n');
            if (process.platform == 'win32') {
              console.log('  --id [deviceid]                - The device identifier.');
            ...
            console.log(
              '  --type [desktop,terminal,files,http,https] - Type of sharing to add, can be combined. default is desktop.'
            );
            ...
            console.log(
              '  --port [portnumber]                        - Set alternative port for http or https, default is 80 for http and 443 for https.'
            );
            break;
          }
          case 'agentdownload': {
            ...
            console.log(
              '    installflags 0                    - Default, Interactive & Background, offers connect button & install/uninstall'
            );
            console.log(
              '    installflags 1                    - Interactive only, offers only connect button, not install/uninstall'
            );
            console.log(
              '    installflags 2                    - Background only, offers only install/uninstall, not connect'
            );
            break;
          }
          case 'upload': {
          ...
          case 'download': {
            ...
            console.log(
              winRemoveSingleQuotes("  MeshCtrl Download --id 'deviceid' --file C:\\sample.txt --target c:\\temp")
            );
            console.log(
              winRemoveSingleQuotes("  MeshCtrl Download --id 'deviceid' --file /tmp/sample.txt --target /tmp")
            );
            console.log('\r\nRequired arguments:\r\n');
            if (process.platform == 'win32') {
              console.log('  --id [deviceid]        - The device identifier.');
          ...
          case 'webrelay': {
            console.log(
              'Generate a webrelay URL to access a HTTP/HTTPS service on a remote device, Example usages:\r\n'
            );
          ...
          case 'deviceopenurl': {
            ...
            console.log(
              winRemoveSingleQuotes("  MeshCtrl DeviceOpenUrl --id 'deviceid' --openurl http://meshcentral.com")
            );
            console.log('\r\nRequired arguments:\r\n');
            if (process.platform == 'win32') {
              console.log('  --id [deviceid]        - The device identifier.');
          ...
          case 'devicemessage': {
            ...
            console.log(
              winRemoveSingleQuotes('  MeshCtrl DeviceMessage --id \'deviceid\' --msg "message" --title "title"')
            );
            console.log(
              winRemoveSingleQuotes(
                '  MeshCtrl DeviceMessage --id \'deviceid\' --msg "message" --title "title" --timeout 120000'
              )
            );
            console.log('\r\nRequired arguments:\r\n');
            if (process.platform == 'win32') {
          ...
          case 'devicetoast': {
            ...
            console.log(
              winRemoveSingleQuotes('  MeshCtrl DeviceToast --id \'deviceid\' --msg "message" --title "title"')
            );
            console.log('\r\nRequired arguments:\r\n');
            if (process.platform == 'win32') {
              console.log('  --id [deviceid]        - The device identifier.');
          ...
          case 'groupmessage': {
            ...
            console.log(
              winRemoveSingleQuotes('  MeshCtrl GroupMessage --id \'devicegroupid\' --msg "message" --title "title"')
            );
            console.log(
              winRemoveSingleQuotes(
          ...
          case 'grouptoast': {
            ...
            console.log(
              winRemoveSingleQuotes('  MeshCtrl GroupToast --id \'devicegroupid\' --msg "message" --title "title"')
            );
            console.log('\r\nRequired arguments:\r\n');
            if (process.platform == 'win32') {
              console.log('  --id [devicegroupid]   - The device identifier.');
...
function performConfigOperations(args) {
  ...
  if (fs.existsSync(configFile) == false) {
    console.log('Unable to find config.json.');
    return;
  }
  var config = null;
  try {
    config = fs.readFileSync(configFile).toString('utf8');
  } catch (ex) {
    console.log('Error: Unable to read config.json');
    return;
  }
  try {
  ...
  if (args.adddomain != null) {
    ...
    if (config.domains[args.adddomain] != null) {
      console.log('Error: Domain "' + args.adddomain + '" already exists');
    } else {
      configChange = true;
      ...
      for (var i in args) {
        if (domainValues.indexOf(i.toLowerCase()) >= 0) {
          if (args[i] == 'true') {
            ...
            args[i] = false;
          } else if (parseInt(args[i]) == args[i]) {
  ...
  if (args.removedomain != null) {
    ...
    if (config.domains[args.removedomain] == null) {
      console.log('Error: Domain "' + args.removedomain + '" does not exist');
    } else {
      delete config.domains[args.removedomain];
      configChange = true;
    }
  }
  if (args.settodomain != null) {
    ...
    if (args.settodomain == true) {
      args.settodomain = '';
    }
    if (config.domains[args.settodomain] == null) {
      console.log('Error: Domain "' + args.settodomain + '" does not exist');
    } else {
      for (var i in args) {
        ...
        if (domainValues.indexOf(i.toLowerCase()) >= 0) {
          ...
          if (isObj == false && isArr == false) {
            // Simple value set
            if (args[i] == '') {
              delete config.domains[args.settodomain][i];
              configChange = true;
            } else {
              if (args[i] == 'true') {
                args[i] = true;
            ...
            if (args[i] == '') {
              ...
              if (x == null || typeof x != 'object') {
                console.log('Unable to parse JSON for ' + i + '.');
              } else {
  ...
  if (args.removefromdomain != null) {
    ...
    if (config.domains[args.removefromdomain] == null) {
      console.log('Error: Domain "' + args.removefromdomain + '" does not exist');
    } else {
      for (var i in args) {
        if (domainValues.indexOf(i.toLowerCase()) >= 0) {
          delete config.domains[args.removefromdomain][i];
          configChange = true;
        }
      }
    }
...
function serverConnect() {
  ...
  if (args.url) {
    ...
    if (url.startsWith('wss://') == false && url.startsWith('ws://') == false) {
      console.log('Invalid url.');
      process.exit();
      return;
    }
  ...
  if (args.loginpass != null) {
    ...
    var token = '';
    if (args.token != null) {
      token = ',' + Buffer.from('' + args.token).toString('base64');
    }
    options.headers = {
      'x-meshauth':
        Buffer.from('' + username).toString('base64') +
        ',' +
        Buffer.from('' + args.loginpass).toString('base64') +
        token
    };
  }
  ...
  if (args.loginkey != null) {
    ...
    if (args.loginkey.length != 160) {
      loginCookie = args.loginkey;
    }
    ...
    try {
      var keydata = fs
        .readFileSync(args.loginkeyfile, 'utf8')
        .split(' ')
        .join('')
        .split('\r')
        .join('')
  ...
  if (ckey != null) {
    var domainid = '',
      username = 'admin';
    if (args.logindomain != null) {
      domainid = args.logindomain;
    }
    if (args.loginuser != null) {
      username = args.loginuser;
    }
    url +=
      (url.indexOf('?key=') >= 0 ? '&auth=' : '?auth=') +
      encodeCookie({ userid: 'user/' + domainid + '/' + username, domainid: domainid }, ckey);
  } else {
    if (args.logindomain != null) {
      console.log('--logindomain can only be used along with --loginkey.');
      process.exit();
      return;
    }
    if (loginCookie != null) {
      url += (url.indexOf('?key=') >= 0 ? '&auth=' : '?auth=') + loginCookie;
    }
  }
  ...
  ws.on('open', function open() {
    ...
    switch (settings.cmd) {
      ...
      case 'listusers': {
        ws.send(JSON.stringify({ action: 'users', responseid: 'meshctrl' }));
        break;
      }
      case 'listusersessions': {
        ws.send(JSON.stringify({ action: 'wssessioncount', responseid: 'meshctrl' }));
        break;
      }
      case 'removeallusersfromusergroup':
      case 'listusergroups': {
        ws.send(JSON.stringify({ action: 'usergroups', responseid: 'meshctrl' }));
        break;
      }
      case 'listdevicegroups': {
        ws.send(JSON.stringify({ action: 'meshes', responseid: 'meshctrl' }));
        break;
      }
      case 'listusersofdevicegroup': {
        ws.send(JSON.stringify({ action: 'meshes', responseid: 'meshctrl' }));
      ...
      case 'logintokens': {
        if (args.add) {
          ...
          if (args.expire) {
            cmd.expire = parseInt(args.expire);
          }
          ws.send(JSON.stringify(cmd));
        } else {
      ...
      case 'adduser': {
        ...
        if (args.randompass) {
          args.pass = getRandomAmtPassword();
        }
        ...
        if (siteadmin != -1) {
          op.siteadmin = siteadmin;
        }
        if (args.domain) {
          op.domain = args.domain;
        }
        if (args.phone === true) {
          op.phone = '';
        }
        ...
        if (typeof args.realname == 'string') {
          op.realname = args.realname;
        }
      ...
      case 'edituser': {
        ...
        if (args.domain != null && userid.indexOf('/') < 0) {
          userid = 'user/' + args.domain + '/' + userid;
        }
        var siteadmin = getSiteAdminRights(args);
      ...
      case 'removeusergroup': {
        ...
        if (args.domain != null && userid.indexOf('/') < 0) {
          ugrpid = 'ugrp/' + args.domain + '/' + ugrpid;
        }
      ...
      case 'addtousergroup': {
        ...
        if (args.meshid != null) {
          ...
          if (args.domain != null && userid.indexOf('/') < 0) {
            meshid = 'mesh/' + args.domain + '/' + meshid;
          }
          ws.send(
            JSON.stringify({
              action: 'addmeshuser',
        ...
        if (args.nodeid != null) {
          ...
          if (args.domain != null && userid.indexOf('/') < 0) {
            nodeid = 'node/' + args.domain + '/' + nodeid;
          }
          ws.send(
            JSON.stringify({
      ...
      case 'removefromusergroup': {
        ...
        if (args.id != null && args.id.startsWith('mesh/')) {
          ws.send(
            JSON.stringify({ action: 'removemeshuser', meshid: args.id, userid: ugrpid, responseid: 'meshctrl' })
          );
          break;
        }
      ...
      case 'adddevicegroup': {
        ...
        if (args.features) {
          op.flags = parseInt(args.features);
        }
        if (args.consent) {
          op.consent = parseInt(args.consent);
        }
        ws.send(JSON.stringify(op));
        break;
      }
      ...
      case 'addamtdevice': {
        ...
        if (typeof args.devicename == 'string' && args.devicename != '') {
          op.devicename = args.devicename;
        }
        if (typeof args.hostname == 'string' && args.hostname != '') {
          op.hostname = args.hostname;
        }
        if (typeof args.user == 'string' && args.user != '') {
          op.amtusername = args.user;
        }
        if (typeof args.pass == 'string' && args.pass != '') {
          op.amtpassword = args.pass;
        }
        if (args.notls) {
          op.amttls = 0;
        }
      ...
      case 'addlocaldevice': {
        ...
        if (args.type) {
          if (typeof parseInt(args.type) != 'number' || isNaN(parseInt(args.type))) {
      ...
      case 'editdevicegroup': {
        ...
        if (args.id) {
          ...
          op.meshidname = args.group;
        }
        if (typeof args.name == 'string' && args.name != '') {
          op.meshname = args.name;
        }
        if (args.desc === true) {
          op.desc = '';
        } else if (typeof args.desc == 'string') {
          op.desc = args.desc;
        }
        if (args.invitecodes === true) {
          op.invite = '*';
        } else if (typeof args.invitecodes == 'string') {
          var invitecodes = args.invitecodes.split(','),
            invitecodes2 = [];
          for (var i in invitecodes) {
            if (invitecodes[i].length > 0) {
              invitecodes2.push(invitecodes[i]);
            }
          }
          if (invitecodes2.length > 0) {
            op.invite = { codes: invitecodes2, flags: 0 };
            if (args.backgroundonly === true) {
              op.invite.flags = 2;
            } else if (args.interactiveonly === true) {
              op.invite.flags = 1;
            }
          }
        }
      ...
      case 'addusertodevicegroup': {
        ...
        if (args.managedevices) {
          meshrights |= 4;
        }
        if (args.remotecontrol) {
          meshrights |= 8;
        }
        if (args.agentconsole) {
          meshrights |= 16;
        }
        if (args.serverfiles) {
          meshrights |= 32;
      ...
      case 'addusertodevice': {
        var meshrights = 0;
        if (args.fullrights) {
          meshrights = 8 + 16 + 32 + 64 + 128 + 16384 + 32768;
        }
        if (args.remotecontrol) {
          meshrights |= 8;
        }
      ...
      case 'editdevice': {
        ...
        if (args.desc) {
          if (args.desc === true) {
            ...
            op.desc = args.desc;
          } else if (typeof args.desc == 'number') {
            op.desc = '' + args.desc;
          }
        }
        if (args.tags) {
          if (args.tags === true) {
            ...
            op.tags = args.tags.split(',');
          } else if (typeof args.tags == 'number') {
            op.tags = '' + args.tags;
          }
        }
        if (args.icon) {
          op.icon = parseInt(args.icon);
          if (typeof op.icon != 'number' || isNaN(op.icon) || op.icon < 1 || op.icon > 8) {
            console.log('Icon must be between 1 and 8.');
            process.exit(1);
            return;
          }
        }
        if (args.consent) {
          op.consent = parseInt(args.consent);
          if (typeof op.consent != 'number' || isNaN(op.consent) || op.consent < 1) {
            console.log('Invalid consent flags.');
            process.exit(1);
            return;
          }
        }
      ...
      case 'agentdownload': {
        ...
        if (args.installflags) {
          if (
            typeof parseInt(args.installflags) != 'number' ||
            isNaN(parseInt(args.installflags)) ||
            parseInt(args.installflags) < 0 ||
            parseInt(args.installflags) > 2
          ) {
            console.log('Invalid Installflags.');
            process.exit(1);
            return;
          }
          ...
          if (res.statusCode != 200) {
            ...
            if (res.headers && res.headers['content-disposition'] != null) {
              ...
              if (i >= 0) {
                ...
                if (i >= 0) {
                  agentFileName = agentFileName.substring(0, i);
                }
              }
            }
            // Check if this file already exists
            if (fs.existsSync(agentFileName)) {
              console.log('File \"' + agentFileName + '\" already exists.');
              process.exit(1);
            }
      ...
      case 'webrelay': {
        ...
        if (args.type != null) {
          if (args.type == 'http') {
            ...
            console.log('Unknown protocol type: ' + args.type);
            process.exit(1);
          }
        }
        var port = null;
        if (typeof args.port == 'number') {
          if (args.port < 1 || args.port > 65535) {
            console.log('Port number must be between 1 and 65535.');
            process.exit(1);
          }
          port = args.port;
        } else if (protocol == 1) {
        ...
        ws.send(
          JSON.stringify({ action: 'webrelay', nodeid: args.id, port: port, appid: protocol, responseid: 'meshctrl' })
        );
        break;
      }
      case 'devicesharing': {
        if (args.add) {
          ...
          if (args.type != null) {
            ...
            for (var i in shareTypes) {
              if (
                shareTypes[i] != 'terminal' &&
                shareTypes[i] != 'desktop' &&
                shareTypes[i] != 'files' &&
                shareTypes[i] != 'http' &&
                shareTypes[i] != 'https'
              ) {
                console.log('Unknown sharing type: ' + shareTypes[i]);
                process.exit(1);
              }
            }
            if (shareTypes.indexOf('terminal') >= 0) {
              p |= 1;
            }
            if (shareTypes.indexOf('desktop') >= 0) {
              p |= 2;
            }
            if (shareTypes.indexOf('files') >= 0) {
              p |= 4;
            }
            if (shareTypes.indexOf('http') >= 0) {
              p |= 8;
            }
            if (shareTypes.indexOf('https') >= 0) {
              p |= 16;
            }
          }
          if (p == 0) {
            ...
            if (typeof args.consent == 'string') {
              ...
              for (var i in flagStrs) {
                ...
                if (flagStr == 'none') {
                  ...
                  console.log('Unknown consent type.');
                  process.exit(1);
                  return;
                }
              }
          ...
          if (args.end) {
            ...
            if (end <= start) {
              console.log('End time must be ahead of start time.');
              process.exit(1);
              return;
            }
          }
          ...
          if (recurring > 0) {
            if (args.end != null) {
              console.log("End time can't be specified for recurring shares, use --duration only.");
              process.exit(1);
              return;
            }
      ...
      case 'deviceopenurl': {
        ws.send(
          JSON.stringify({ action: 'msg', type: 'openUrl', nodeid: args.id, url: args.openurl, responseid: 'meshctrl' })
        );
        break;
      }
      case 'devicemessage': {
        ws.send(
          JSON.stringify({
            ...
            type: 'messagebox',
            nodeid: args.id,
            title: args.title ? args.title : 'MeshCentral',
            msg: args.msg,
            timeout: args.timeout ? args.timeout : 120000,
            responseid: 'meshctrl'
          })
        );
        break;
      ...
      case 'report': {
        ...
        if (args.start) {
          ...
          start =
            reportgroupby === 3
              ? Math.round(new Date().getTime() / 1000) - 168 * 3600
        ...
        ws.send(
          JSON.stringify({
            ...
            showTraffic: args.hasOwnProperty('showtraffic'),
            l: 'en',
            responseid: 'meshctrl'
          })
        );
  ...
  function getSiteAdminRights(args) {
    ...
    if (typeof args.rights == 'number') {
      ...
      if (srights.indexOf('full') != -1) {
        siteadmin = 0xffffffff;
      }
      if (srights.indexOf('none') != -1) {
        siteadmin = 0x00000000;
      }
      if (srights.indexOf('backup') != -1 || srights.indexOf('serverbackup') != -1) {
        siteadmin |= 0x00000001;
      }
      if (srights.indexOf('manageusers') != -1) {
        siteadmin |= 0x00000002;
      }
      if (srights.indexOf('restore') != -1 || srights.indexOf('serverrestore') != -1) {
        siteadmin |= 0x00000004;
      }
      if (srights.indexOf('fileaccess') != -1) {
        siteadmin |= 0x00000008;
      }
      if (srights.indexOf('update') != -1 || srights.indexOf('serverupdate') != -1) {
        siteadmin |= 0x00000010;
      }
      if (srights.indexOf('locked') != -1) {
        siteadmin |= 0x00000020;
      }
      if (srights.indexOf('nonewgroups') != -1) {
        siteadmin |= 0x00000040;
      }
      if (srights.indexOf('notools') != -1) {
        siteadmin |= 0x00000080;
      }
      if (srights.indexOf('usergroups') != -1) {
        siteadmin |= 0x00000100;
      }
      if (srights.indexOf('recordings') != -1) {
        siteadmin |= 0x00000200;
      }
      if (srights.indexOf('locksettings') != -1) {
        siteadmin |= 0x00000400;
      }
      if (srights.indexOf('allevents') != -1) {
        siteadmin |= 0x00000800;
      }
      if (srights.indexOf('nonewdevices') != -1) {
        siteadmin |= 0x00001000;
      }
    }
  ...
  ws.on('error', function (err) {
    if (err.code == 'ENOTFOUND') {
      console.log('Unable to resolve ' + url);
  ...
  ws.on('message', function incoming(rawdata) {
    ...
    if (data == null) {
      console.log('Unable to parse data: ' + rawdata);
    }
    if (settings.cmd == 'showevents') {
      if (args.filter == null) {
        ...
        if (typeof data.event == 'object') {
          if (filters.indexOf(data.event.action) >= 0) {
            console.log(JSON.stringify(data, null, 2) + '\r\n');
          }
        } else {
          if (filters.indexOf(data.action) >= 0) {
            console.log(JSON.stringify(data, null, 2) + '\r\n');
          }
        }
      }
    ...
    switch (data.action) {
      case 'serverinfo': {
        ...
        if (settings.cmd == 'serverinfo') {
          if (args.json) {
            ...
            for (var i in data.serverinfo) {
              console.log(i + ':', data.serverinfo[i]);
            }
          }
          process.exit();
        }
      ...
      case 'authcookie': {
        ...
        if (settings.cmd == 'shell' || settings.cmd == 'upload' || settings.cmd == 'download') {
          ...
          if (settings.cmd == 'upload' || settings.cmd == 'download') {
            protocol = 5;
          } // Files
          if (args.powershell) {
            protocol = 6;
          } // PowerShell
          if (args.id.split('/').length != 3 && settings.currentDomain != null) {
            args.id = 'node/' + settings.currentDomain + '/' + args.id;
          }
          ...
          ws.send(
            JSON.stringify({
              ...
              type: 'tunnel',
              usage: 1,
              value: '*/meshrelay.ashx?p=' + protocol + '&nodeid=' + args.id + '&id=' + id + '&rauth=' + data.rcookie,
              responseid: 'meshctrl'
            })
          );
          connectTunnel(
          ...
          if (data.deviceShares == null || data.deviceShares.length == 0) {
            ...
            if (args.json) {
              ...
              for (var i in data.deviceShares) {
                ...
                var shareType = [];
                if ((share.p & 1) != 0) {
                  shareType.push('Terminal');
                }
                if ((share.p & 2) != 0) {
                  if (share.viewOnly) {
                    shareType.push('View Only Desktop');
                  } else {
                    shareType.push('Desktop');
                  }
                }
                if ((share.p & 4) != 0) {
                  shareType.push('Files');
                }
                ...
                var consent = [];
                if ((share.consent & 0x0001) != 0) {
                  consent.push('Desktop Notify');
                }
                if ((share.consent & 0x0008) != 0) {
                  consent.push('Desktop Prompt');
                }
                if ((share.consent & 0x0040) != 0) {
                  consent.push('Desktop Connection Toolbar');
                }
                if ((share.consent & 0x0002) != 0) {
                  consent.push('Terminal Notify');
                }
                if ((share.consent & 0x0010) != 0) {
                  consent.push('Terminal Prompt');
                }
                if ((share.consent & 0x0004) != 0) {
                  consent.push('Files Notify');
                }
                if ((share.consent & 0x0020) != 0) {
                  consent.push('Files Prompt');
                }
                console.log('----------');
                ...
                if (share.duration) {
                  console.log('Duration:     ' + share.duration + ' minute' + (share.duration > 1 ? 's' : ''));
                }
                if (share.recurring == 1) {
                  console.log('Recurring:    ' + 'Daily');
                }
                if (share.recurring == 2) {
                  console.log('Recurring:    ' + 'Weekly');
                }
      ...
      case 'getsysinfo': {
        ...
        if (settings.cmd == 'deviceinfo') {
          ...
          if (--settings.deviceinfocount == 0) {
            displayDeviceInfo(settings.sysinfo, settings.lastconnect, settings.networking, settings.nodes);
            process.exit();
          }
        }
        break;
      ...
      case 'userbroadcast': {
        // BROADCAST
        if ((settings.cmd == 'shell' || settings.cmd == 'upload' || settings.cmd == 'download') && data.result == 'OK')
          return;
        if (data.type == 'runcommands' && settings.cmd != 'runcommand') return;
        if (settings.multiresponse != null && settings.multiresponse > 1) {
          settings.multiresponse--;
          break;
        }
        if (data.responseid == 'meshctrl') {
          if (data.meshid) {
            console.log(data.result, data.meshid);
          } else if (data.userid) {
      ...
      case 'wssessioncount': {
        ...
        if (args.json) {
          ...
          for (var i in data.wssessions) {
            console.log(i + ', ' + (data.wssessions[i] > 1 ? data.wssessions[i] + ' sessions.' : '1 session.'));
          }
        }
        process.exit();
        break;
        ...
        if (settings.cmd == 'listusergroups') {
          if (args.json) {
            ...
            for (var i in data.ugroups) {
              ...
              if (data.ugroups[i].desc && data.ugroups[i].desc != '') {
                x += ', ' + data.ugroups[i].desc;
              }
              console.log(x);
              var mesh = [],
                user = [],
                node = [];
              if (data.ugroups[i].links != null) {
                for (var j in data.ugroups[i].links) {
              ...
              if (mesh.length > 0) {
                for (var j in mesh) {
                  console.log('    ' + mesh[j] + ', ' + data.ugroups[i].links[mesh[j]].rights);
                }
              } else {
                console.log('    (None)');
              }
              ...
              if (node.length > 0) {
                for (var j in node) {
                  console.log('    ' + node[j] + ', ' + data.ugroups[i].links[node[j]].rights);
                }
              } else {
                console.log('    (None)');
              }
          ...
          if (ugroup == null) {
            ...
            if (usercount == 0) {
              console.log('No users in this user group.');
              exit = true;
            } else {
              settings.multiresponse = usercount;
            }
          }
          if (exit) {
            process.exit();
      ...
      case 'users': {
        ...
        if (args.filter) {
          ...
          for (var i in data.users) {
            var ok = false;
            if (
              filters.indexOf('2fa') >= 0 &&
              (data.users[i].otphkeys != null || data.users[i].otpkeys != null || data.users[i].otpsecret != null)
            ) {
              ok = true;
            }
            if (
              filters.indexOf('no2fa') >= 0 &&
              data.users[i].otphkeys == null &&
              data.users[i].otpkeys == null &&
              data.users[i].otpsecret == null
            ) {
              ok = true;
            }
            if (ok == true) {
        ...
        if (args.json) {
          ...
          if (args.idexists) {
            for (var i in data.users) {
              ...
              if (u._id == args.idexists || u._id.split('/')[2] == args.idexists) {
                console.log('1');
                process.exit();
                return;
              }
      ...
      case 'nodes': {
        ...
        if (settings.cmd == 'listdevices' && data.responseid == 'meshctrl') {
          if (data.result != null && data.result != 'ok') {
            ...
            if (args.filterid) {
              var filteridSplit = args.filterid.split(','),
                filters = [];
              ...
              if (filters.length > 0) {
                for (var mid in data.nodes) {
                  ...
                  for (var nid in data.nodes[mid]) {
                    var n = data.nodes[mid][nid],
                      match = false;
                    for (var f in filters) {
                      if (n._id.indexOf(filters[f]) >= 0) {
                        match = true;
                      }
                    }
                    if (match) {
            ...
            if (args.filter != null) {
              for (var meshid in data.nodes) {
                for (var d in data.nodes[meshid]) {
                  data.nodes[meshid][d].meshid = meshid;
                }
            ...
            if (args.csv) {
              ...
              for (var i in data.nodes) {
                ...
                for (var j in devicesInMesh) {
                  ...
                  if (settings.xmeshes && settings.xmeshes[i]) {
                    console.log(
                      '\"' +
                        settings.xmeshes[i]._id.split('/')[2] +
                        '\",\"' +
                        settings.xmeshes[i].name.split('\"').join('') +
                        '\",\"' +
                        n._id.split('/')[2] +
                        '\",\"' +
                        n.name.split('\"').join('') +
              ...
              for (var i in data.nodes) {
                ...
                for (var j in devicesInMesh) {
                  ...
                  if (settings.xmeshes && settings.xmeshes[i] && settings.xmeshes[i].name) {
                    devicesInMesh[j].groupname = settings.xmeshes[i].name;
      ...
      case 'meshes': {
        ...
        if (settings.cmd == 'listdevices') {
          ...
          for (var i in data.meshes) {
            settings.xmeshes[data.meshes[i]._id] = data.meshes[i];
          }
          ...
          if (args.json) {
            ...
            if (args.hex) {
              for (var i in data.meshes) {
                data.meshes[i]._idhex =
                  '0x' +
                  Buffer.from(data.meshes[i]._id.split('/')[2].replace(/\@/g, '+').replace(/\$/g, '/'), 'base64')
                    .toString('hex')
                    .toUpperCase();
              }
            }
            ...
            for (var i in data.meshes) {
              ...
              if (args.hex) {
                mid =
                  '0x' +
                  Buffer.from(mid.replace(/\@/g, '+').replace(/\$/g, '/'), 'base64').toString('hex').toUpperCase();
              }
              var t = '"' + mid + '", "' + m.name + '"';
              console.log(t);
            }
            ...
            if (mid == args.id) {
              if (args.json) {
                ...
                for (var l in m.links) {
                  ...
                  var rightsstr = [];
                  if (rights == 4294967295) {
                    rightsstr = ['FullAdministrator'];
                  } else {
                    if (rights & 1) {
                      rightsstr.push('EditMesh');
                    }
                    if (rights & 2) {
                      rightsstr.push('ManageUsers');
                    }
                    if (rights & 4) {
                      rightsstr.push('ManageComputers');
                    }
                    if (rights & 8) {
                      rightsstr.push('RemoteControl');
                    }
                    if (rights & 16) {
                      rightsstr.push('AgentConsole');
                    }
                    if (rights & 32) {
                      rightsstr.push('ServerFiles');
                    }
                    if (rights & 64) {
                      rightsstr.push('WakeDevice');
                    }
                    if (rights & 128) {
                      rightsstr.push('SetNotes');
                    }
                    if (rights & 256) {
                      rightsstr.push('RemoteViewOnly');
                    }
                    if (rights & 512) {
                      rightsstr.push('NoTerminal');
                    }
                    if (rights & 1024) {
                      rightsstr.push('NoFiles');
                    }
                    if (rights & 2048) {
                      rightsstr.push('NoAMT');
                    }
                    if (rights & 4096) {
                      rightsstr.push('DesktopLimitedInput');
                    }
                  }
      ...
      case 'createLoginToken': {
        if (data.result != null) {
          ...
          if (args.json) {
            ...
            if (data.expire) {
              console.log('Expire: ' + new Date(data.expire).toLocaleString());
            }
            if (data.tokenUser) {
              console.log('Username: ' + data.tokenUser);
            }
            if (data.tokenPass) {
              console.log('Password: ' + data.tokenPass);
            }
          }
        }
        process.exit();
...
function padString(str, pad) {
  ...
  return str + xpad.substring(0, pad - str.length);
}
...
function parseSearchOrInput(nodes, x) {
  var s = x.split(' ' + 'or' + ' '),
    r = null;
  for (var i in s) {
    var r2 = parseSearchAndInput(nodes, s[i]);
    if (r == null) {
      r = r2;
    } else {
      for (var j in r2) {
...
function getDevicesThatMatchFilter(nodes, x) {
  ...
  var userSearch = null,
    ...
    amtSearch = null,
    descSearch = null;
  if (x.startsWith('user:'.toLowerCase())) {
    userSearch = x.substring('user:'.length);
  } else if (x.startsWith('u:'.toLowerCase())) {
    userSearch = x.substring('u:'.length);
  } else if (x.startsWith('ip:'.toLowerCase())) {
    ipSearch = x.substring('ip:'.length);
  } else if (x.startsWith('group:'.toLowerCase())) {
    groupSearch = x.substring('group:'.length);
  } else if (x.startsWith('g:'.toLowerCase())) {
    groupSearch = x.substring('g:'.length);
  } else if (x.startsWith('tag:'.toLowerCase())) {
    tagSearch = x.substring('tag:'.length);
  } else if (x.startsWith('t:'.toLowerCase())) {
    tagSearch = x.substring('t:'.length);
  } else if (x.startsWith('atag:'.toLowerCase())) {
    agentTagSearch = x.substring('atag:'.length);
  } else if (x.startsWith('a:'.toLowerCase())) {
    agentTagSearch = x.substring('a:'.length);
  } else if (x.startsWith('os:'.toLowerCase())) {
    osSearch = x.substring('os:'.length);
  } else if (x.startsWith('amt:'.toLowerCase())) {
    amtSearch = x.substring('amt:'.length);
  } else if (x.startsWith('desc:'.toLowerCase())) {
    descSearch = x.substring('desc:'.length);
  } else if (x == 'wsc:ok') {
    wscSearch = 1;
  } else if (x == 'wsc:noav') {
    wscSearch = 2;
  } else if (x == 'wsc:noupdate') {
    wscSearch = 3;
  } else if (x == 'wsc:nofirewall') {
    wscSearch = 4;
  } else if (x == 'wsc:any') {
    wscSearch = 5;
  }
  ...
  if (x == '') {
    ...
    // IP address search
    for (var d in nodes) {
      if (nodes[d].ip != null && nodes[d].ip.indexOf(ipSearch) >= 0) {
        r.push(nodes[d]);
      }
    }
    ...
    if (settings.xmeshes) {
      for (var d in nodes) {
        if (
          settings.xmeshes[nodes[d].meshid] &&
          settings.xmeshes[nodes[d].meshid].name.toLowerCase().indexOf(groupSearch) >= 0
        ) {
          r.push(nodes[d]);
        }
      }
    ...
    // Tag filter
    for (var d in nodes) {
      if (nodes[d].tags == null && tagSearch == '') {
        r.push(nodes[d]);
      } else if (nodes[d].tags != null) {
        for (var j in nodes[d].tags) {
          if (nodes[d].tags[j].toLowerCase() == tagSearch) {
            r.push(nodes[d]);
            break;
          }
        }
    ...
    for (var d in nodes) {
      if (
        (nodes[d].agent != null && nodes[d].agent.tag == null && agentTagSearch == '') ||
        (nodes[d].agent != null &&
          nodes[d].agent.tag != null &&
          nodes[d].agent.tag.toLowerCase().indexOf(agentTagSearch) >= 0)
      ) {
        r.push(nodes[d]);
      }
    }
    ...
    // User search
    for (var d in nodes) {
      if (nodes[d].users && nodes[d].users.length > 0) {
        for (var i in nodes[d].users) {
          if (nodes[d].users[i].toLowerCase().indexOf(userSearch) >= 0) {
            r.push(nodes[d]);
          }
        }
      }
    ...
    // OS search
    for (var d in nodes) {
      if (nodes[d].osdesc != null && nodes[d].osdesc.toLowerCase().indexOf(osSearch) >= 0) {
        r.push(nodes[d]);
      }
    }
    ...
    // Intel AMT search
    for (var d in nodes) {
      if (nodes[d].intelamt != null && (amtSearch == '' || nodes[d].intelamt.state == amtSearch)) {
        r.push(nodes[d]);
      }
    }
    ...
    for (var d in nodes) {
      if (
        nodes[d].desc != null &&
        nodes[d].desc != '' &&
        (descSearch == '' || nodes[d].desc.toLowerCase().indexOf(descSearch) >= 0)
      ) {
        r.push(nodes[d]);
      }
    }
    ...
    for (var d in nodes) {
      if (nodes[d].wsc) {
        if (
          wscSearch == 1 &&
          nodes[d].wsc.antiVirus == 'OK' &&
          nodes[d].wsc.autoUpdate == 'OK' &&
          nodes[d].wsc.firewall == 'OK'
        ) {
          r.push(nodes[d]);
        } else if ((wscSearch == 2 || wscSearch == 5) && nodes[d].wsc.antiVirus != 'OK') {
          r.push(nodes[d]);
        } else if ((wscSearch == 3 || wscSearch == 5) && nodes[d].wsc.autoUpdate != 'OK') {
          r.push(nodes[d]);
        } else if ((wscSearch == 4 || wscSearch == 5) && nodes[d].wsc.firewall != 'OK') {
          r.push(nodes[d]);
        }
      }
    }
    ...
    try {
      var rs = x.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'),
        rx = new RegExp(rs); // In some cases (like +), this can throw an exception.
      for (var d in nodes) {
        //if (showRealNames) {
        //if (nodes[d].rnamel != null && rx.test(nodes[d].rnamel.toLowerCase())) { r.push(nodes[d]); }
        //} else {
        if (rx.test(nodes[d].name.toLowerCase())) {
          r.push(nodes[d]);
        }
        //}
      }
...
function connectTunnel(url) {
  ...
  settings.tunnelws.on('open', function () {
    console.log('Waiting for Agent...');
  }); // Wait for agent connection
  settings.tunnelws.on('close', function () {
    console.log('Connection Closed.');
    process.exit();
  });
  settings.tunnelws.on('error', function (err) {
    console.log(err);
    process.exit();
  });
  ...
  if (settings.cmd == 'shell') {
    ...
    settings.tunnelws.on('message', function (rawdata) {
      ...
      if (settings.tunnelwsstate == 1) {
        ...
        if (data == 'c') {
          ...
          console.log('Connected, session is being recorded.');
        } else return;
        // Send terminal size
        var termSize = null;
        if (typeof process.stdout.getWindowSize == 'function') {
          termSize = process.stdout.getWindowSize();
        }
        if (termSize != null) {
          settings.tunnelws.send(
            JSON.stringify({ ctrlChannel: '102938', type: 'options', cols: termSize[0], rows: termSize[1] })
          );
        }
        ...
        process.stdin.on('data', function (data) {
          settings.tunnelws.send(Buffer.from(data));
        });
        ...
        process.stdout.on('resize', function () {
          ...
          if (termSize != null) {
            settings.tunnelws.send(
              JSON.stringify({ ctrlChannel: '102938', type: 'termsize', cols: termSize[0], rows: termSize[1] })
            );
          }
        });
      }
    ...
    settings.tunnelws.on('message', function (rawdata) {
      if (settings.tunnelwsstate == 1) {
        var cmd = null;
        try {
          cmd = JSON.parse(rawdata.toString());
        } catch (ex) {
          return;
        }
        if (cmd.reqid == 'up') {
          if (cmd.action == 'uploadack' || cmd.action == 'uploadstart') {
            settings.inFlight--;
            if (settings.uploadFile == null) {
              if (settings.inFlight == 0) {
                process.exit();
              }
              return;
            } // If the file is closed and there is no more in-flight data, exit.
            ...
            for (var i = 0; i < loops; i++) {
              ...
              if (len > 0) {
                if (buf[1] == 0 || buf[1] == 123) {
                  start = 0;
                  buf[0] = 0;
                  len++;
                } // If the buffer starts with 0 or 123, we must add an extra 0 at the start of the buffer
                settings.inFlight++;
                settings.tunnelws.send(buf.slice(start, start + len));
              } else {
                console.log('Upload done, ' + settings.uploadPtr + ' bytes sent.');
                if (settings.uploadFile != null) {
                  require('fs').closeSync(settings.uploadFile);
                  delete settings.uploadFile;
                }
                if (settings.inFlight == 0) {
                  process.exit();
                  return;
                } // File is closed, if there is no more in-flight data, exit.
              }
            }
        ...
        settings.tunnelws.send(
          JSON.stringify({
            ...
            reqid: 'up',
            path: args.target,
            name: require('path').basename(args.file),
            size: settings.uploadSize
          })
        );
      }
    });
    ...
    settings.tunnelws.on('message', function (rawdata) {
      if (settings.tunnelwsstate == 1) {
        if (rawdata.length > 0 && rawdata.toString()[0] != '{') {
          ...
          if (rawdata.length > 4 && settings.downloadFile != null) {
            settings.downloadSize += rawdata.length - 4;
            require('fs').writeSync(settings.downloadFile, rawdata, 4, rawdata.length - 4);
          }
          if ((rawdata[3] & 1) != 0) {
            // Check end flag
            // File is done, close everything.
            if (settings.downloadFile != null) {
              require('fs').closeSync(settings.downloadFile);
            }
          ...
          if (cmd.action == 'download') {
            ...
            if (cmd.sub == 'start') {
              if (args.target.endsWith('\\') || args.target.endsWith('/')) {
                args.target += path.parse(args.file).name;
              }
              try {
                settings.downloadFile = require('fs').openSync(args.target, 'w');
              } catch (ex) {
                console.log('Unable to create file: ' + args.target);
                process.exit();
                return;
              }
...
function getRandomAmtPassword() {
  var p;
  do {
    p = Buffer.from(crypto.randomBytes(9), 'binary').toString('base64').split('/').join('@');
  } while (checkAmtPassword(p) == false);
  return p;
}
function getRandomHex(count) {
  return Buffer.from(crypto.randomBytes(count), 'binary').toString('hex');
}
...
function winRemoveSingleQuotes(str) {
...
function displayDeviceInfo(sysinfo, lastconnect, network, nodes) {
  ...
  if (sysinfo != null && sysinfo.node != null) {
    ...
    for (var m in nodes.nodes) {
      for (var n in nodes.nodes[m]) {
        if (nodes.nodes[m][n]._id.indexOf(args.id) >= 0) {
          node = nodes.nodes[m][n];
        }
      }
    }
  }
  ...
  if (args.raw) {
    console.log(JSON.stringify(sysinfo, ' ', 2));
    return;
  }
  ...
  var output = {},
    outputCount = 0;
  if (node.name) {
    output['Server Name'] = node.name;
    outputCount++;
  }
  if (node.rname) {
    output['Computer Name'] = node.rname;
    outputCount++;
  }
  if (node.host != null) {
    output['Hostname'] = node.host;
    outputCount++;
  }
  if (node.ip != null) {
    output['IP Address'] = node.ip;
    outputCount++;
  }
  if (node.desc != null) {
    output['Description'] = node.desc;
    outputCount++;
  }
  if (node.icon != null) {
    output['Icon'] = node.icon;
    outputCount++;
  }
  if (node.tags) {
  ...
  if (node.av) {
    ...
    for (var i in node.av) {
      if (typeof node.av[i]['product'] == 'string') {
        ...
        if (node.av[i]['updated'] === true) {
          n += ', updated';
        }
        if (node.av[i]['updated'] === false) {
          n += ', not updated';
        }
        if (node.av[i]['enabled'] === true) {
          n += ', enabled';
        }
        if (node.av[i]['enabled'] === false) {
          n += ', disabled';
        }
        av.push(n);
      }
  ...
  if (typeof node.wsc == 'object') {
    output['WindowsSecurityCenter'] = node.wsc;
    outputCount++;
  }
  if (outputCount > 0) {
    info['General'] = output;
  ...
  // Operating System
  var hardware = null;
  if (sysinfo != null && sysinfo.hardware != null) {
  ...
  if ((hardware && hardware.windows && hardware.windows.osinfo) || node.osdesc) {
    var output = {},
      outputCount = 0;
    if (node.rname) {
      output['Name'] = node.rname;
      outputCount++;
    }
    if (node.osdesc) {
      output['Version'] = node.osdesc;
      outputCount++;
    }
    if (hardware && hardware.windows && hardware.windows.osinfo) {
      var m = hardware.windows.osinfo;
      if (m.OSArchitecture) {
        output['Architecture'] = m.OSArchitecture;
        outputCount++;
      }
    }
    if (outputCount > 0) {
  ...
  if (node.agent) {
    ...
    var agentsStr = [
      'Unknown',
      'Windows 32bit console',
      'Windows 64bit console',
      'Windows 32bit service',
      'Windows 64bit service',
      'Linux 32bit',
      'Linux 64bit',
      'MIPS',
      'XENx86',
      ...
      'PogoPlug ARM',
      'Android',
      'Linux Poky x86-32bit',
      'macOS x86-64bit',
      'ChromeOS',
      'Linux Poky x86-64bit',
      'Linux NoKVM x86-32bit',
      'Linux NoKVM x86-64bit',
      'Windows MinCore console',
      'Windows MinCore service',
      'NodeJS',
      'ARM-Linaro',
      'ARMv6l / ARMv7l',
      'ARMv8 64bit',
      ...
      'Assistant (Windows)',
      'Armada370 - ARM32/HF (libc/2.26)',
      'OpenWRT x86-64',
      'OpenBSD x86-64',
      'Unknown',
      'Unknown',
      'MIPSEL24KC (OpenWRT)',
      'ARMADA/CORTEX-A53/MUSL (OpenWRT)',
      'Windows ARM 64bit console',
      'Windows ARM 64bit service',
      'ARMVIRT32 (OpenWRT)',
      'RISC-V x86-64'
    ];
    if (node.agent != null && node.agent.id != null && node.agent.ver != null) {
      var str = '';
      if (node.agent.id <= agentsStr.length) {
        str = agentsStr[node.agent.id];
      } else {
        str = agentsStr[0];
      }
      if (node.agent.ver != 0) {
      ...
      output['Mesh Agent'] = str;
      outputCount++;
    }
    if ((node.conn & 1) != 0) {
      output['Last agent connection'] = 'Connected now';
      outputCount++;
    } else {
      if (node.lastconnect) {
        output['Last agent connection'] = new Date(node.lastconnect).toLocaleString();
        outputCount++;
      }
    }
    output['Agent status'] = (node.conn & 1) != 0 ? 'Connected now' : 'Offline';
    outputCount++;
    if (node.lastaddr) {
      var splitip = node.lastaddr.split(':');
      if (splitip.length > 2) {
        output['Last agent address'] = node.lastaddr;
        outputCount++; // IPv6
      } else {
        output['Last agent address'] = splitip[0];
        outputCount++; // IPv4
      }
    }
    if (node.agent != null && node.agent.tag != null) {
      output['Tag'] = node.agent.tag;
      outputCount++;
    }
    if (outputCount > 0) {
      info['Mesh Agent'] = output;
    }
  }
  ...
  if (network.netif != null) {
    ...
    for (var i in network.netif) {
      var m = network.netif[i],
        ...
        moutputCount = 0;
      if (m.desc) {
        moutput['Description'] = m.desc;
        moutputCount++;
      }
      if (m.mac) {
        if (m.gatewaymac) {
          moutput['MAC Layer'] = format('MAC: {0}, Gateway: {1}', m.mac, m.gatewaymac);
          moutputCount++;
        } else {
          moutput['MAC Layer'] = format('MAC: {0}', m.mac);
          moutputCount++;
        }
      }
      if (m.v4addr && m.v4addr != '0.0.0.0') {
        if (m.v4gateway && m.v4mask) {
          moutput['IPv4 Layer'] = format('IP: {0}, Mask: {1}, Gateway: {2}', m.v4addr, m.v4mask, m.v4gateway);
          moutputCount++;
        } else {
          moutput['IPv4 Layer'] = format('IP: {0}', m.v4addr);
          moutputCount++;
        }
      }
      if (moutputCount > 0) {
        minfo[m.name + (m.dnssuffix ? ', ' + m.dnssuffix : '')] = moutput;
      ...
      for (var j = 0; j < m.length; j++) {
        ...
        if (iplayer.family == 'IPv4' || iplayer.family == 'IPv6') {
          if (iplayer.gateway && iplayer.netmask) {
            moutput[iplayer.family + ' Layer'] += format(
              'IP: {0}, Mask: {1}, Gateway: {2}  ',
              iplayer.address,
              iplayer.netmask,
              iplayer.gateway
            );
  ...
  if (node.intelamt != null) {
    var output = {},
      outputCount = 0;
    output['Version'] = node.intelamt.ver ? 'v' + node.intelamt.ver : '<i>' + 'Unknown' + '</i>';
    outputCount++;
    var provisioningStates = { 0: 'Not Activated (Pre)', 1: 'Not Activated (In)', 2: 'Activated' };
    var provisioningMode = '';
    if (node.intelamt.state == 2 && node.intelamt.flags) {
      if (node.intelamt.flags & 2) {
        provisioningMode = ', ' + 'Client Control Mode (CCM)';
      } else if (node.intelamt.flags & 4) {
        provisioningMode = ', ' + 'Admin Control Mode (ACM)';
      }
    }
    output['Provisioning State'] =
      (node.intelamt.state ? provisioningStates[node.intelamt.state] : '<i>' + 'Unknown' + '</i>') + provisioningMode;
    outputCount++;
    output['Security'] = node.intelamt.tls == 1 ? 'Secured using TLS' : 'TLS is not setup';
    outputCount++;
    output['Admin Credentials'] = node.intelamt.user == null || node.intelamt.user == '' ? 'Not Known' : 'Known';
    outputCount++;
    if (outputCount > 0) {
      info['Intel Active Management Technology (Intel AMT)'] = output;
    }
  }
  ...
  if (hardware != null) {
    if (hardware.identifiers) {
      var output = {},
        outputCount = 0,
        ident = hardware.identifiers;
      // BIOS
      if (ident.bios_vendor) {
        output['Vendor'] = ident.bios_vendor;
        outputCount++;
      }
      if (ident.bios_version) {
        output['Version'] = ident.bios_version;
        outputCount++;
      }
      if (ident.bios_serial) {
        output['Serial'] = ident.bios_serial;
        outputCount++;
      }
      if (ident.bios_mode) {
        output['Mode'] = ident.bios_mode;
        outputCount++;
      }
      if (outputCount > 0) {
        info['BIOS'] = output;
      ...
      // Motherboard
      if (ident.board_vendor) {
        output['Vendor'] = ident.board_vendor;
        outputCount++;
      }
      if (ident.board_name) {
        output['Name'] = ident.board_name;
        outputCount++;
      }
      if (ident.board_serial && ident.board_serial != '') {
        output['Serial'] = ident.board_serial;
        outputCount++;
      }
      if (ident.board_version) {
        output['Version'] = ident.board_version;
      }
      if (ident.product_uuid) {
        output['Identifier'] = ident.product_uuid;
      }
      if (ident.cpu_name) {
        output['CPU'] = ident.cpu_name;
      }
      if (ident.gpu_name) {
        for (var i in ident.gpu_name) {
          output['GPU' + (parseInt(i) + 1)] = ident.gpu_name[i];
        }
      }
      if (outputCount > 0) {
        info['Motherboard'] = output;
      }
      ((output = {}), (outputCount = 0));

      // System
      if (ident.chassis_manufacturer) {
        output['Manufacturer'] = ident.chassis_manufacturer;
        outputCount++;
      }
      if (ident.product_name) {
        output['Product Name'] = ident.product_name;
        outputCount++;
      }
      if (ident.chassis_serial) {
        output['Serial'] = ident.chassis_serial;
        outputCount++;
      }
      if (ident.chassis_assettag) {
        output['Asset Tag'] = ident.chassis_assettag;
        outputCount++;
      }
      if (outputCount > 0) {
        info['System'] = output;
    ...
    if (hardware.tpm) {
      var output = {},
        ...
        tpm = hardware.tpm;
      if (tpm.SpecVersion) {
        output['SpecVersion'] = parseFloat(tpm.SpecVersion).toFixed(1);
        outputCount++;
      }
      if (tpm.ManufacturerId) {
        output['Identifier'] = tpm.ManufacturerId;
        outputCount++;
      }
      if (tpm.ManufacturerVersion) {
        output['Version'] = tpm.ManufacturerVersion;
        outputCount++;
      }
      if (tpm.IsActivated != null) {
        output['Activated'] = tpm.IsActivated ? 'Yes' : 'No';
        outputCount++;
      }
      if (tpm.IsEnabled != null) {
        output['Enabled'] = tpm.IsEnabled ? 'Yes' : 'No';
        outputCount++;
      }
      if (tpm.IsOwned != null) {
        output['Owned'] = tpm.IsOwned ? 'Yes' : 'No';
        outputCount++;
      }
      if (outputCount > 0) {
        info['TPM'] = output;
    ...
    if (hardware.windows) {
      if (hardware.windows.memory) {
        var output = {},
          outputCount = 0,
          minfo = {};
        hardware.windows.memory.sort(function (a, b) {
          if (a.BankLabel > b.BankLabel) return 1;
          if (a.BankLabel < b.BankLabel) return -1;
          return 0;
        });
        for (var i in hardware.windows.memory) {
          var m = hardware.windows.memory[i],
            moutput = {},
            moutputCount = 0;
          if (m.Capacity && m.Speed) {
            moutput['Capacity/Speed'] = m.Capacity / 1024 / 1024 + ' Mb, ' + m.Speed + ' Mhz';
            moutputCount++;
          } else if (m.Capacity) {
            moutput['Capacity'] = m.Capacity / 1024 / 1024 + ' Mb';
            moutputCount++;
          }
          if (m.PartNumber) {
            moutput['Part Number'] =
              (m.Manufacturer && m.Manufacturer != 'Undefined' ? m.Manufacturer + ', ' : '') + m.PartNumber;
            moutputCount++;
          }
          if (moutputCount > 0) {
            minfo[m.BankLabel ? m.BankLabel : m.DeviceLocator ? m.DeviceLocator : 'Unknown'] = moutput;
            info['Memory'] = minfo;
          }
        }
      }
    ...
    if (hardware.identifiers && ident.storage_devices) {
      var output = {},
        ...
        minfo = {};
      // Sort Storage
      ident.storage_devices.sort(function (a, b) {
      ...
      for (var i in ident.storage_devices) {
        var m = ident.storage_devices[i],
          moutput = {};
        if (m.Size) {
          if (m.Model && m.Model != m.Caption) {
            moutput['Model'] = m.Model;
            outputCount++;
          }
          if (typeof m.Size == 'string' && parseInt(m.Size) == m.Size) {
            m.Size = parseInt(m.Size);
          }
          if (typeof m.Size == 'number') {
            moutput['Capacity'] = Math.floor(m.Size / 1024 / 1024) + 'Mb';
            outputCount++;
          }
          if (typeof m.Size == 'string') {
            moutput['Capacity'] = m.Size;
            outputCount++;
          }
          if (moutputCount > 0) {
            minfo[m.Caption] = moutput;
            info['Storage'] = minfo;
          }
        }
      }
...
function indexAgentErrorLog() {
  ...
  const lines = require('fs')
    .readFileSync('../meshcentral-data/agenterrorlogs.txt', { encoding: 'utf8', flag: 'r' })
    .split('\r\n');
  ...
  for (var i in errorIndex) {
    errorIndexCount.push({ m: i, c: errorIndex[i].length });
  }
  errorIndexCount = errorIndexCount.sort(function (a, b) {
    return b.c - a.c;
  });
  ...
  for (var i = 0; i < errorIndexCount.length; i++) {
    ...
    if (m.indexOf('STUCK') >= 0 || m.indexOf('FATAL') >= 0) {
      console.log(errorIndexCount[i].c, m);
    }
  }
}
