...
module.exports.ReadShort = function (v, p) {
  return (v.charCodeAt(p) << 8) + v.charCodeAt(p + 1);
};
module.exports.ReadShortX = function (v, p) {
  return (v.charCodeAt(p + 1) << 8) + v.charCodeAt(p);
};
module.exports.ReadInt = function (v, p) {
...
module.exports.ReadIntX = function (v, p) {
  return v.charCodeAt(p + 3) * 0x1000000 + (v.charCodeAt(p + 2) << 16) + (v.charCodeAt(p + 1) << 8) + v.charCodeAt(p);
};
module.exports.ShortToStr = function (v) {
  return String.fromCharCode((v >> 8) & 0xff, v & 0xff);
};
module.exports.ShortToStrX = function (v) {
  return String.fromCharCode(v & 0xff, (v >> 8) & 0xff);
};
module.exports.IntToStr = function (v) {
  return String.fromCharCode((v >> 24) & 0xff, (v >> 16) & 0xff, (v >> 8) & 0xff, v & 0xff);
};
module.exports.IntToStrX = function (v) {
  return String.fromCharCode(v & 0xff, (v >> 8) & 0xff, (v >> 16) & 0xff, (v >> 24) & 0xff);
};
module.exports.MakeToArray = function (v) {
  if (!v || v == null || typeof v == 'object') return v;
  return [v];
};
module.exports.SplitArray = function (v) {
  return v.split(',');
};
module.exports.Clone = function (v) {
  return JSON.parse(JSON.stringify(v));
};
module.exports.IsFilenameValid = (function () {
  var x1 = /^[^\\/:\*\?"<>\|]+$/,
    x2 = /^\./,
    x3 = /^(nul|prn|con|lpt[0-9]|com[0-9])(\.|$)/i;
  return function isFilenameValid(fname) {
    return (
      module.exports.validateString(fname, 1, 4096) &&
      x1.test(fname) &&
      !x2.test(fname) &&
      !x3.test(fname) &&
      fname[0] != '.'
...
module.exports.makeFilename = function (v) {
  return v
    .split('\\')
    .join('')
    .split('/')
...
module.exports.joinPath = function (base, path_) {
  return path.isAbsolute(path_) ? path_ : path.join(base, path_);
};

// Move an element from one position in an array to a new position
module.exports.ArrayElementMove = function (arr, from, to) {
...
module.exports.ObjectToStringEx = function (x, c) {
  ...
  if (x instanceof Array) {
    for (i in x) {
      r += '<br />' + gap(c) + 'Item #' + i + ': ' + module.exports.ObjectToStringEx(x[i], c + 1);
    }
  } else if (x instanceof Object) {
    for (i in x) {
      r += '<br />' + gap(c) + i + ' = ' + module.exports.ObjectToStringEx(x[i], c + 1);
    }
  } else {
    r += x;
  }
...
module.exports.gap2 = function (c) {
  var x = '';
  for (var i = 0; i < c * 4; i++) {
    x += ' ';
  }
...
module.exports.ObjectToString = function (x) {
  return module.exports.ObjectToStringEx(x, 0);
};
module.exports.ObjectToString2 = function (x) {
  return module.exports.ObjectToStringEx2(x, 0);
};
...
module.exports.char2hex = function (i) {
...
module.exports.rstr2hex = function (input) {
  ...
  for (i = 0; i < input.length; i++) {
    r += module.exports.char2hex(input.charCodeAt(i));
  }
  return r;
};
...
module.exports.random = function (max) {
  ...
  do {
    r = crypto.randomBytes(4).readUInt32BE(0) & maxmask;
  } while (r > max);
  return r;
};
...
module.exports.toNumber = function (str) {
  var x = parseInt(str);
  if (x == str) return x;
  return str;
};
module.exports.escapeHtml = function (string) {
...
module.exports.escapeHtmlBreaks = function (string) {
  return String(string).replace(/[&<>"'`=\/]/g, function (s) {
    return {
      '&': '&amp;',
      '<': '&lt;',
...
module.exports.zeroPad = function (num, c) {
  if (c == null) {
    c = 2;
  }
  var s = '000000' + num;
...
module.exports.objKeysToLower = function (obj, exceptions, parent) {
  for (var i in obj) {
    if (
      typeof obj[i] == 'object' &&
      (exceptions == null ||
        (exceptions.indexOf(i.toLowerCase()) == -1 &&
          (parent == null || exceptions.indexOf(parent.toLowerCase() + '/' + i.toLowerCase()) == -1)))
    ) {
...
module.exports.escapeFieldName = function (name) {
  if (name.indexOf(',') == -1 && name.indexOf('%') == -1 && name.indexOf('.') == -1 && name.indexOf('$') == -1)
    return name;
  return name.split('%').join('%25').split('.').join('%2E').split('$').join('%24').split(',').join('%2C');
};
module.exports.unEscapeFieldName = function (name) {
  if (name.indexOf('%') == -1) return name;
  return name.split('%2C').join(',').split('%2E').join('.').split('%24').join('$').split('%25').join('%');
};
...
module.exports.escapeLinksFieldNameEx = function (docx) {
  if (docx.links == null && docx.ssh == null && docx.rdp == null) {
    return docx;
  }
  return module.exports.escapeLinksFieldName(docx);
};
module.exports.escapeLinksFieldName = function (docx) {
  var doc = Object.assign({}, docx);
  if (doc.links != null) {
    doc.links = Object.assign({}, doc.links);
    for (var i in doc.links) {
      var ue = module.exports.escapeFieldName(i);
      if (ue !== i) {
        doc.links[ue] = doc.links[i];
        delete doc.links[i];
      }
    }
  }
  if (doc.ssh != null) {
    doc.ssh = Object.assign({}, doc.ssh);
    for (var i in doc.ssh) {
      var ue = module.exports.escapeFieldName(i);
      if (ue !== i) {
        doc.ssh[ue] = doc.ssh[i];
        delete doc.ssh[i];
      }
    }
  }
  if (doc.rdp != null) {
    doc.rdp = Object.assign({}, doc.rdp);
    for (var i in doc.rdp) {
      var ue = module.exports.escapeFieldName(i);
      if (ue !== i) {
        doc.rdp[ue] = doc.rdp[i];
        delete doc.rdp[i];
      }
    }
  }
...
module.exports.unEscapeLinksFieldName = function (doc) {
  if (doc.links != null) {
    for (var j in doc.links) {
      var ue = module.exports.unEscapeFieldName(j);
      if (ue !== j) {
        doc.links[ue] = doc.links[j];
        delete doc.links[j];
      }
    }
  }
  if (doc.ssh != null) {
    for (var j in doc.ssh) {
      var ue = module.exports.unEscapeFieldName(j);
      if (ue !== j) {
        doc.ssh[ue] = doc.ssh[j];
        delete doc.ssh[j];
      }
    }
  }
  if (doc.rdp != null) {
    for (var j in doc.rdp) {
      var ue = module.exports.unEscapeFieldName(j);
      if (ue !== j) {
        doc.rdp[ue] = doc.rdp[j];
        delete doc.rdp[j];
      }
    }
  }
...
module.exports.unEscapeAllLinksFieldName = function (docs) {
  for (var i in docs) {
    docs[i] = module.exports.unEscapeLinksFieldName(docs[i]);
  }
  return docs;
};
...
module.exports.aceEscapeFieldNames = function (docx) {
  var doc = Object.assign({}, docx);
  for (var k in aceEscFields) {
    if (typeof doc[aceEscFields[k]] == 'object') {
      doc[aceEscFields[k]] = Object.assign({}, doc[aceEscFields[k]]);
      for (var i in doc[aceEscFields[k]]) {
        var ue = encodeURIComponent(i);
        if (ue !== i) {
          doc[aceEscFields[k]][ue] = doc[aceEscFields[k]][i];
          delete doc[aceEscFields[k]][i];
        }
      }
    }
  }
...
module.exports.aceUnEscapeFieldNames = function (doc) {
  for (var k in aceEscFields) {
    if (typeof doc[aceEscFields[k]] == 'object') {
      for (var j in doc[aceEscFields[k]]) {
        var ue = decodeURIComponent(j);
        if (ue !== j) {
          doc[aceEscFields[k]][ue] = doc[aceEscFields[k]][j];
          delete doc[aceEscFields[k]][j];
        }
      }
    }
  }
...
module.exports.aceUnEscapeAllFieldNames = function (docs) {
  for (var i in docs) {
    docs[i] = module.exports.aceUnEscapeFieldNames(docs[i]);
  }
  return docs;
};

// Validation methods
module.exports.validateString = function (str, minlen, maxlen) {
  return (
    str != null &&
    typeof str == 'string' &&
...
module.exports.validateInt = function (int, minval, maxval) {
  return (
    int != null && typeof int == 'number' && (minval == null || int >= minval) && (maxval == null || int <= maxval)
  );
};
module.exports.validateArray = function (array, minlen, maxlen) {
  return (
    array != null &&
    Array.isArray(array) &&
    (minlen == null || array.length >= minlen) &&
    (maxlen == null || array.length <= maxlen)
  );
};
module.exports.validateStrArray = function (array, minlen, maxlen) {
  if ((array != null && Array.isArray(array)) == false) return false;
  for (var i in array) {
    if (
      typeof array[i] != 'string' ||
      (minlen != null && array[i].length < minlen) ||
      (maxlen != null && array[i].length > maxlen)
    )
      return false;
  }
  return true;
};
module.exports.validateObject = function (obj) {
  return obj != null && typeof obj == 'object';
};
module.exports.validateEmail = function (email, minlen, maxlen) {
  if (module.exports.validateString(email, minlen, maxlen) == false) return false;
  var emailReg =
    /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
  return emailReg.test(email);
};
module.exports.validateUsername = function (username, minlen, maxlen) {
  return (
    module.exports.validateString(username, minlen, maxlen) &&
    username.indexOf(' ') == -1 &&
    username.indexOf('"') == -1 &&
    username.indexOf(',') == -1
  );
...
module.exports.validateAlphaNumericArray = function (array, minlen, maxlen) {
  if ((array != null && Array.isArray(array)) == false) return false;
  for (var i in array) {
    if (
      typeof array[i] != 'string' ||
      module.exports.isAlphaNumeric(array[i]) == false ||
      (minlen != null && array[i].length < minlen) ||
      (maxlen != null && array[i].length > maxlen)
    )
      return false;
...
module.exports.validateEmailDomain = function (email, allowedDomains) {
  ...
  if (allowedDomains != null && Array.isArray(allowedDomains)) {
    ...
    for (var i in allowedDomains) {
      if (emaildomain == allowedDomains[i].toLowerCase()) {
        emailok = true;
      }
    }
    return emailok;
    ...
    try {
      ...
      function detectBuffer(b) {
        ...
        try {
          ...
          if (svgHead.charCodeAt(0) === 0xfeff) {
            svgHead = svgHead.slice(1);
          } // strip BOM
        ...
        return new Promise((resolveInspect) => {
          try {
            ...
            const to = setTimeout(() => {
              timedOut = true;
              try {
                getRes.destroy(new Error('timeout'));
              } catch (e) {}
            }, timeoutMs + 1000);
            ...
            function finalize(result) {
              ...
              clearTimeout(to);
              try {
                getRes.removeAllListeners('data');
                getRes.removeAllListeners('end');
                getRes.removeAllListeners('close');
                getRes.removeAllListeners('error');
              } catch (e) {}
              try {
                return resolveInspect(result);
              } catch (e) {
                return;
              }
            }
        ...
        try {
          ...
          if (err || (headRes && headRes.statusCode >= 400)) {
            ...
            if (err || status === 405 || status === 501 || status === 403) {
              try {
                if (headRes && headRes.resume) headRes.resume();
              } catch (e) {}
              const headers = {
                Range: 'bytes=0-' + (maxHeadBytes - 1),
                'User-Agent': 'MeshCentral/validateRemoteImage'
              };
          ...
          if (clen > 0 && clen > maxContentLength) {
            headRes.resume();
            return resolve(false);
          }
          if (ct && allowedMimes.indexOf(ct.split(';')[0].trim()) === -1) {
            headRes.resume();
            return resolve(false);
          }
...
module.exports.checkPasswordRequirements = function (password, requirements) {
  ...
  if (requirements.min) {
    if (password.length < requirements.min) return false;
  }
  if (requirements.max) {
    if (password.length > requirements.max) return false;
  }
  var numeric = 0,
    lower = 0,
    upper = 0,
...
module.exports.createTaskLimiterQueue = function (maxTasks, maxTaskTime, cleaningInterval) {
  ...
  obj.launch = function (func, arg, pri) {
    ...
    if (obj.currentCount < obj.maxTasks) {
      ...
      if (obj.timer == null) {
        obj.timer = setInterval(obj.clean, cleaningInterval * 1000);
      }
    } else {
      // Hold this task
      //console.log('Holding');
  ...
  obj.completed = function (taskid) {
    ...
    if (obj.current[taskid]) {
      delete obj.current[taskid];
      obj.currentCount--;
    } else {
      return;
    }
    while (
      obj.currentCount < obj.maxTasks &&
      (obj.pending[0].length > 0 || obj.pending[1].length > 0 || obj.pending[2].length > 0)
    ) {
      // Run this task now
      var t = null;
      if (obj.pending[0].length > 0) {
        t = obj.pending[0].shift();
      } else if (obj.pending[1].length > 0) {
        t = obj.pending[1].shift();
      } else if (obj.pending[2].length > 0) {
        t = obj.pending[2].shift();
      }
      const id = obj.nextTaskId++;
      obj.current[id] = Date.now() + obj.maxTaskTime;
      obj.currentCount++;
    ...
    if (
      obj.currentCount == 0 &&
      obj.pending[0].length == 0 &&
      obj.pending[1].length == 0 &&
      obj.pending[2].length == 0 &&
      obj.timer != null
    ) {
  ...
  obj.clean = function () {
    const t = Date.now();
    for (var i in obj.current) {
      if (obj.current[i] < t) {
        obj.completed(parseInt(i));
      }
    }
  };
...
module.exports.sortObj = function (obj) {
...
function validateObjectForMongoRec(obj, maxStrLen) {
  ...
  for (var i in obj) {
    ...
    for (var j in i) {
      const c = i.charCodeAt(j);
      if (c < 48 || (c > 57 && c < 65) || (c > 90 && c < 97 && c != 95) || c > 122) return false;
    }
    ...
    if (
      typeof obj[i] == 'object' &&
      Array.isArray(obj[i]) == false &&
      validateObjectForMongoRec(obj[i], maxStrLen) == false
    )
      return false;
  }
  return true;
...
module.exports.moveOldFiles = function (filelist) {
  ...
  do {
    extOk = true;
    if (++oldFileExtCount == 1) {
      oldFileExt = '-old';
    } else {
      oldFileExt = '-old' + oldFileExtCount;
    }
    for (var i in filelist) {
      if (fs.existsSync(filelist[i] + oldFileExt) == true) {
        extOk = false;
      }
    }
  } while (extOk == false);
  for (var i in filelist) {
    try {
      fs.renameSync(filelist[i], filelist[i] + oldFileExt);
    } catch (ex) {}
  }
};
