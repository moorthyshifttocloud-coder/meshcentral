!(function (t, e) {
  ...
  function U(t, e, i) {
    var s;
    H(t) &&
      ((s = e[t]), (i = i[t]), A(s) && A(i) ? $(s, i) : Object.prototype.hasOwnProperty.call(e, t) || (e[t] = N(i)));
  }
  ...
  function Ot(t, e, i) {
    ...
    if (t._sorted) {
      ...
      (d && (a = C(Math.min(f(r, l, h).lo, i ? s : f(e, l, o.getPixelForValue(h)).lo), 0, s - 1)),
        (n = u
          ? C(Math.max(f(r, o.axis, c, !0).hi + 1, i ? 0 : f(e, l, o.getPixelForValue(c), !0).hi + 1), a, s) - a
          : s - a));
    }
    ...
    _update(o = Date.now()) {
      ...
      (this._charts.forEach((s, a) => {
        if (s.running && s.items.length) {
          ...
          for (; 0 <= e; --e)
            (t = n[e])._active
              ? (t._total > s.duration && (s.duration = t._total), t.tick(o), (i = !0))
              : ((n[e] = n[n.length - 1]), n.pop());
          (i && (a.draw(), this._notify(a, s, o, 'progress')),
            n.length || ((s.running = !1), this._notify(a, s, o, 'complete'), (s.initial = !1)),
            (r += n.length));
        }
      }),
        (this._lastDate = o),
        ...
        (o =
          60 *
            (o =
              ((a = i),
              (i = t),
              (t = e) === s ? (a - i) / l + (a < i ? 6 : 0) : a === s ? (i - t) / l + 2 : (t - a) / l + 4)) +
          0.5)),
      [0 | o, r || 0, n]
    );
  }
  ...
  const Zt = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/,
    Jt = (t) => (t <= 0.0031308 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - 0.055),
  ...
  function ie(t) {
    ...
    return (
      Array.isArray(t)
        ? 3 <= t.length && ((e = { r: t[0], g: t[1], b: t[2], a: 255 }), 3 < t.length && (e.a = Rt(t[3])))
  ...
  class ae {
      ...
      ('object' == s
        ...
        : 'string' == s &&
          ...
          (a =
            ...
            (i = Gt[i.toLowerCase()]) && { r: i[0], g: i[1], b: i[2], a: 4 === i.length ? i[3] : 255 }) ||
            se(t))),
        (this._rgb = a),
        (this._valid = !!a));
    }
    ...
    rgbString() {
      return this._valid
        ? (t = this._rgb) && (t.a < 255 ? `rgba(${t.r}, ${t.g}, ${t.b}, ${o(t.a)})` : `rgb(${t.r}, ${t.g}, ${t.b})`)
        : void 0;
      var t;
    }
    hexString() {
      return this._valid
        ? ((t = this._rgb),
          ...
          t ? '#' + e(t.r) + e(t.g) + e(t.b) + ((t = t.a) < 255 ? e(t) : '') : void 0)
        : void 0;
      var t, e;
    }
    hslString() {
  ...
  function ne(t) {
    return (
      !(!t || 'object' != typeof t) &&
      ('[object CanvasPattern]' === (t = t.toString()) || '[object CanvasGradient]' === t)
    );
  }
  function oe(t) {
  ...
  function Se(t, e) {
    ...
    return (
      ...
      { x: Math.round((((t - h) / c) * i.width) / s), y: Math.round((((r - l) / d) * i.height) / s) }
    );
  }
  ...
  function De(t, e, i, s) {
    ...
    return (
      ...
      l && !h && (h = Pe(l / 2)),
      (void 0 !== e || void 0 !== i) && s && t.height && h > t.height && ((h = t.height), (l = Pe(Math.floor(h * s)))),
      { width: l, height: h }
    );
  }
  function Ce(t, e, i) {
    ...
    return (
      ...
      (t.currentDevicePixelRatio !== e || n.height !== s || n.width !== a) &&
        ((t.currentDevicePixelRatio = e), (n.height = s), (n.width = a), t.ctx.setTransform(e, 0, 0, e, 0, 0), !0)
    );
  }
  var Oe = (function () {
    let t = !1;
  ...
  function Fe(t, e, i, s, a) {
    ...
    if (
      g &&
      'object' == typeof g &&
      ('[object HTMLImageElement]' === (n = g.toString()) || '[object HTMLCanvasElement]' === n)
    )
      return (
        t.save(),
        t.translate(i, s),
            ...
            (at(d[t], 0, si)
              ...
              : ((e = u[t] / d[t]),
                ...
                (a = Math.pow(e, 2) + Math.pow(i, 2)) <= 9 ||
                  ((s = 3 / Math.sqrt(a)), (u[t] = e * s * d[t]), (u[t + 1] = i * s * d[t])))));
    }
    {
      var [f, p, m = 'x'] = [t, l, n];
      const b = ni(m),
      ...
      for (let t = 0; t < x; ++t)
        if (((i = s), (s = a), (a = ai(f, t + 1)), s)) {
          const x = s[m],
            v = s[b];
          (i && ((e = (x - i[m]) / 3), (s['cp1' + m] = x - e), (s['cp1' + b] = v - e * p[t])),
            a && ((e = (a[m] - x) / 3), (s['cp2' + m] = x + e), (s['cp2' + b] = v + e * p[t])));
        }
      return;
    }
  }
    ...
    if (e.capBezierPoints) {
      ...
      for (t = 0, e = h.length; t < e; ++t)
        ((a = s),
          ...
          s &&
            ((i = h[t]),
            a && ((i.cp1x = li(i.cp1x, c.left, c.right)), (i.cp1y = li(i.cp1y, c.top, c.bottom))),
            n && ((i.cp2x = li(i.cp2x, c.left, c.right)), (i.cp2y = li(i.cp2y, c.top, c.bottom)))));
    }
  }
  const ci = (t) => 0 === t || 1 === t,
    ...
    gi = {
      ...
      easeInOutBounce: (t) => (t < 0.5 ? 0.5 * gi.easeInBounce(2 * t) : 0.5 * gi.easeOutBounce(2 * t - 1) + 0.5)
    };
  function fi(t, e, i, s) {
  ...
  function Ci(t, e) {
    let i, s;
    ('ltr' !== e && 'rtl' !== e) ||
      ((s = [(i = t.canvas.style).getPropertyValue('direction'), i.getPropertyPriority('direction')]),
  ...
  function Li(t, i, g) {
    ...
    for (let t = c, e = c; t <= d; ++t)
      (b = i[t % o]).skip ||
        ((m = h(b[s])) !== x &&
          ((v = l(m, a, n)),
          null === (_ = null === _ && (v || (l(a, x, m) && 0 !== r(a, x))) ? (0 === r(m, a) ? t : e) : _) ||
            (v && 0 !== r(n, m) && !l(n, x, m)) ||
            (p.push(Ti({ start: _, end: t, loop: u, count: o, style: f })), (_ = null)),
          (e = t),
          (x = m)));
      ...
      !0 === n
        ...
        : (function (t, e, i, s) {
            ...
            for (o = e + 1; o <= i; ++o) {
              const i = t[o % a];
              (i.skip || i.stop
                ? l.skip || ((s = !1), n.push({ start: e % a, end: (o - 1) % a, loop: s }), (e = r = i.stop ? o : null))
                : ((r = o), l.skip && (e = o)),
                (l = i));
            }
      ...
      for (const r of t) {
        ...
        for (i = o + 1; i <= r.end; i++) {
          ...
          ((function (t, e) {
            ...
            (t = zi(
              h.setContext(
                Pi(d, { type: 'segment', p0: e, p1: f, p0DataIndex: (i - 1) % p, p1DataIndex: i % p, datasetIndex: g })
              )
            )),
            n
          ) && c(o, i - 1, r.loop, n),
            ...
            Vi(l, c, h, function (t, e, i) {
              ...
              (d && !a) ||
                ...
                (g || l.isPointInArea(s) || a) &&
                  ((a = m(h, s)) < o
                    ? ((n = [{ element: t, datasetIndex: e, index: i }]), (o = a))
                    : a === o && n.push({ element: t, datasetIndex: e, index: i })));
            }),
            n
          );
        }
  ...
  function ds(t, e, i) {
    (i && i.disconnect(),
      'resize' === e && ((i = t), rs.delete(i), rs.size || window.removeEventListener('resize', hs)));
  }
  function us(e, t, i) {
    var s = e.canvas,
      a = St((t) => {
        ...
        if (i && i.canvas === t) {
          {
            ...
            if (
              ((t[ts] = {
                initial: { height: n, width: o, style: { display: a.display, height: a.height, width: a.width } }
              }),
    ...
    update(t, e) {
      {
        if (0 !== this._properties.size)
          return (t = this._createAnimations(t, e)).length ? (l.add(this._chart, t), !0) : void 0;
        Object.assign(t, e);
      }
    }
  }
  ...
  class Os {
    ...
    parseObjectData(t, e, i, s) {
      ...
      let h, c, d, u;
      for (h = 0, c = s; h < c; ++h)
        ((u = e[(d = h + i)]), (l[h] = { x: a.parse(m(u, o), d), y: n.parse(m(u, r), d) }));
      return l;
    }
    getParsed(t) {
    ...
    _update(t) {
      ...
      (this.update(t || 'default'),
        (e._clip = (function (t) {
          let e, i, s, a;
          return (
            A(t) ? ((e = t.top), (i = t.right), (s = t.bottom), (a = t.left)) : (e = i = s = a = t),
  ...
  class zs extends e {
    ...
    getMinMax(i) {
      ...
      for (let t = 0, e = l.length; t < e; ++t)
        ((s = l[t].controller.getMinMax(this, i)), o || (a = Math.min(a, s.min)), r || (n = Math.max(n, s.max)));
    ...
    calculateLabelRotation() {
      ...
      let h,
        ...
        d,
        u = r;
      !this._isVisible() || !n.display || l <= r || o <= 1 || !this.isHorizontal()
    ...
    _calculatePadding(i, s, a, n) {
      ...
      if (this.isHorizontal()) {
        ...
        let t = 0,
          e = 0;
        (h
          ? (e = c ? ((t = n * i.width), a * s.height) : ((t = a * i.height), n * s.width))
          : 'start' === o
            ? (e = s.width)
            : 'end' === o
              ? (t = i.width)
        ...
        let t = s.height / 2,
          e = i.height / 2;
        ('start' === o ? ((t = 0), (e = i.height)) : 'end' === o && ((t = s.height), (e = 0)),
          (this.paddingTop = t + r),
    ...
    _computeGridLineItems(t) {
      ...
      if ('top' === o) ((m = e(this.bottom)), (y = this.bottom - d), (w = m - p), (S = e(t.top) + p), (D = t.bottom));
        ...
        ((m = e(this.right)), (_ = this.right - d), (M = m - p), (k = e(t.left) + p), (P = t.right));
      else if ('right' === o)
        ((m = e(this.left)), (k = t.left), (P = e(t.right) - p), (_ = m + p), (M = this.left + d));
      else if ('x' === i) {
    ...
    _getYAxisLabelAlignment(t) {
      ...
      return (
        'left' === e
          ? s
            ? ((r = this.right + a),
              'near' === i ? (o = 'left') : 'center' === i ? ((o = 'center'), (r += n / 2)) : ((o = 'right'), (r += n)))
            : ((r = this.right - t),
              'near' === i
                ? (o = 'right')
                : 'center' === i
    ...
    drawBorder() {
      ...
      if (l) {
        ...
        let t, e, i, s;
        (this.isHorizontal()
          ? ((t = Re(a, this.left, l) - l / 2), (e = Re(a, this.right, h) + h / 2), (i = s = c))
          : ((i = Re(a, this.top, l) - l / 2), (s = Re(a, this.bottom, h) + h / 2), (t = e = c)),
          n.save(),
          (n.lineWidth = r.width),
    ...
    drawTitle() {
      ...
      if (s.display) {
        ...
        'bottom' === i || 'center' === i || A(i)
          ? ((t += o.bottom), O(s.text) && (t += n.lineHeight * (s.text.length - 1)))
          : (t += o.top);
        var {
          titleX: o,
          titleY: l,
  ...
  function Gs(t, e, i) {
    ...
    return (
      a ||
        ((a = { resolver: Ye(e, i), subPrefixes: i.filter((t) => !t.toLowerCase().includes('hover')) }), s.set(t, a)),
      a
    );
  }
  ...
  function sa(t) {
    return (
      xe() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
  ...
  class i {
    ...
    buildOrUpdateScales() {
      ...
      (k(
        ...
        (t) => {
          ...
          (i in r && r[i].type === a
            ? (n = r[i])
            : ((n = new (b.getScale(a))({ id: i, type: a, ctx: this.ctx, chart: this })), (r[n.id] = n)),
            n.init(e, o));
        }
      ),
        k(l, (t, e) => {
    ...
    buildOrUpdateControllers() {
      ...
      for (this._removeUnreferencedMetasets(), s = 0, a = i.length; s < a; s++) {
        ...
        if (
          (t.type && t.type !== n && (this._destroyDatasetMeta(s), (t = this.getDatasetMeta(s))),
          (t.type = n),
          ...
          (Object.assign(i, { dataElementType: b.getElement(o), datasetElementType: a && b.getElement(a) }),
    ...
    render() {
      !1 !== this.notifyPlugins('beforeRender', { cancelable: !0 }) &&
        (l.has(this) ? this.attached && !l.running(this) && l.start(this) : (this.draw(), ea({ chart: this })));
    }
    draw() {
      let t;
    ...
    destroy() {
      ...
      (this._stop(),
        ...
        t && (this.unbindEvents(), Ie(t, e), this.platform.releaseContext(e), (this.canvas = null), (this.ctx = null)),
        delete aa[this.id],
    ...
    updateHoverStyle(t, e, i) {
      ...
      let a, n, o, r;
      for (
        'dataset' === e && (a = this.getDatasetMeta(t[0].datasetIndex)).controller['_' + s + 'DatasetHoverStyle'](),
          o = 0,
          r = t.length;
        o < r;
        ++o
  ...
  function ha(i, s, a, n) {
    if (O(i)) {
      ...
      (Math.abs(h) > Math.abs(d) && ((t = d), (e = h)),
        (r[l.axis] = e),
        (r._custom = { barStart: t, barEnd: e, start: c, end: o, min: h, max: d }));
  ...
  function ca(t, e, i, s) {
    const a = t.iScale,
      ...
      l = [];
    let h, c, d, u;
    for (c = (h = i) + s; h < c; ++h) ((u = e[h]), ((d = {})[a.axis] = r || a.parse(o[h], h)), l.push(ha(u, d, n, h)));
    return l;
  }
  function da(t) {
  ...
  function ua(t, e, i, s) {
    return (t = s ? ga((t = t === e ? i : t === i ? e : t), i, e) : ga(t, e, i));
  }
  function ga(t, e, i) {
  ...
  var ma = Object.freeze({
    ...
    BarController: class extends Os {
      ...
      parseObjectData(t, e, i, s) {
        ...
        let d, u, g, f;
        for (u = (d = i) + s; d < u; ++d)
          ((f = e[d]), ((g = {})[a.axis] = a.parse(m(f, l), d)), c.push(ha(m(f, h), g, n, d)));
        return c;
      }
      updateRangeFromParsed(t, e, i, s) {
      ...
      getLabelAndValue(t) {
        const e = this._cachedMeta,
          ...
          a = this.getParsed(t),
          n = a._custom,
          o = da(n) ? '[' + n.start + ', ' + n.end + ']' : '' + s.getLabelForValue(a[s.axis]);
        ...
        for (let t = i; t < i + s; t++) {
          const i = this.getParsed(t),
            ...
            x = {
              horizontal: h,
              base: s.base,
              enableBorderRadius: !b || da(i._custom) || o === b._top || o === b._bottom,
              x: h ? s.head : m.center,
              y: h ? m.center : s.head,
          ...
          ((function (n, t, e, i) {
            ...
            ('middle' === s &&
              ...
              (s = (e._top || 0) === i ? l : (e._bottom || 0) === i ? h : ((a[ua(h, t, o, r)] = !0), l))),
              (a[ua(s, t, o, r)] = !0),
              (n.borderSkipped = a));
          })(x, g, b, o),
      ...
      _getStacks(t, i) {
        ...
        for (const e of s)
          if (
            ...
            ((!1 === a || -1 === n.indexOf(e.stack) || (void 0 === a && void 0 === e.stack)) && n.push(e.stack),
            e.index === t)
          )
            break;
      ...
      _calculateBarValuePixels(t) {
        ...
        (f !== u && ((g = f - u), (f = u)),
          h && ((u = l.barStart), (f = l.barEnd - l.barStart), 0 !== u && y(u) !== y(l.barEnd) && (g = 0), (g += u)));
        var p,
          m,
          b = P(a) || h ? g : a;
        ...
        if (((c = this.chart.getDataVisibility(t) ? e.getPixelForValue(g + f) : x), (d = c - x), Math.abs(d) < n)) {
          ((d =
            ((b = d), (p = e), (m = o), (0 !== b ? y(b) : (p.isHorizontal() ? 1 : -1) * (p.min >= m ? 1 : -1)) * n)),
            u === o && (x -= d / 2));
            ...
            T = (
              'flex' === s.barThickness
                ...
                : function (t, e, i, s) {
                    ...
                    let n, o;
                    return (
                      (o = P(a) ? ((n = e.min * i.categoryPercentage), i.barPercentage) : ((n = a * s), 1)),
      ...
      updateElements(e, i, s, a) {
        ...
        for (let t = i; t < i + s; t++) {
          const i = e[t],
            ...
            u = {},
            g = (u[c] = n ? o.getPixelForDecimal(0.5) : o.getPixelForValue(s[c])),
            f = (u[d] = n ? r.getBasePixel() : r.getPixelForValue(s[d]));
          ((u.skip = isNaN(g) || isNaN(f)),
            h &&
              ((u.options = l || this.resolveDataElementOptions(t, i.active ? 'active' : a)),
  ...
  function Ma(t, e, i, s) {
    const { points: a, options: n } = e,
      ...
      c = n.stepped ? We : n.tension || 'monotone' === n.cubicInterpolationMode ? Ne : _a;
    let d,
      u,
      g,
    ...
    for (d = 0; d <= h; ++d)
      (u = a[(r + (p ? h - d : d)) % o]).skip ||
        (f ? (t.moveTo(u.x, u.y), (f = !1)) : c(t, g, u, p, n.stepped), (g = u));
  ...
  function ka(t) {
    ...
    return t._decimated || t._loop || e.tension || 'monotone' === e.cubicInterpolationMode || e.stepped || i ? Ma : wa;
  }
  ...
  class Pa extends e {
    ...
    updateControlPoints(t, e) {
      ...
      (!s.tension && 'monotone' !== s.cubicInterpolationMode) ||
        s.stepped ||
        this._pointsUpdated ||
        ((i = s.spanGaps ? this._loop : this._fullLoop), hi(this._points, s, t, i, e), (this._pointsUpdated = !0));
    }
    set points(t) {
    ...
    draw(t, e, i, s) {
      ...
      ((this.points || []).length &&
        ...
        (Sa && !a.options.segment
          ? function (t, e, i, s) {
              let a = e._path;
              (a || ((a = e._path = new Path2D()), e.path(a, i, s) && a.closePath()), va(t, e.options), t.stroke(a));
            }
          : function (t, e, i, s) {
  ...
  function Ca(t, e) {
    ...
    return (
      (h = t.horizontal
        ? ((c = n / 2), (o = Math.min(e, s)), (r = Math.max(e, s)), (l = i - c), i + c)
        : ((c = a / 2), (o = e - c), (r = e + c), (l = Math.min(i, s)), Math.max(i, s))),
      ...
      draw(t) {
        const {
          ...
          { inner: a, outer: n } =
            ...
            (d = c.borderSkipped),
            (r = {
              topLeft: Oa(!(c = r || A(m)) || d.top || d.left, l.topLeft, 0, h),
              topRight: Oa(!c || d.top || d.right, l.topRight, 0, h),
              bottomLeft: Oa(!c || d.bottom || d.left, l.bottomLeft, 0, h),
              bottomRight: Oa(!c || d.bottom || d.right, l.bottomRight, 0, h)
            }),
            {
          ...
          o = (m = n.radius).topLeft || m.topRight || m.bottomLeft || m.bottomRight ? je : Ta;
        var r, l, h, c, d, u, g, f, p, m;
        (t.save(),
          (n.w === a.w && n.h === a.h) ||
            (t.beginPath(), o(t, La(n, e, a)), t.clip(), o(t, La(a, -e, n)), (t.fillStyle = i), t.fill('evenodd')),
          t.beginPath(),
          o(t, La(a, e)),
          (t.fillStyle = s),
          t.fill(),
  ...
  class za extends zs {
    ...
    getTickLimit() {
      ...
      return (
        i
          ? 1e3 < (t = Math.ceil(this.max / i) - Math.floor(this.min / i) + 1) &&
            (console.warn(
    ...
    buildTicks() {
      ...
      const s = (function (t, e) {
        ...
        ((w = Math.ceil(p / k) - Math.floor(f / k)) > g && (k = nt((w * k) / g / u) * u),
          ...
          (M = 'ticks' === s ? ((y = Math.floor(f / k) * k), Math.ceil(p / k) * k) : ((y = f), p)),
          m && b && a && lt((o - n) / a, k / 1e3)
            ? ((w = Math.round(Math.min((o - n) / k, h))), (k = (o - n) / w), (y = n), (M = o))
            : x
              ? ((y = m ? n : y), (M = b ? o : M), (w = l - 1), (k = (M - y) / w))
              : (w = at((w = (M - y) / k), Math.round(w), k / 1e3) ? Math.round(w) : Math.ceil(w)));
        ...
        for (
          m &&
          (d && y !== n
            ? (i.push({ value: n }), y < n && S++, at(Math.round((y + S * k) * _) / _, n, Ia(n, v, t)) && S++)
            : y < n && S++);
          S < w;
          ++S
        ) {
    ...
    configure() {
      ...
      let e = this.min,
        i = this.max;
      (super.configure(),
        this.options.offset && t.length && ((t = (i - e) / Math.max(t.length - 1, 1) / 2), (e -= t), (i += t)),
        (this._startValue = e),
        (this._endValue = i),
  ...
  class Ha extends zs {
    ...
    determineDataLimits() {
      ...
      ((this.min = p(t) ? Math.max(0, t) : null),
        ...
        this._zero &&
          ...
          !p(this._userMin) &&
          (this.min = t === Ba(this.min, 0) ? Ba(this.min, -1) : Ba(this.min, 0)),
    ...
    buildTicks() {
      const t = this.options,
        e = (function (t, { min: e, max: i }) {
          ...
          for (; u < i; )
            (s.push({ value: u, major: Wa(u), significand: d }),
              10 <= d ? (d = d < 15 ? 15 : 20) : d++,
              20 <= d && (n++, (d = 2), (o = 0 <= n ? 1 : o)),
              (u = Math.round((l + c + d * Math.pow(10, n)) * o) / o));
          return ((e = g(t.max, u)), s.push({ value: e, major: Wa(e), significand: d }), s);
    ...
    getPixelForValue(t) {
      return null === (t = void 0 !== t && 0 !== t ? t : this.min) || isNaN(t)
        ? NaN
        : this.getPixelForDecimal(t === this.min ? 0 : (r(t) - this._startValue) / this._valueRange);
    }
    getValueForPixel(t) {
    ...
    for (let t = 0; t < o; t++) {
        ...
        c = Math.round(ct(u));
      {
        ...
        (m.start < f.l
          ...
          : m.end > f.r && ((t = (m.end - f.r) / x), (g.r = Math.max(g.r, f.r + t))),
          b.start < f.t
            ? ((e = (f.t - b.start) / p), (g.t = Math.min(g.t, f.t - e)))
            : b.end > f.b && ((e = (b.end - f.b) / p), (g.b = Math.max(g.b, f.b + e))));
      }
    }
    var d, u;
  ...
  class Xa extends za {
    ...
    fit() {
      var t = this.options;
      t.display && t.pointLabels.display ? $a(this) : this.setCenterPoint(0, 0, 0, 0);
    }
    ...
    getPointLabelContext(t) {
      ...
      if (0 <= t && t < e.length)
        return ((e = e[t]), Pi(this.getContext(), { label: e, index: t, type: 'pointLabel' }));
    }
          ...
          if (o.visible) {
            ...
            if (!P((r = f['backdropColor']))) {
              ...
              Object.values(p).some((t) => 0 !== t)
                ? (g.beginPath(), je(g, { x: f, y: r, w: x, h: m, radius: p }), g.fill())
                : g.fillRect(f, r, x, m);
            }
            var p = z(l.font),
  ...
  function Ga(t, e) {
    ...
    let o = e;
    return null ===
      (o = p((o = 'function' == typeof s ? s(o) : o)) ? o : 'string' == typeof s ? i.parse(o, s) : i.parse(o))
      ? null
      : +(o = a ? ('week' !== a || (!rt(n) && !0 !== n) ? i.startOf(o, a) : i.startOf(o, 'isoWeek', n)) : o);
  }
  function Za(e, i, s, a) {
    const n = h.length;
  ...
  class tn extends zs {
    ...
    determineDataLimits() {
      ...
      ((n && o) ||
        (r(this._getLabelBounds()), ('ticks' === t.bounds && 'labels' === t.ticks.source) || r(this.getMinMax(!1))),
    ...
    buildTicks() {
      ...
      return (
        (this._unit =
          e.unit ||
          (i.autoSkip
            ? Za(e.minUnit, this.min, this.max, this._getLabelCapacity(a))
            : (function (e, i, s, a, n) {
                for (let t = h.length - 1; t >= h.indexOf(s); t--) {
                  const s = h[t];
                  if (qa[s].common && e._adapter.diff(n, a, s) >= i - 1) return s;
                }
        ...
        (this._majorUnit =
          i.major.enabled && 'year' !== this._unit
            ? (function (i) {
                for (let t = h.indexOf(i) + 1, e = h.length; t < e; ++t) if (qa[h[t]].common) return h[t];
              })(this._unit)
            : void 0),
        this.initOffsets(s),
        t.reverse && n.reverse(),
    ...
    _generate() {
      ...
      let c,
        d,
        u = e;
      if ((l && (u = +t.startOf(u, 'isoWeek', r)), (u = +t.startOf(u, l ? 'day' : n)), t.diff(i, e, n) > 1e5 * o))
  ...
  function en(t, e, i) {
    ...
    i
      ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = f(t, 'pos', e)),
        ({ pos: s, time: n } = t[r]),
        ({ pos: a, time: o } = t[l]))
      : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = f(t, 'time', e)),
        ({ time: s, pos: n } = t[r]),
        ({ time: a, pos: o } = t[l]));
    i = a - s;
  ...
  function ln(n) {
    ...
    return (t, e) => {
      ...
      e instanceof fa
        ? (o = ((s = t), (a = o), (s.backgroundColor = s.data.map(() => on(a++))), a))
        : e instanceof pa
          ? (o = ((s = t), (i = o), (s.backgroundColor = s.data.map(() => rn(i++))), i))
          : e && (o = ((e = t), (t = o), (e.borderColor = on(t)), (e.backgroundColor = rn(t)), ++t));
    };
  }
  function hn(t) {
    let e;
    ...
    beforeLayout(t, e, i) {
      if (i.enabled) {
        const {
          ...
          n = a['elements'];
        (!i.forceOverride && (hn(s) || (a && (a.borderColor || a.backgroundColor)) || (n && hn(n)))) ||
          ((i = ln(t)), s.forEach(i));
      }
    }
  };
                    ...
                    t = (function (s, a, n, t) {
                      ...
                      for (o[l++] = s[p], c = 0; c < e - 2; c++) {
                        ...
                        var m = Math.floor(c * r) + 1 + a,
                          ...
                          { x, y: v } = s[p];
                        for (u = -1, t = m; t < b; t++)
                          (g = 0.5 * Math.abs((x - e) * (s[t].y - v) - (x - s[t].x) * (i - v))) > u &&
                            ((u = g), (d = s[t]), (f = t));
                        ((o[l++] = d), (p = f));
                      }
                      return ((o[l++] = s[h]), o);
                  ...
                  case 'min-max':
                    t = (function (t, e, i, s) {
                      ...
                      for (a = e; a < e + i; ++a) {
                        ...
                        const e = 0 | o;
                        if (e === l)
                          (r < u ? ((u = r), (h = a)) : r > g && ((g = r), (c = a)), (f = (p * f + n.x) / ++p));
                        else {
                          const i = a - 1;
                          if (!P(h) && !P(c)) {
  ...
  function bn(e, t) {
    ...
    return (i = O(e)
      ...
      ? new Pa({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s })
      : null;
  }
  function xn(t) {
    return t && !1 !== t.fill;
    ...
    s = (function (t) {
      ...
      if (e.getPointPositionForValue) {
        ...
        if (o.grid.circular) {
          ...
          return new _n({ x: i.x, y: i.y, radius: a.getDistanceFromCenterForValue(h) });
        }
  ...
  function Mn(t, e, i) {
    ...
    a &&
      ...
      ({
        ...
        area: n,
        scale: o
      } = e = { line: e, target: a, above: l, below: r, area: i, scale: n, axis: o }),
  ...
  function wn(t, e, i) {
    ...
    for (const r of s) {
      ...
      (n ? (t.moveTo(h.x, h.y), (n = !1)) : (t.lineTo(h.x, i), t.lineTo(h.x, h.y)),
        (o = !!e.pathSegment(t, r, { move: o })) ? t.closePath() : t.lineTo(c.x, i));
    }
  ...
  var Pn = {
            ...
            (l = {
              ...
              fill: (function (s, t, e) {
                ...
                return p(n) && Math.floor(n) === n
                  ? ((a = i[0]), (n = n), !((n = '-' !== a && '+' !== a ? n : t + n) === t || n < 0 || e <= n) && n)
                  : 0 <= ['origin', 'start', 'end', 'stack', 'shape'].indexOf(i) && i;
              })(r, o, s),
              chart: t,
    ...
    beforeDraw(e, t, i) {
      ...
      for (let t = a.length - 1; 0 <= t; --t) {
        const i = a[t].$filler;
        i && (i.line.updateControlPoints(n, i.axis), s && i.fill && Mn(e.ctx, i, n));
      }
    },
    ...
    beforeDatasetDraw(t, e, i) {
      e = e.meta.$filler;
      xn(e) && 'beforeDatasetDraw' === i.drawTime && Mn(t.ctx, e, t.chartArea);
    },
  ...
  class Cn extends e {
          ...
          var i,
            ...
            { itemWidth: t, itemHeight: o } = {
              ...
              itemHeight: (function (t) {
                let e = n;
                return (e = 'string' != typeof a.text ? On(a, t) : e);
              })(i.lineHeight)
            };
          (0 < e &&
            b + o + 2 * d > f &&
            ((p += m + d), g.push({ width: m, height: b }), (x += m + d), v++, (m = b = 0)),
    ...
    adjustHitBoxes() {
      if (this.options.display) {
        ...
        if (this.isHorizontal()) {
          ...
          for (const r of s)
            (t !== r.row && ((t = r.row), (e = E(a, this.left + n, this.right - this.lineWidths[t]))),
              (r.top += this.top + i + n),
          ...
          for (const l of s)
            (l.col !== t && ((t = l.col), (e = E(a, this.top + i + n, this.bottom - this.columnSizes[t].height))),
              (l.top = e),
              (l.left += this.left + n),
    ...
    _draw() {
      ...
      const { boxWidth: M, boxHeight: w, itemHeight: k } = Dn(f, v),
        ...
        D =
          ((y = S
            ? { x: E(g, this.left + x, this.right - d[0]), y: this.top + x + P, line: 0 }
            : { x: this.left + x, y: E(g, this.top + P + x, this.bottom - c[0].height), line: 0 }),
      ...
      (this.legendItems.forEach((t, e) => {
        ...
        (m.setWidth(this.width),
          S
            ? 0 < e &&
              a + i + x > this.right &&
              ((n = y.y += D), y.line++, (a = y.x = E(g, this.left + x, this.right - d[y.line])))
            : 0 < e &&
              n + D > this.bottom &&
        ...
        if (!(isNaN(M) || M <= 0 || isNaN(w) || w < 0)) {
          ...
          if (
            ...
            const f = o + Math.max((v - w) / 2, 0),
              ...
              T = wi(r.borderRadius);
            (u.beginPath(),
              Object.values(T).some((t) => 0 !== t) ? je(u, { x: p, y: f, w: M, h: w, radius: T }) : u.rect(p, f, M, w),
              u.fill(),
              0 !== l && u.stroke());
          }
          u.restore();
        ...
        if (
          ...
          (e = n),
          (r = t),
          He(u, r.text, o, e + k / 2, b, { strikethrough: r.hidden, textAlign: m.textAlign(r.textAlign) }),
          S)
        )
          y.x += i + x;
    ...
    drawTitle() {
      ...
      if (a.display) {
        ...
        let t,
          ...
          i = this.width;
        if (this.isHorizontal())
          ((i = Math.max(...this.lineWidths)), (t = this.top + u), (e = E(s.align, e, this.right - i)));
        else {
    ...
    handleEvent(t) {
      var e,
        ...
        s,
        a = this.options;
      ((('mousemove' !== (e = t.type) && 'mouseout' !== e) || (!a.onHover && !a.onLeave)) &&
  ...
  class Yn extends e {
    ...
    getContext() {
      return (
        this.$context ||
        (this.$context =
          ((t = this.chart.getContext()), Pi(t, { tooltip: this, tooltipItems: this._tooltipItems, type: 'tooltip' })))
      );
      var t;
    }
    getTitle(t, e) {
    ...
    getBeforeBody(t, e) {
      return Nn(w(e.callbacks, 'beforeBody', this, t));
    }
    getBody(t, e) {
      const s = e['callbacks'],
        a = [];
    ...
    getAfterBody(t, e) {
      return Nn(w(e.callbacks, 'afterBody', this, t));
    }
    getFooter(t, e) {
      var e = e['callbacks'],
    ...
    update(t, e) {
      ...
      if (s.length) {
        ...
        ((this.xAlign = r.xAlign),
          ...
          (a = { opacity: 1, x: l.x, y: l.y, width: e.width, height: e.height, caretX: t.x, caretY: t.y }));
      ...
      return (
        'center' === a
          ? ((p = h + c / 2),
            ...
            (g = d))
          : ((u = 'left' === s ? t + Math.max(n, r) + i : 'right' === s ? t + e - Math.max(o, l) - i : this.caretX),
            (g =
              'top' === a
                ? ((f = h), (p = f - i), (d = u - i), u + i)
      ...
      for (
        ...
        for (
          m = s[v],
            ...
            k(m.before, g),
            x = m.lines,
            o && x.length && (this._drawColorBox(i, e, v, f, t), (d = Math.max(c.lineHeight, r))),
            _ = 0,
            M = x.length;
          _ < M;
          ++_
    ...
    drawFooter(t, e, i) {
      ...
      if (a) {
        ...
        for (
          ...
          (e.fillText(s[o], r.x(t.x), t.y + n.lineHeight / 2), (t.y += n.lineHeight + i.footerSpacing));
      }
    }
    ...
    _updateAnimationTarget(t) {
      ...
      if (s || a) {
        ...
        i &&
          ...
          (o = Bn(t, (o = Object.assign({}, i, this._size)), (t = Vn(e, t, o)), e)),
          (s._to === o.x && a._to === o.y) ||
