...
var MeshServerCreateControl = function (domain, authCookie) {
  ...
  obj.Start = function () {
    ...
    obj.socket.onopen = function (e) {
      obj.connectstate = 1;
      if (obj.authCookie && obj.authCookie != '') {
        obj.send({ action: 'urlargs', args: { auth: obj.authCookie } });
      }
    };
    ...
    obj.pingTimer = setInterval(function () {
      obj.send({ action: 'ping' });
    }, 29000); // Ping the server every 29 seconds, stops corporate proxies from disconnecting.
  };
  ...
  obj.xxOnMessage = function (e) {
    ...
    if (typeof message != 'object' || message.action == 'pong') {
      return;
    }
