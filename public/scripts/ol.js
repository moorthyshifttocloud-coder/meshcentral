...
(function (root, factory) {
  ...
  function Na(a) {
    for (var b = Oa(), c = 0, d = a.length; c < d; ++c) Pa(b, a[c]);
    return b;
  }
  function Qa(a, b, c) {
    return c
  ...
  function db(a, b, c) {
    var d;
    return (d = b.call(c, eb(a))) || (d = b.call(c, gb(a))) || (d = b.call(c, hb(a)))
      ? d
      : (d = b.call(c, ib(a)))
        ? d
        : !1;
...
*/
  ...
  xb.prototype.a = function (a) {
    for (var b = 0, c = a.length, d = a[c - 1][0], e = a[c - 1][1], f = 0; f < c; f++)
      var g = a[f][0], h = a[f][1], b = b + Ha(g - d) * (2 + Math.sin(Ha(e)) + Math.sin(Ha(h))), d = g, e = h;
  ...
  xb.prototype.offset = function (a, b, c) {
    ...
    return [
      (180 *
        (Ha(a[0]) + Math.atan2(Math.sin(c) * Math.sin(b) * Math.cos(d), Math.cos(b) - Math.sin(d) * Math.sin(e)))) /
        Math.PI,
      (180 * e) / Math.PI
    ];
  };
  ...
  function Ib(a, b, c) {
    ...
    void 0 === b && (2 < c ? (b = a.slice()) : (b = Array(d)));
    for (var e = 0; e < d; e += c)
      ((b[e] = (180 * a[e]) / Fb), (b[e + 1] = (360 * Math.atan(Math.exp(a[e + 1] / 6378137))) / Math.PI - 90));
    return b;
  }
  ...
  var Lb = [-180, -90, 180, 90],
    ...
    Nb = [
      new Kb('CRS:84'),
      new Kb('EPSG:4326', 'neu'),
      new Kb('urn:ogc:def:crs:EPSG::4326', 'neu'),
      new Kb('urn:ogc:def:crs:EPSG:6.6:4326', 'neu'),
      new Kb('urn:ogc:def:crs:OGC:1.3:CRS84'),
      new Kb('urn:ogc:def:crs:OGC:2:84'),
      new Kb('http://www.opengis.net/gml/srs/epsg.xml#4326', 'neu'),
      new Kb('urn:x-ogc:def:crs:EPSG:4326', 'neu')
    ];
  var Ob = {};
  var Pb = {};
  function Qb(a, b, c) {
  ...
  function Tb(a) {
    var b = null;
    if (a instanceof Bb) b = a;
    else if ('string' === typeof a) {
      var b = Ob[a] || null,
        c = Ab || window.proj4;
      b || 'function' != typeof c || void 0 === c.defs(a) || ((b = new Bb({ code: a })), Xb(b));
    }
    return b;
  }
  function dc(a, b) {
  ...
  function Vb(a, b) {
    ...
    if (!e) {
      ...
      if ('function' == typeof f) {
        ...
        void 0 !== g &&
          void 0 !== h &&
          (g === h ? Wb([b, a]) : ((e = f(d, c)), ac(b, a, e.forward, e.inverse)), (e = Rb(c, d)));
      }
    }
    e || (e = fc);
    return e;
  ...
  function lc(a) {
    ...
    this.c = null;
    void 0 !== a.origins && ((this.c = a.origins), xa(this.c.length == this.b.length, 20));
    var b = a.extent;
    void 0 === b || this.i || this.c || (this.i = ib(b));
    xa((!this.i && this.c) || (this.i && !this.c), 18);
    this.f = null;
    void 0 !== a.tileSizes && ((this.f = a.tileSizes), xa(this.f.length == this.b.length, 19));
  ...
  k.Rf = function (a, b, c) {
    a = oc(this, a, b);
    for (var d = a.ca, e = a.$; d <= e; ++d) for (var f = a.da, g = a.ia; f <= g; ++f) c([b, d, f]);
  };
  function pc(a, b, c, d, e) {
    e = a.Aa(b, e);
    for (b = b[0] - 1; b >= a.minZoom; ) {
      if (c.call(null, b, oc(a, e, b, d))) return !0;
      --b;
    }
    return !1;
  }
  ...
  function rc(a, b, c, d) {
    ...
    a = nc[1];
    b = nc[2];
    void 0 !== d ? ((d.ca = e), (d.$ = a), (d.da = f), (d.ia = b)) : (d = new ya(e, a, f, b));
    return d;
  }
  function oc(a, b, c, d) {
  ...
  function mc(a, b) {
    for (var c = a.b.length, d = Array(c), e = a.minZoom; e < c; ++e) d[e] = oc(a, b, e);
    a.a = d;
  }
  function vc(a) {
    var b = a.j;
  ...
  function wc(a, b, c) {
    a = zc(a);
    b = yc(a, b, c);
    return new lc({ extent: a, origin: ib(a), resolutions: b, tileSize: c });
  }
  function zc(a) {
    a = Tb(a);
    var b = a.G();
    b || ((a = (180 * zb.degrees) / a.sc()), (b = Xa(-a, -a, a, a)));
    return b;
  }
  function Ac(a) {
    this.b = a.html;
  ...
  function Bc(a) {
    return function (b) {
      if (b) return [Ca(b[0], a[0], a[2]), Ca(b[1], a[1], a[3])];
    };
  }
  function Cc(a) {
    return a;
  ...
  function Fc(a, b, c, d) {
    for (var e, f = 0, g = a.length; f < g; ++f)
      if (((e = a[f]), e.listener === b && e.lh === c)) return (d && (e.deleteIndex = f), e);
  }
  function Gc(a, b) {
  ...
  function Ic(a, b) {
    var c = Gc(a, b);
    if (c) {
      for (var d = 0, e = c.length; d < e; ++d) (a.removeEventListener(b, c[d].mh), ub(c[d]));
      c.length = 0;
      if ((c = a.fb)) (delete c[b], Object.keys(c).length || delete a.fb);
    }
  }
  function y(a, b, c, d, e) {
    ...
    (f = Fc(g, c, d, !1))
      ? e || (f.nh = !1)
      : ((f = { lh: d, nh: !!e, listener: c, target: a, type: b }), a.addEventListener(b, Dc(f)), g.push(f));
    return f;
  }
  function Jc(a, b, c, d) {
    return y(a, b, c, d, !0);
  ...
  Qc.prototype.b = function (a) {
    ...
    if (c) {
      ...
      if (!this.ra[a]) {
        b = this.Ua[a];
        for (delete this.Ua[a]; b--; ) this.removeEventListener(a, ua);
        delete this.ra[a];
      }
      return f;
    }
  ...
  Qc.prototype.removeEventListener = function (a, b) {
    ...
    c &&
      ((b = c.indexOf(b)),
      a in this.Ua ? ((c[b] = ua), ++this.Ua[a]) : (c.splice(b, 1), c.length || delete this.oa[a]));
  };
  function Sc() {
    Qc.call(this);
    this.i = 0;
  ...
  k.once = function (a, b, c) {
    if (Array.isArray(a)) {
      for (var d = a.length, e = Array(d), f = 0; f < d; ++f) e[f] = Jc(this, a[f], b, c);
      return e;
    }
    return Jc(this, a, b, c);
  };
  k.K = function (a, b, c) {
    if (Array.isArray(a)) for (var d = 0, e = a.length; d < e; ++d) Kc(this, a[d], b, c);
    else Kc(this, a, b, c);
  };
  function Tc(a) {
    Sc.call(this);
  ...
  k.set = function (a, b, c) {
    c ? (this.S[a] = b) : ((c = this.S[a]), (this.S[a] = b), c !== b && Wc(this, a, c));
  };
  k.H = function (a, b) {
  ...
  function Yc(a, b) {
    ...
    this.c = !!(b || {}).unique;
    this.a = a ? a : [];
    if (this.c) for (a = 0, b = this.a.length; a < b; ++a) Zc(this, this.a[a], a);
    $c(this);
  }
  v(Yc, Tc);
  k = Yc.prototype;
  ...
  k.remove = function (a) {
    var b = this.a,
      c;
    var d = 0;
    for (c = b.length; d < c; ++d) if (b[d] === a) return this.Hg(d);
  };
  k.Hg = function (a) {
    var b = this.a[a];
    this.a.splice(a, 1);
  ...
  function Zc(a, b, c) {
    for (var d = 0, e = a.a.length; d < e; ++d) if (a.a[d] === b && d !== c) throw new wa(58);
  }
  var ad = 'length';
  function bd(a, b) {
    Oc.call(this, a);
      ...
      if (a.hasOwnProperty(c)) var d = a[c];
        ...
        if (cd.exec(d)) {
          ...
          d.indexOf('rgba(')
            ? d.indexOf('rgb(')
              ? xa(!1, 14)
              : ((d = d.slice(4, -1).split(',').map(Number)), d.push(1), (f = hd(d)))
            : ((d = d.slice(5, -1).split(',').map(Number)), (f = hd(d)));
        d = f;
        a[c] = d;
        ++b;
      }
  ...
  function hd(a) {
    var b = [];
    b[0] = Ca((a[0] + 0.5) | 0, 0, 255);
    b[1] = Ca((a[1] + 0.5) | 0, 0, 255);
    b[2] = Ca((a[2] + 0.5) | 0, 0, 255);
    b[3] = Ca(a[3], 0, 1);
    return b;
  }
  function id(a) {
  ...
  md.prototype.setMap = function (a) {
    ...
    for (var b = 0, c = this.v.length; b < c; ++b) Ec(this.v[b]);
    this.v.length = 0;
    if ((this.a = a))
  ...
  function nd(a) {
    ...
    c.className =
      ...
      (this.c && this.o ? ' ol-collapsed' : '') +
      (this.o ? '' : ' ol-uncollapsible');
    c.appendChild(this.I);
    c.appendChild(d);
    md.call(this, { element: c, render: a.render ? a.render : od, target: a.target });
    this.B = !0;
    this.l = {};
    this.j = {};
    this.T = {};
  ...
  function od(a) {
    if ((a = a.frameState)) {
          ...
          if ((f = e.j)) {
            ...
            for (c = f.length; r < c; r++) {
              ...
              if (!(x in h)) {
                      ...
                      for (E in d)
                        if (E in L.a) {
                          ...
                          for (A = L.a[E].length; ga < A; ++ga) {
                            ...
                            if (B.ca < M.ca || B.$ > M.$)
                              if (
                                Ba(z, new ya(Ia(B.ca, ba), Ia(B.$, ba), B.da, B.ia)) ||
                                (B.$ - B.ca + 1 > ba && Ba(z, M))
                              ) {
                                E = !0;
                                break a;
                ...
                E ? (x in l && delete l[x], (E = u.b), E in m || ((m[E] = !0), (h[x] = u))) : (l[x] = u);
              }
            }
          }
        }
      ...
      for (var da in this.l)
        da in p
          ? (this.j[da] || ((this.l[da].style.display = ''), (this.j[da] = !0)), delete p[da])
          : da in b
            ? (this.j[da] && ((this.l[da].style.display = 'none'), delete this.j[da]), delete b[da])
            : (ld(this.l[da]), delete this.l[da], delete this.j[da]);
      for (da in p)
      ...
      this.B != da && ((this.element.style.display = da ? '' : 'none'), (this.B = da));
      da && wb(this.j) ? this.element.classList.add('ol-logo-only') : this.element.classList.remove('ol-logo-only');
      a = a.logos;
      da = this.T;
      for (ca in da) ca in a || (ld(da[ca]), delete da[ca]);
      for (var fb in a)
        if (((b = a[fb]), b instanceof HTMLElement && (this.u.appendChild(b), (da[fb] = b)), !(fb in da))) {
          var ca = new Image();
          ca.src = fb;
  ...
  k.Xm = function (a) {
    this.o !== a && ((this.o = a), this.element.classList.toggle('ol-uncollapsible'), !a && this.c && pd(this));
  };
  k.Wm = function (a) {
  ...
  function ud(a) {
    ...
    this.c = null;
    'string' === typeof c
      ? ((this.c = document.createElement('span')), (this.c.className = 'ol-compass'), (this.c.textContent = c))
    ...
    md.call(this, { element: d, render: b, target: a.target });
  ...
  ud.prototype.D = function (a) {
    ...
    this.o
      ...
      : (a = this.a.Z()) &&
        void 0 !== a.Qa() &&
        (0 < this.l ? a.animate({ rotation: 0, duration: this.l, easing: rd }) : a.Oe(0));
  };
  function vd(a) {
    if ((a = a.frameState)) {
  ...
  function wd(a) {
    ...
    c.appendChild(h);
    c.appendChild(d);
    md.call(this, { element: c, target: a.target });
  ...
  wd.prototype.j = function (a, b) {
    ...
    if ((b = this.a.Z())) {
      ...
      c &&
        ...
        0 < this.c ? (b.Ic() && b.ed(), b.animate({ resolution: a, duration: this.c, easing: rd })) : b.Vc(a));
    }
  };
  function xd(a) {
    a = a ? a : {};
  ...
  yd.prototype.C = function (a) {
    ...
    Ad() &&
      ...
      (zd()
        ...
        : ((a = this.j ? ('string' === typeof this.j ? document.getElementById(this.j) : this.j) : a.jd()),
          this.D
  ...
  yd.prototype.u = function () {
    var a = this.element.firstElementChild,
      b = this.a;
    zd()
      ? ((a.className = this.c + '-true'), kd(this.l, this.o))
      : ((a.className = this.c + '-false'), kd(this.o, this.l));
    b && b.Ad();
  };
  ...
  function Dd(a) {
    ...
    md.call(this, { element: b, render: a.render ? a.render : Ed, target: a.target });
  ...
  k.setMap = function (a) {
    md.prototype.setMap.call(this, a);
    a && ((a = a.a), this.v.push(y(a, 'mousemove', this.Ll, this), y(a, 'mouseout', this.Ml, this)));
  };
  k.kj = function (a) {
    this.set(Hd, a);
  };
  ...
  function Gd(a, b) {
    ...
    if (b && a.c) {
      ...
      if ((b = a.a.Wa(b))) (a.j(b, b), (c = (c = a.xh()) ? c(b) : b.toString()));
    }
    (a.l && c == a.l) || ((a.element.innerHTML = c), (a.l = c));
  }
  var Fd = 'projection',
    Hd = 'coordinateFormat';
  function Id(a, b, c) {
  ...
  function Ld(a, b) {
    ...
    for (d = 0; d < e; ++d)
      try {
        if ((c = a.getContext(Kd[d], b))) return c;
      } catch (f) {}
    return null;
  }
  var Md,
    Nd = 'undefined' !== typeof navigator ? navigator.userAgent.toLowerCase() : '',
    Od = -1 !== Nd.indexOf('firefox'),
    Pd = -1 !== Nd.indexOf('safari') && -1 == Nd.indexOf('chrom'),
    Qd = -1 !== Nd.indexOf('webkit') && -1 == Nd.indexOf('edge'),
    Rd = -1 !== Nd.indexOf('macintosh'),
    Sd = window.devicePixelRatio || 1,
    Td = !1,
    Ud = (function () {
      if (!('HTMLCanvasElement' in window)) return !1;
      try {
        var a = document.createElement('CANVAS').getContext('2d');
        return a ? (void 0 !== a.setLineDash && (Td = !0), !0) : !1;
      } catch (b) {
        return !1;
      }
    })(),
    Vd = 'DeviceOrientationEvent' in window,
    Wd = 'geolocation' in navigator,
    Xd = 'ontouchstart' in window,
    Yd = 'PointerEvent' in window,
    Zd = !!navigator.msPointerEnabled,
    $d = !1,
    ae,
    be = [];
  if ('WebGLRenderingContext' in window)
    try {
      var ce = Ld(document.createElement('CANVAS'), { failIfMajorPerformanceCaveat: !0 });
      ce && (($d = !0), (ae = ce.getParameter(ce.MAX_TEXTURE_SIZE)), (be = ce.getSupportedExtensions()));
    } catch (a) {}
  Md = $d;
  fa = be;
  ea = ae;
  ...
  k.jm = function (a) {
    if (!he(this, a)) {
      ...
      b && b.button === a.button && ((b = ie(a)), ke(this.b, 'pointerup', b, a), delete this.a[(1).toString()]);
    }
  };
  k.im = function (a) {
    if (!he(this, a)) {
  ...
  function oe(a, b) {
    var c = b;
    'number' === typeof b.pointerType && ((c = je(b, b)), (c.pointerType = a.i[b.pointerType]));
    return c;
  }
  k = ne.prototype;
  k.om = function (a) {
  ...
  function ve(a, b) {
    fe.call(this, a, { touchstart: this.rq, touchmove: this.qq, touchend: this.pq, touchcancel: this.oq });
    this.a = a.i;
    this.j = b;
    this.i = void 0;
    this.g = 0;
  ...
  k.rq = function (a) {
    ...
    if (d >= b.length) {
      ...
      for (f = 0; f < e.length; ++f) this.Kf(a, e[f]);
    }
    b = a.changedTouches[0];
    c = Object.keys(this.a).length;
    if (!c || (1 === c && (1).toString() in this.a))
      ((this.i = b.identifier), void 0 !== this.c && clearTimeout(this.c));
    ye(this, a);
    this.g++;
    xe(this, a, this.cp);
  };
  k.cp = function (a, b) {
    this.a[b.pointerId] = { target: b.target, out: b, Wi: b.target };
    var c = this.b;
    b.bubbles = !0;
  ...
  k.km = function (a, b) {
    ...
    if (c) {
      ...
      d &&
        ...
        (b.relatedTarget = e),
        (d.target = e),
        b.target ? (me(this.b, d, a), le(this.b, b, a)) : ((b.target = e), (b.relatedTarget = null), this.Kf(a, b)));
      c.out = b;
      c.Wi = b.target;
    }
  };
  ...
  k.sq = function (a, b) {
    ...
    b.isPrimary && ((this.i = void 0), (this.c = setTimeout(this.ij.bind(this), 200)));
  };
  k.oq = function (a) {
    xe(this, a, this.Kf);
  };
  ...
  function Ae(a) {
    ...
    Yd
      ...
      : Zd
        ? Be(this, new ne(this))
        : ((a = new ge(this)), Be(this, a), Xd && Be(this, new ve(this, a)));
    a = this.a.length;
    for (var b, c = 0; c < a; c++) ((b = this.a[c]), Ce(this, Object.keys(b.f)));
  }
  v(Ae, Qc);
  function Be(a, b) {
  ...
  function le(a, b, c) {
    ...
    var d = b.target,
      e = b.relatedTarget;
    (d && e && d.contains(e)) || ((b.bubbles = !1), ke(a, 'pointerenter', b, c));
  }
  function ke(a, b, c, d) {
    a.b(new pe(b, d, c));
  }
  ...
  Ae.prototype.ka = function () {
    for (var a = this.a.length, b, c = 0; c < a; c++) ((b = this.a[c]), De(this, Object.keys(b.f)));
  ...
  function Ge(a, b) {
    ...
    a.b(c);
    a.j
      ? (clearTimeout(a.j), (a.j = 0), (c = new ee('dblclick', a.i, b)), a.b(c))
      : (a.j = setTimeout(
          function () {
            this.j = 0;
  ...
  function He(a, b) {
    'pointerup' == b.type || 'pointercancel' == b.type
      ? delete a.u[b.pointerId]
      : 'pointerdown' == b.type && (a.u[b.pointerId] = !0);
  ...
  k.Jh = function (a) {
    ...
    this.S || (this.f.forEach(Ec), (this.f.length = 0), (this.o = !1), (this.c = null), Nc(this.a), (this.a = null));
  };
  k.Ol = function (a) {
    He(this, a);
    ...
    this.c = a;
    this.f.length ||
      ((this.a = new Ae(document)),
      this.f.push(
        y(this.a, 'pointermove', this.Hm, this),
        y(this.a, 'pointerup', this.Jh, this),
  ...
  k.ka = function () {
    this.v && (Ec(this.v), (this.v = null));
    this.l && (Ec(this.l), (this.l = null));
    this.f.forEach(Ec);
    this.f.length = 0;
    this.a && (Nc(this.a), (this.a = null));
    this.g && (Nc(this.g), (this.g = null));
    Qc.prototype.ka.call(this);
  };
  function Ke(a, b) {
    this.l = a;
  ...
  function Le(a) {
    var b = a.b,
      c = a.i,
      d = b[0];
    1 == b.length ? ((b.length = 0), (c.length = 0)) : ((b[0] = b.pop()), (c[0] = c.pop()), Me(a, 0));
    b = a.c(d);
    delete a.a[b];
    return d;
  }
  Ke.prototype.f = function (a) {
    ...
    var b = this.l(a);
    return Infinity != b
      ? (this.b.push(a), this.i.push(b), (this.a[this.c(a)] = !0), Ne(this, 0, this.b.length - 1), !0)
      : !1;
  };
  function Me(a, b) {
  ...
  function Oe(a) {
    ...
    c.length = e;
    d.length = e;
    for (b = (a.b.length >> 1) - 1; 0 <= b; b--) Me(a, b);
  }
  function Pe(a, b) {
    Ke.call(
      this,
  ...
  Pe.prototype.o = function (a) {
    ...
    var b = a.getState();
    if (2 === b || 3 === b || 4 === b || 5 === b)
      (Kc(a, 'change', this.o, this), (a = a.bb()), a in this.g && (delete this.g[a], --this.j), this.v());
  };
  function Qe(a, b, c) {
    for (var d = 0, e, f; a.j < b && d < c && 0 < a.b.length; )
      ((e = Le(a)[0]), (f = e.bb()), 0 !== e.getState() || f in a.g || ((a.g[f] = !0), ++a.j, ++d, e.load()));
  }
  function Re(a) {
    return function (b, c, d) {
      if (void 0 !== b)
  ...
  k.Mc = nf;
  k.G = function (a) {
    this.v != this.i && ((this.l = this.se(this.l)), (this.v = this.i));
    var b = this.l;
  ...
  k.Vd = function (a) {
    this.o != this.i && (ub(this.f), (this.g = 0), (this.o = this.i));
    if (0 > a || (this.g && a <= this.g)) return this;
    var b = a.toString();
    if (this.f.hasOwnProperty(b)) return this.f[b];
    var c = this.hd(a);
    if (c.ga().length < this.A.length) return (this.f[b] = c);
    this.g = a;
    return this;
  };
  k.hd = function () {
  ...
  k.translate = function (a, b) {
    var c = this.ga();
    c && (qf(c, 0, c.length, this.qa(), a, b, c), this.s());
  };
  function vf(a, b, c, d) {
  ...
  function xf(a, b, c, d, e, f, g) {
    ...
    if (m || n)
      if (((f = ((e - h) * m + (f - l) * n) / (m * m + n * n)), 1 < f)) b = c;
        ...
        for (e = 0; e < d; ++e) g[e] = Ja(a[b + e], a[c + e], f);
        g.length = d;
        return;
      }
  ...
  function Af(a, b, c, d, e, f, g, h, l, m, n) {
    ...
    for (var q = n ? n : [NaN, NaN], r = b + d; r < c; )
      if ((xf(a, r - d, r, d, g, h, q), (p = Ga(g, h, q[0], q[1])), p < m)) {
        m = p;
        for (n = 0; n < d; ++n) l[n] = q[n];
        l.length = d;
        r += d;
      } else r += d * Math.max(((Math.sqrt(p) - Math.sqrt(m)) / e) | 0, 1);
    if (f && (xf(a, c - d, b, d, g, h, q), (p = Ga(g, h, q[0], q[1])), p < m)) {
      m = p;
      for (n = 0; n < d; ++n) l[n] = q[n];
      l.length = d;
    }
  ...
  function Ef(a, b, c, d, e) {
    ...
    var f = 0,
      g;
    var h = 0;
    for (g = c.length; h < g; ++h) ((b = Df(a, b, c[h], d)), (e[f++] = b));
    e.length = f;
    return e;
  }
          ...
          for (; b < q; ) {
            ...
            if (oa != L || ha != g) {
              var ga = L - E,
                ...
                ba = ha - A;
              (ga * ba == z * M &&
                ((0 > ga && M < ga) || ga == M || (0 < ga && M > ga)) &&
                ((0 > z && ba < z) || z == ba || (0 < z && ba > z))) ||
                ((x[B++] = L), (x[B++] = g), (E = L), (A = g));
              L = oa;
              g = ha;
            }
  ...
  k.Kb = function (a, b, c, d) {
    if (d < Sa(this.G(), a, b)) return d;
    this.c != this.i && ((this.j = Math.sqrt(yf(this.A, 0, this.A.length, this.a, 0))), (this.c = this.i));
  ...
  k.ma = function (a, b) {
    a
      ? (uf(this, b, a, 1), this.A || (this.A = []), (this.A.length = Df(this.A, 0, a, this.a)), this.s())
      : Kf(this, 'XY', null);
  };
  function Kf(a, b, c) {
    tf(a, b, c);
  ...
  k.ma = function (a, b) {
    a ? (uf(this, b, a, 0), this.A || (this.A = []), (this.A.length = Cf(this.A, a)), this.s()) : this.ba('XY', null);
  };
  k.ba = function (a, b) {
    tf(this, a, b);
    this.s();
  ...
  function Nf(a, b, c, d, e, f) {
    if (!c.length || !Mf(a, b, c[0], d, e, f)) return !1;
    var g;
    b = 1;
    for (g = c.length; b < g; ++b) if (Mf(a, c[b - 1], c[b], d, e, f)) return !1;
    return !0;
  }
  function Of(a, b, c, d, e, f, g) {
    ...
    for (u = m.length; h < u; ++h) {
      r = m[h];
      var x = Math.abs(r - p);
      x > q && ((p = (p + r) / 2), Nf(a, b, c, d, p, l) && ((n = p), (q = x)));
      p = r;
    }
    isNaN(n) && (n = e[f]);
  ...
  function Qf(a, b, c, d, e) {
    var f = ab(Oa(), a, b, c, d);
    return qb(e, f)
      ? Va(e, f) || (f[0] >= e[0] && f[2] <= e[2]) || (f[1] >= e[1] && f[3] <= e[3])
        ? !0
        : Pf(a, b, c, d, function (a, b) {
            var c = !1,
              d = Wa(e, a),
              f = Wa(e, b);
            if (1 === d || 1 === f) c = !0;
  ...
  function Rf(a, b, c, d, e) {
    ...
    b = 1;
    for (f = c.length; b < f; ++b) if (Lf(a, c[b - 1], c[b], d, e)) return !1;
    return !0;
  }
  function Sf(a, b, c, d) {
    for (var e = 0, f = a[c - d], g = a[c - d + 1]; b < c; b += d)
  ...
  k.Kb = function (a, b, c, d) {
    if (d < Sa(this.G(), a, b)) return d;
    this.C != this.i && ((this.B = Math.sqrt(zf(this.A, 0, this.c, this.a, 0))), (this.C = this.i));
  ...
  function Xf(a, b, c, d) {
    ...
    d = [];
    var f;
    for (f = 0; f < e; ++f) la(d, a.offset(b, c, (2 * Math.PI * f) / e));
    d.push(d[0], d[1]);
    a = new D(null);
    a.ba('XY', d, [d.length]);
    return a;
  ...
  function Zf(a, b, c) {
    var d = b ? b : 32,
      e = a.qa();
    b = a.ja;
    for (var f = new D(null, b), d = e * (d + 1), e = Array(d), g = 0; g < d; g++) e[g] = 0;
    f.ba(b, e, [e.length]);
    $f(f, a.wa(), a.pd(), c);
    return f;
  }
  ...
  function ag(a, b) {
    ...
    if (void 0 !== b.resolutions) {
      ...
      h = b.minResolution;
      void 0 === h &&
        (h = void 0 !== b.maxZoom ? (void 0 !== b.maxResolution ? g / Math.pow(f, e) : l / Math.pow(f, e)) : m);
    ...
    (void 0 !== b.enableRotation ? b.enableRotation : 1)
      ? ((d = b.constrainRotation),
        (d = void 0 === d || !0 === d ? We() : !1 === d ? Ue : 'number' === typeof d ? Ve(d) : Ue))
      : (d = Te);
    a.g = { center: void 0 !== b.extent ? Bc(b.extent) : Cc, resolution: e, rotation: d };
    void 0 !== b.resolution
      ? (c.resolution = b.resolution)
      : void 0 !== b.zoom && (c.resolution = a.constrainResolution(a.a, b.zoom - a.l));
  ...
  k.animate = function (a) {
    ...
    for (var h = [], l = 0; l < f; ++l) {
      ...
      m.center && ((n.Rg = c), (n.Tg = m.center), (c = n.Tg));
      void 0 !== m.zoom
        ? ((n.tf = d), (n.zd = this.constrainResolution(this.a, m.zoom - this.l, 0)), (d = n.zd))
        : m.resolution && ((n.tf = d), (n.zd = m.resolution), (d = n.zd));
      void 0 !== m.rotation && ((n.Sg = e), (n.uf = m.rotation), (e = n.uf));
      n.callback = g;
      b += n.duration;
      h.push(n);
    }
  ...
  function dg(a, b) {
    return void 0 !== b ? ((b[0] = a.o[0]), (b[1] = a.o[1]), b) : a.o.slice();
  }
  k.dd = function (a) {
    a = a || gg(this);
    var b = this.wa();
  ...
  k.Qf = function (a, b) {
    ...
    else (xa(Array.isArray(a), 24), xa(!kb(a), 25), (d = Yf(a)));
    ...
    void 0 !== b.minResolution
      ? (h = b.minResolution)
      : void 0 !== b.maxZoom
        ? (h = this.constrainResolution(this.a, b.maxZoom - this.l, 0))
        : (h = 0);
    var l = d.ga(),
      m = this.Qa();
    a = Math.cos(-m);
    ...
    void 0 !== b.duration
      ...
      : (this.Vc(c), this.ob(a), setTimeout(e.bind(void 0, !0), 0));
  };
  k.uk = function (a, b, c) {
    var d = this.Qa(),
      e = Math.cos(-d),
  ...
  k.rotate = function (a, b) {
    void 0 !== b && ((b = fg(this, a, b)), this.ob(b));
    this.Oe(a);
  };
  k.ob = function (a) {
    this.set('center', a);
  ...
  function og(a, b, c, d) {
    if (void 0 !== b) {
      var e = a.Qa(),
        f = a.wa();
      void 0 !== e && f && 0 < d ? a.animate({ rotation: b, anchor: c, duration: d, easing: rd }) : a.rotate(b, c);
    }
  }
  function pg(a, b, c, d) {
    var e = a.Pa();
  ...
  function qg(a, b, c, d) {
    if (b) {
      var e = a.Pa(),
        f = a.wa();
      void 0 !== e && f && b !== e && d
        ? a.animate({ resolution: b, anchor: c, duration: d, easing: rd })
        : (c && ((c = eg(a, b, c)), a.ob(c)), a.Vc(b));
    }
  }
  function rg(a) {
    a = a ? a : {};
  ...
  function Eg(a) {
    if (!(a instanceof ee)) return !0;
    var b = !1,
      c = a.type;
    if ('pointerdown' === c || 'pointerdrag' === c || 'pointerup' === c)
      ((c = a.b),
        'pointerup' == a.type
          ? delete this.na[c.pointerId]
          : 'pointerdown' == a.type
            ? (this.na[c.pointerId] = c)
            : c.pointerId in this.na && (this.na[c.pointerId] = c),
        (this.o = vb(this.na)));
    this.D
      ? 'pointerdrag' == a.type
        ? this.If(a)
        : 'pointerup' == a.type && (this.D = this.sk(a) && 0 < this.o.length)
      : 'pointerdown' == a.type
        ? ((this.D = a = this.yf(a)), (b = this.Xc(a)))
        : 'pointermove' == a.type && this.Jf(a);
    return !b;
  }
  ...
  function Gg(a) {
    Dg.call(this, { handleDownEvent: Hg, handleDragEvent: Ig, handleUpEvent: Jg });
    a = a ? a : {};
    this.a = a.kinetic;
    this.g = null;
  ...
  function Jg(a) {
    var b = a.map;
    a = b.Z();
    if (this.o.length) return (this.a && lg(this.a), (this.g = null), !0);
    if (!this.j && this.a && mg(this.a)) {
      ...
      a.animate({ center: a.Ec(b), duration: 500, easing: rd });
    }
    cg(a, 1, -1);
    return !1;
  }
  ...
  function Kg(a) {
    a = a ? a : {};
    Dg.call(this, { handleDownEvent: Lg, handleDragEvent: Mg, handleUpEvent: Ng });
  ...
  function Lg(a) {
    return Bg(a) && ug(a) && this.g(a) ? (cg(a.map.Z(), 1, 1), (this.a = void 0), !0) : !1;
  }
  Kg.prototype.Xc = nf;
  function Og(a) {
    this.Gc = null;
  ...
  function Rg(a) {
    Dg.call(this, { handleDownEvent: Sg, handleDragEvent: Tg, handleUpEvent: Ug });
    a = a ? a : {};
  ...
  function Ug(a) {
    if (!Bg(a)) return !0;
    this.a.setMap(null);
    this.l(a, this.g, a.pixel) && (this.j(a), this.b(new Wg(Yg, a.coordinate, a)));
    return !1;
  }
  function Sg(a) {
  ...
  function $g(a) {
    ...
    Rg.call(this, { condition: b, className: a.className || 'ol-dragzoom' });
  }
  v($g, Rg);
  $g.prototype.j = function () {
    ...
    if (this.I) {
      var e = b.dd(c),
        d = [a.Ja(eb(d)), a.Ja(hb(d))],
        a = Ya(void 0),
        f;
      var g = 0;
      for (f = d.length; g < f; ++g) Pa(a, d[g]);
      d = b.ze(a, c);
      rb(e, 1 / d);
      d = e;
    }
    ...
    e = nb(d);
    e = b.Ec(e);
    b.animate({ resolution: c, center: e, duration: this.B, easing: rd });
  };
  function ah(a) {
    ng.call(this, { handleEvent: bh });
    a = a || {};
    this.a = function (a) {
      return xg(a) && Ag(a);
    };
  ...
  function bh(a) {
    ...
    if ('keydown' == a.type) {
      ...
      if (this.g(a) && (40 == c || 37 == c || 39 == c || 38 == c)) {
        ...
        c = this.j;
        if ((e = b.wa()))
          ((d = b.Ec([e[0] + d[0], e[1] + d[1]])), c ? b.animate({ duration: c, easing: td, center: d }) : b.ob(d));
        a.preventDefault();
        b = !0;
      }
    }
  ...
  function dh(a) {
    ...
    if ('keydown' == a.type || 'keypress' == a.type) {
      ...
      !this.g(a) ||
        (43 != c && 45 != c) ||
        ((b = 43 == c ? this.a : -this.a), (c = a.map.Z()), pg(c, b, void 0, this.j), a.preventDefault(), (b = !0));
    }
    return !b;
  }
  function eh(a) {
    ng.call(this, { handleEvent: fh });
    a = a || {};
    this.j = 0;
  ...
  function fh(a) {
    ...
    } else 'mousewheel' == a.type && ((d = -c.wheelDeltaY), Pd && (d /= 3));
    if (0 === d) return !1;
    a = Date.now();
    void 0 === this.g && (this.g = a);
    if (!this.o || 400 < a - this.g) this.o = 4 > Math.abs(d) ? gh : hh;
    if (this.o === gh) {
      b = b.Z();
      ...
      0 < g
        ? b.animate({ resolution: e, easing: rd, anchor: this.a, duration: 500 })
        : 0 > g && b.animate({ resolution: f, easing: rd, anchor: this.a, duration: 500 });
      this.g = a;
      return !1;
    }
    this.j += d;
  ...
  var gh = 'trackpad',
    hh = 'wheel';
  function ih(a) {
    Dg.call(this, { handleDownEvent: jh, handleDragEvent: kh, handleUpEvent: lh });
    a = a || {};
    this.g = null;
    this.j = void 0;
    this.a = !1;
  ...
  function kh(a) {
    ...
    void 0 !== this.j && ((b = c - this.j), (this.l += b), !this.a && Math.abs(this.l) > this.C && (this.a = !0));
    this.j = c;
    a = a.map;
    c = a.Z();
    if (c.g.rotation !== Te) {
  ...
  function jh(a) {
    return 2 <= this.o.length
      ? ((a = a.map), (this.g = null), (this.j = void 0), (this.a = !1), (this.l = 0), this.D || cg(a.Z(), 1, 1), !0)
      : !1;
  }
  ih.prototype.Xc = nf;
  function mh(a) {
    Dg.call(this, { handleDownEvent: nh, handleDragEvent: oh, handleUpEvent: ph });
    a = a ? a : {};
  ...
  function nh(a) {
    return 2 <= this.o.length
      ? ((a = a.map), (this.g = null), (this.a = void 0), (this.j = 1), this.D || cg(a.Z(), 1, 1), !0)
      : !1;
  }
  mh.prototype.Xc = nf;
  function qh(a) {
    ...
    (void 0 !== a.doubleClickZoom ? a.doubleClickZoom : 1) &&
      b.push(new rg({ delta: a.zoomDelta, duration: a.zoomDuration }));
    ...
    (void 0 !== a.pinchZoom ? a.pinchZoom : 1) &&
      b.push(new mh({ constrainResolution: a.constrainResolution, duration: a.zoomDuration }));
    if (void 0 !== a.keyboard ? a.keyboard : 1)
      (b.push(new ah()), b.push(new ch({ delta: a.zoomDelta, duration: a.zoomDuration })));
    (void 0 !== a.mouseWheelZoom ? a.mouseWheelZoom : 1) &&
      b.push(new eh({ constrainResolution: a.constrainResolution, duration: a.zoomDuration }));
    (void 0 !== a.shiftDragZoom ? a.shiftDragZoom : 1) && b.push(new $g({ duration: a.zoomDuration }));
    return b;
  }
  function sh(a) {
    Tc.call(this);
  ...
  function uh(a) {
    ...
    b
      ? Array.isArray(b)
        ? (b = new Yc(b.slice(), { unique: !0 }))
        : xa(b instanceof Yc, 43)
      : (b = new Yc(void 0, { unique: !0 }));
    this.xi(b);
  }
  v(uh, sh);
  k = uh.prototype;
  ...
  k.Hl = function () {
    ...
    for (var b in this.c) this.c[b].forEach(Ec);
    ub(this.c);
    var a = a.a,
      c;
    b = 0;
  ...
  k = Mh.prototype;
  k.ka = function () {
    for (var a in this.c) Nc(this.c[a]);
  };
  function Oh() {
    if (32 < zh.a) {
      var a = 0,
  ...
  k.Ea = function (a, b, c, d, e, f, g) {
    ...
    for (q = p.length - 1; 0 <= q; --q) {
      var u = p[q],
        r = u.layer;
      if (xh(u, n) && f.call(g, r) && ((u = Ph(this, r)), r.ha() && (l = u.Ea(r.ha().u ? m : a, b, c, h, e)), l))
        return l;
    }
  };
  ...
  function Yh(a, b, c) {
    if (a.M) {
      ...
      for (g = b.length; h < g; h += 2) {
        var l = b[h] - a.D,
          m = b[h + 1] - a.C;
        a.pa && ((l = Math.round(l)), (m = Math.round(m)));
        if (f || 1 != a.f) {
          var n = l + a.D,
            p = m + a.C;
    ...
    if (a.ra && '' !== a.Ia) {
      ...
      h
        ...
        : ((g.font = f.font),
          ...
          (a.Ua = { font: f.font, textAlign: f.textAlign, textBaseline: f.textBaseline }));
  ...
  function ci(a, b, c, d, e) {
    var f;
    var g = 0;
    for (f = d.length; g < f; ++g) c = bi(a, b, c, d[g], e, !0);
    return c;
  }
  k = Xh.prototype;
  k.Zb = function (a) {
  ...
  k.te = function (a, b) {
    (a = (0, b.Za)(a)) && qb(this.c, a.G()) && (this.rd(b), this.zb(a));
  };
  k.ue = function (a) {
    a = a.a;
    var b;
    var c = 0;
    for (b = a.length; c < b; ++c) this.zb(a[c]);
  };
  k.qc = function (a) {
    var b = a.ga();
    a = a.qa();
  ...
  k.nc = function (a) {
    ...
    if (qb(this.c, b)) {
      if (this.b) {
        ...
        var g;
        var h = 0;
        for (g = e.length; h < g; ++h) d = bi(this, c, d, e[h], f, !1);
        b.stroke();
      }
      '' !== this.Ia && ((a = ei(a)), Zh(this, a, a.length, 2));
    }
  };
  k.rc = function (a) {
    if (qb(this.c, a.G())) {
  ...
  k.pc = function (a) {
    if (qb(this.c, a.G())) {
      if (this.b || this.a) {
        ...
        b.beginPath();
        var h = 0;
        for (g = e.length; h < g; ++h) d = ci(this, c, d, e[h], f);
        this.a && b.fill();
        this.b && b.stroke();
      }
      '' !== this.Ia && ((a = gi(a)), Zh(this, a, a.length, 2));
    }
  };
  function $h(a, b) {
    var c = a.i,
    ...
    d
      ...
      : ((c.fillStyle = b.fillStyle), (a.I = { fillStyle: b.fillStyle }));
  }
  function ai(a, b) {
    var c = a.i,
      d = a.R;
  ...
  k.Ma = function (a, b) {
    a ? ((a = a.b), (this.a = { fillStyle: id(a ? a : Sh) })) : (this.a = null);
    if (b) {
      a = b.a;
      var c = b.f,
        d = b.i,
  ...
  k.Cb = function (a) {
    if (a) {
      var b = a.Fa();
      b ? ((b = b.b), (this.g = { fillStyle: id(b ? b : Sh) })) : (this.g = null);
      var c = a.Ga();
      if (c) {
        var b = c.a,
          d = c.f,
  ...
  hi.prototype.Di = function (a, b, c, d, e, f) {
    ...
    for (--l; 0 <= l; --l) {
      var m = h[l];
      var n = m.layer;
      if (xh(m, g) && e.call(f, n) && (m = Ph(this, n).u(a, b, c, d))) return m;
    }
  };
  ...
  vi.prototype.La = function (a, b, c, d, e, f, g, h, l, m, n) {
    ...
    if (l) {
      m
        ? (a = this.ve(p, a, h, l, n))
        : (p.clear(p.COLOR_BUFFER_BIT | p.DEPTH_BUFFER_BIT), this.Od(p, a, h, !0), (a = (a = l(null)) ? a : void 0));
      var ha = a;
    } else this.Od(p, a, h, !1);
    this.sf(p, f);
    this.g &&
    ...
    for (f = this.u.length - 1; 0 <= f; --f) {
      ...
      for (g = this.u[f]; 0 <= h && this.i[h] >= g; ) {
        ...
        if (
          ...
          n.V() &&
          (void 0 === e || qb(e, n.V().G())) &&
          (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), xi(a, b, m, l), (l = d(n)))
        )
          return l;
        h--;
        l = m;
  ...
  k.Ma = function (a, b) {
    ...
    a instanceof CanvasGradient || a instanceof CanvasPattern
      ? (a = yi)
      : (a =
          ed(a).map(function (a, b) {
            return 3 != b ? a / 255 : a;
          }) || yi);
    (this.c.strokeColor &&
      pa(this.c.strokeColor, c) &&
      this.c.fillColor &&
      pa(this.c.fillColor, a) &&
      this.c.lineWidth === b) ||
      ((this.c.s = !0),
      (this.c.fillColor = a),
  ...
  k.ka = function () {
    ...
    if (!a.isContextLost()) {
      ...
      for (b in this.i) a.deleteProgram(this.i[b]);
  ...
  k.Eb = function (a) {
    ...
    return function () {
      if (!f.isContextLost()) {
        var g;
        var h = 0;
        for (g = d.length; h < g; ++h) f.deleteTexture(d[h]);
        h = 0;
        for (g = e.length; h < g; ++h) f.deleteTexture(e[h]);
      }
      Gi(a, b);
      Gi(a, c);
    };
  ...
  function Wi(a, b, c, d) {
    ...
    for (e = 0; e < f; ++e) {
      var g = b[e];
      var h = w(g).toString();
      h in c ? (g = c[h]) : ((g = Ti(d, g)), (c[h] = g));
      a[e] = g;
    }
  }
  k.rf = function (a, b) {
    var c = Hi(b, Ki, Mi);
    if (this.B) var d = this.B;
    else this.B = d = new Ni(a, c);
    b.Qc(c);
    ...
    if (wb(c)) {
      ...
      for (f = g = 0, h = e.length; f < h; ++f) {
        ...
        for (var l = 0 < f ? d[f - 1] : 0, m = d[f], n = l; g < this.i.length && this.i[g] <= m; ) {
          ...
          void 0 !== c[p]
            ? (n !== l && xi(a, b, n, l), (l = n = g === this.i.length - 1 ? m : this.i[g + 1]))
            : (l = g === this.i.length - 1 ? m : this.i[g + 1]);
          g++;
        }
        n !== l && xi(a, b, n, l);
      }
    ...
    for (f = this.u.length - 1; 0 <= f; --f) {
      ...
      for (g = this.v[f]; 0 <= h && this.i[h] >= l; ) {
        ...
        if (
          ...
          n.V() &&
          (void 0 === e || qb(e, n.V().G())) &&
          (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), xi(a, b, m, g), (g = d(n)))
        )
          return g;
        g = m;
        h--;
  ...
  k.Ub = function (a) {
    ...
    if (this.j.length) {
      ...
      w(n) != w(c) && (this.S.push(this.b.length), this.j.push(c));
    } else this.j.push(c);
    this.c.length
      ? ((n = this.c[this.c.length - 1]), w(n) != w(e) && (this.v.push(this.b.length), this.c.push(e)))
      : this.c.push(e);
    this.D = b[0];
    this.C = b[1];
    this.oa = m[1];
  ...
  function dj(a, b, c, d) {
    ...
    for (e = 0; e < c; e += d) {
      ...
      n = q + 2;
      p = E;
      h && ((f = ej(a, r, u, x, E * mj * h, f)), (a.b[g++] = q + 1), (a.b[g++] = q + 3), (a.b[g++] = q));
    }
    m &&
      ((q = q || f / 7),
  ...
  k.mc = function (a, b) {
    ...
    a = a.qa();
    nj(c, 0, c.length, a) &&
      ((c = qf(c, 0, c.length, a, -this.origin[0], -this.origin[1])),
  ...
  k.nc = function (a, b) {
    ...
    this.b.length > c && (this.i.push(c), this.f.push(b), this.c.s && (this.j.push(c), (this.c.s = !1)));
  };
  function oj(a, b, c, d) {
    Xi(b, b.length, d) || (b.push(b[0]), b.push(b[1]));
    dj(a, b, b.length, d);
    if (c.length) {
      var e;
      b = 0;
      for (e = c.length; b < e; ++b)
        (Xi(c[b], c[b].length, d) || (c[b].push(c[b][0]), c[b].push(c[b][1])), dj(a, c[b], c[b].length, d));
    }
  }
  function pj(a, b, c) {
    ...
    if (wb(c)) {
      ...
      for (h = this.j.length - 1; 0 <= h; --h) {
        ...
        for (n = this.j[h]; 0 <= m && this.i[m] >= n; ) {
          ...
          var q = this.f[m];
          q = w(q).toString();
          c[q] && (g !== l && (xi(a, b, g, l), a.clear(a.DEPTH_BUFFER_BIT)), (l = p));
          m--;
          g = p;
        }
        g !== l && (xi(a, b, g, l), a.clear(a.DEPTH_BUFFER_BIT));
        g = l = n;
      }
    }
  ...
  k.Ma = function (a, b) {
    ...
    b = b.o;
    b = void 0 !== b ? b : 10;
    (this.c.strokeColor && pa(this.c.strokeColor, a) && this.c.lineWidth === c && this.c.miterLimit === b) ||
      ((this.c.s = !0),
  ...
  function yj(a) {
    ...
    if (b) {
      ...
      a.b = c || d;
      a.i === a.a
        ? ((a.b = void 0), (a.i = void 0), (a.a = void 0))
        : a.i === b
          ? (a.i = a.b)
  ...
  xj.prototype.concat = function (a) {
    if (a.b) {
      if (this.b) {
        ...
        a.a.next = b;
        this.c += a.c;
      } else ((this.b = a.b), (this.i = a.i), (this.a = a.a), (this.c = a.c));
      a.b = void 0;
      a.i = void 0;
      a.a = void 0;
      a.c = 0;
  ...
  (function (a) {
      ...
      for (h = h || d; g > f; ) {
        if (600 < g - f) {
          var l = g - f + 1,
            m = e - f + 1,
            n = Math.log(l),
            p = 0.5 * Math.exp((2 * n) / 3),
            n = 0.5 * Math.sqrt((n * p * (l - p)) / l) * (0 > m - l / 2 ? -1 : 1);
    ...
    function e(a, b) {
      ...
      this.fh = Math.max(2, Math.ceil(0.4 * this.Hf));
      b && this.ek(b);
      this.clear();
    }
    function f(a, b) {
    ...
    function g(a, b, c, d, e) {
      ...
      e.$ = -Infinity;
      e.ia = -Infinity;
      for (var f; b < c; b++) ((f = a.children[b]), h(e, a.ib ? d(f) : f));
      return e;
    }
    function h(a, b) {
    ...
    function u(a) {
      return { children: a, height: 1, ib: !0, ca: Infinity, da: Infinity, $: -Infinity, ia: -Infinity };
    }
    function x(a, b, c, d, e) {
      for (var f = [b, c], g; f.length; )
        ((c = f.pop()),
          (b = f.pop()),
          c - b <= d || ((g = b + Math.ceil((c - b) / d / 2) * d), B(a, g, b, c, e), f.push(b, g, g, c)));
    }
    var B = b;
    e.prototype = {
      all: function () {
        ...
        this.data.children.length
          ? this.data.height === a.height
            ...
            : (this.data.height < a.height && ((b = this.data), (this.data = a), (a = b)),
              this.eh(a, this.data.height - a.height - 1, !0))
          : (this.data = a);
        return this;
      },
      Ca: function (a) {
      ...
      $g: function (a, b) {
        for (var c = []; a; ) (a.ib ? b.push.apply(b, a.children) : c.push.apply(c, a.children), (a = c.pop()));
        return b;
      },
      bh: function (a, b, c, d) {
        var e = c - b + 1,
        ...
        for (var e, f, g, h, l, m, p, q; ; ) {
          ...
          for (f = b.children.length; e < f; e++)
            ((g = b.children[e]),
              ...
              m < q ? ((q = m), (p = l < p ? l : p), (h = g)) : m === q && l < p && ((p = l), (h = g)));
          b = h || b.children[0];
        }
        return b;
      },
      eh: function (a, b, c) {
        ...
        e.children.push(a);
        for (h(e, c); 0 <= b; )
          if (d[b].children.length > this.Hf) (this.jk(d, b), b--);
          else break;
        this.Zj(c, d, b);
      },
      jk: function (a, b) {
      ...
      ak: function (a, b, c) {
        ...
        for (d = b; d <= c - b; d++) {
          ...
          var m =
            Math.max(0, Math.min(h.$, l.$) - Math.max(h.ca, l.ca)) *
            Math.max(0, Math.min(h.ia, l.ia) - Math.max(h.da, l.da));
          h = n(h) + n(l);
          if (m < f) {
            f = m;
            var p = d;
      ...
      ah: function (a, b, c, d) {
        ...
        for (m = c - b - 1; m >= b; m--) ((n = a.children[m]), h(f, a.ib ? d(n) : n), (l += p(f)));
        return l;
      },
      Zj: function (a, b, c) {
        for (; 0 <= c; c--) h(b[c], a);
      ...
      ek: function (a) {
        ...
        this.wb = new Function(
          'a',
          'return {minX: a' + a[0] + ', minY: a' + a[1] + ', maxX: a' + a[2] + ', maxY: a' + a[3] + '};'
        );
      }
    };
    a['default'] = e;
  ...
  k = Gj.prototype;
  k.Ca = function (a, b) {
    a = { ca: a[0], da: a[1], $: a[2], ia: a[3], value: b };
    this.a.Ca(a);
    this.b[w(b)] = a;
  };
  k.load = function (a, b) {
    for (var c = Array(b.length), d = 0, e = b.length; d < e; d++) {
      var f = a[d],
        g = b[d],
        f = { ca: f[0], da: f[1], $: f[2], ia: f[3], value: g };
      c[d] = f;
      this.b[w(g)] = f;
    }
    this.a.load(c);
  ...
  function Hj(a, b, c) {
    var d = a.b[w(c)];
    bb([d.ca, d.da, d.$, d.ia], b) || (a.remove(c), a.Ca(b, c));
  }
  function Ij(a) {
  ...
  function Jj(a, b) {
    return a.a.search({ ca: b[0], da: b[1], $: b[2], ia: b[3] }).map(function (a) {
      return a.value;
    });
  }
  k.forEach = function (a, b) {
  ...
  function Nj(a, b, c, d) {
    ...
    if (c.length) {
      ...
      for (g = c.length; l < g; ++l) {
        var m = { list: new xj(), $: void 0, Mg: new Gj() };
        h.push(m);
      ...
      for (l = 0; l < h.length; ++l) {
        ...
        n || (Qj(c, h[l].Mg, !0), Rj(c, h[l].$[0], e, b[0], f) && (f.concat(h[l].Mg), Qj(e, f, !1)));
      }
    } else Qj(e, f, !1);
    Sj(a, e, f);
  }
  function Oj(a, b, c, d, e, f) {
    ...
    if (f === Sf(b, 0, b.length, c)) {
      ...
      for (r = b.length - c, p = l = Tj(a, b[r], b[r + 1], h++), f = b[r], q = b[r + 1], r -= c, g = 0; r >= g; r -= c)
        ((u = Tj(a, b[r], b[r + 1], h++)),
          n.push(Uj(p, u, d)),
          m.push([Math.min(p.x, u.x), Math.min(p.y, u.y), Math.max(p.x, u.x), Math.max(p.y, u.y)]),
          b[r] > f && ((f = b[r]), (q = b[r + 1])),
  ...
  function Qj(a, b, c) {
    ...
    do {
      ...
      void 0 === h
        ? (Vj(e, f, a, b), (g = !0), f === d && (d = Bj(a)), (f = e), Cj(a))
        : e.W.Fb !== h && ((e.W.Fb = h), (g = !0));
      e = f;
      f = Aj(a);
    } while (e !== d);
    return g;
  ...
  function Rj(a, b, c, d, e) {
    for (var f = zj(a); f.W.x !== b; ) f = Aj(a);
    b = f.W;
    d = { x: d, y: b.y, hb: -1 };
    var g = Infinity,
      h;
    var l = Pj({ aa: b, W: d }, e, !0);
    var m = 0;
    for (h = l.length; m < h; ++m) {
      ...
      if (q < g && void 0 !== Bi(b.x, b.y, n.aa.x, n.aa.y, n.W.x, n.W.y)) {
        g = q;
        var r = { x: p[0], y: p[1], hb: -1 };
        f = n;
      }
    }
    if (Infinity === g) return !1;
    l = f.W;
    if (0 < g && ((f = Xj(b, r, f.W, e)), f.length))
      for (r = Infinity, m = 0, h = f.length; m < h; ++m)
        if (((g = f[m]), (n = Math.atan2(b.y - g.y, d.x - g.x)), n < r || (n === r && g.x < l.x))) ((r = n), (l = g));
    for (f = zj(c); f.W.x !== l.x || f.W.y !== l.y; ) f = Aj(c);
    d = { x: b.x, y: b.y, hb: b.hb, Fb: void 0 };
    m = { x: f.W.x, y: f.W.y, hb: f.W.hb, Fb: void 0 };
    Bj(a).aa = d;
    Uj(b, f.W, a, e);
    Uj(m, d, a, e);
    f.W = m;
    a.f && a.b && ((a.i = a.b), (a.a = a.b.ub));
    c.concat(a);
    return !0;
  }
  function Sj(a, b, c) {
      ...
      if (e) {
        ...
        if ((e = Yj(b, c))) {
          var d = b,
            ...
            l = h,
            m = 0;
          do ((g[m++] = l.aa.x), (g[m++] = l.aa.y), (l = Aj(d)));
          while (l !== h);
          d = !Sf(g, 0, f, 2);
          Qj(b, c, d);
        } else {
          ...
          do {
            ...
            if (h.length) {
              ...
              for (f = Aj(d); f !== g; ) (Uj(f.aa, f.W, l, m), c.remove(f), yj(d), (f = Ej(d)));
              Uj(g.aa, h, l, m);
              g.aa = h;
  ...
  function Zj(a, b, c, d, e) {
    ...
    do {
      ...
      if (!1 === r.Fb) {
        ...
        (!d && Pj({ aa: q, W: u }, c).length) ||
          !x ||
          Xj(q, r, u, c, !0).length ||
          (!d &&
            !1 !== q.Fb &&
            !1 !== u.Fb &&
            Sf([h.aa.x, h.aa.y, q.x, q.y, r.x, r.y, u.x, u.y, n.W.x, n.W.y], 0, 10, 2) !== !e) ||
          ((a.b[f++] = q.hb), (a.b[f++] = r.hb), (a.b[f++] = u.hb), Vj(l, m, b, c), m === g && (g = n), (p = !0));
      }
      h = Dj(b);
      l = Ej(b);
      m = Aj(b);
      ...
      if (l) {
        ...
        d
          ? (l[0] === f.aa.x && l[1] === f.aa.y
              ? (Cj(b), (l = f.aa), (g.aa = l), c.remove(f), (p = p || f === e))
              : ((l = g.W), (f.W = l), c.remove(g), (p = p || g === e)),
            yj(b))
          : ((l = Tj(a, l[0], l[1], m)),
            (f.W = l),
            (g.aa = l),
            Hj(
              c,
              [Math.min(f.aa.x, f.W.x), Math.min(f.aa.y, f.W.y), Math.max(f.aa.x, f.W.x), Math.max(f.aa.y, f.W.y)],
              f
            ),
            Hj(
              c,
              [Math.min(g.aa.x, g.W.x), Math.min(g.aa.y, g.W.y), Math.max(g.aa.x, g.W.x), Math.max(g.aa.y, g.W.y)],
              g
            ));
        a.b[h++] = n.aa.hb;
        a.b[h++] = n.W.hb;
  ...
  function Uj(a, b, c, d) {
    ...
    if (g) {
      ...
      h && (h.ub = f);
      g === c.a && (c.a = f);
    } else ((c.i = f), (c.a = f), c.f && ((f.next = f), (f.ub = f)));
    c.b = f;
    c.c++;
  ...
  function Xj(a, b, c, d, e) {
    var f,
      g,
      h = [],
      l = Jj(d, [Math.min(a.x, b.x, c.x), Math.min(a.y, b.y, c.y), Math.max(a.x, b.x, c.x), Math.max(a.y, b.y, c.y)]);
    d = 0;
    for (f = l.length; d < f; ++d)
      for (g in l[d]) {
        ...
        'object' !== typeof m ||
          ...
          (m.x === c.x && m.y === c.y) ||
          -1 !== h.indexOf(m) ||
          !Mf([a.x, a.y, b.x, b.y, c.x, c.y], 0, 6, 2, m.x, m.y) ||
          h.push(m);
      }
    return h;
  }
  ...
  function bk(a, b, c, d, e) {
    if (void 0 === b.Fb || void 0 === d.Fb) return !1;
  ...
  k.pc = function (a, b) {
    ...
    this.b.length > e && (this.i.push(e), this.f.push(b), this.j.s && (this.c.push(e), (this.j.s = !1)));
  ...
  k.Ma = function (a, b) {
    ...
    (this.j.fillColor && pa(a, this.j.fillColor)) || ((this.j.fillColor = a), (this.j.s = !0), this.u.push(a));
    b ? this.g.Ma(null, b) : this.g.Ma(null, new wj({ color: [0, 0, 0, 0], lineWidth: 0 }));
  };
  function ck() {}
  ...
  dk.prototype.b = function (a, b) {
    ...
    c = a[b];
    void 0 === c && ((c = new gk[b](this.g, this.f)), (a[b] = c));
    return c;
  };
  ...
  function hk(a, b, c, d, e, f, g, h, l, m, n) {
    ...
    for (r = q.length; x < r; ++x) {
      ...
      for (u = ji.length - 1; 0 <= u; --u) {
        var E = B[ji[u]];
        if (void 0 !== E && (E = E.La(b, c, d, e, p, f, g, h, l, m, n))) return E;
      }
    }
  }
  ...
  var ik = [1, 1],
    gk = { Circle: Fi, Image: Ui, LineString: cj, Polygon: Mj, Text: ck };
  ...
  k.te = function (a, b) {
    (a = (0, b.Za)(a)) && qb(this.a, a.G()) && (this.rd(b), this.zb(a));
  };
  k.ue = function (a) {
    a = a.a;
    var b;
  ...
  k.forEach = function (a, b) {
    for (var c = this.a; c; ) (a.call(b, c.Yc, c.uc, this), (c = c.Nb));
  };
  k.get = function (a) {
    a = this.b[a];
    xa(!!a, 15);
    if (a === this.i) return a.Yc;
    a === this.a ? ((this.a = this.a.Nb), (this.a.vd = null)) : ((a.Nb.vd = a.vd), (a.vd.Nb = a.Nb));
    a.Nb = null;
    a.vd = this.i;
    this.i = this.i.Nb = a;
    return a.Yc;
  ...
  function nk(a, b, c, d) {
    ...
    if (a.a.b.hasOwnProperty(f))
      ((a = a.a.get(f)),
        ...
        9729 != a.Ph && (e.texParameteri(3553, 10240, 9729), (a.Ph = 9729)),
        9729 != a.Rh && (e.texParameteri(3553, 10241, 9729), (a.Rh = 9729)));
    else {
      ...
      if (0 < d) {
        var h = a.C.canvas,
          l = a.C;
        a.D !== c[0] || a.S !== c[1]
          ? ((h.width = c[0]), (h.height = c[1]), (a.D = c[0]), (a.S = c[1]))
      ...
      a.a.set(f, { Ib: g, Ph: 9729, Rh: 9729 });
    }
  }
  function pk(a, b, c) {
    var d = a.o;
  ...
  k.xk = function (a, b) {
    ...
    for (var c; 1024 < this.a.c - this.g; ) {
      if ((c = this.a.a.Yc)) a.deleteTexture(c.Ib);
      else if (+this.a.a.uc == b.index) break;
      else --this.g;
      this.a.pop();
    }
  };
  ...
  k.Jg = function (a) {
    ...
    h = 0;
    for (g = d.length; h < g; ++h) ((l = d[h]), (m = Ph(this, l.layer)), m.Gi(a, l, b));
    this.l || ((this.b.style.display = ''), (this.l = !0));
    Nh(a);
    1024 < this.a.c - this.g && a.postRenderFunctions.push(this.xk.bind(this));
    this.j.b.length && (a.postRenderFunctions.push(this.B), (a.animate = !0));
    pk(this, 'postcompose', a);
    Qh(this, a);
    a.postRenderFunctions.push(Oh);
  };
  k.Ea = function (a, b, c, d, e, f, g) {
    if (this.i.isContextLost()) return !1;
    var h = b.viewState,
    ...
    for (m = l.length - 1; 0 <= m; --m) {
      var n = l[m];
      var p = n.layer;
      if (xh(n, h.resolution) && f.call(g, p) && (n = Ph(this, p).Ea(a, b, c, d, e))) return n;
    }
  };
  k.Ei = function (a, b, c, d, e) {
    c = !1;
    ...
    for (h = g.length - 1; 0 <= h; --h) {
      var l = g[h],
        m = l.layer;
      if (xh(l, f.resolution) && d.call(e, m) && (c = Ph(this, m).Ue(a, b))) return !0;
    }
    return c;
  };
  k.Di = function (a, b, c, d, e) {
    ...
    for (h = g.length - 1; 0 <= h; --h) {
      var l = g[h];
      var m = l.layer;
      if (xh(l, f.resolution) && e.call(d, m) && (l = Ph(this, m).lg(a, b, c, d))) return l;
    }
  };
  var qk = ['canvas', 'webgl'];
  function G(a) {
    ...
    for (
      var c = 'click dblclick mousedown touchstart MSPointerDown pointerdown mousewheel wheel'.split(' '),
        d = 0,
        e = c.length;
      d < e;
      ++d
    ...
    for (var f in de) y(this.Sa, de[f], this.Ih, this);
  ...
  k.ka = function () {
    ...
    this.f && (window.removeEventListener('resize', this.f, !1), (this.f = void 0));
    ...
    if (this.c)
      return (
        ...
        this.B.Ea(
          ...
          b,
          null,
          c.layerFilter ? c.layerFilter : mf,
          null
        )
      );
  };
  k.Im = function (a, b, c, d, e) {
    if (this.c) return this.B.Di(a, this.c, b, void 0 !== c ? c : null, d ? d : mf, void 0 !== e ? e : null);
  };
  k.Yl = function (a, b) {
    if (!this.c) return !1;
    a = this.Wa(a);
    ...
    return this.B.Ei(
      ...
      b.layerFilter ? b.layerFilter : mf,
      null
    );
  };
  k.Tf = function (a) {
  ...
  k.Rl = function () {
    ...
    if (b.b.length) {
      ...
      if (a) {
        var e = a.viewHints;
        e[0] && ((c = this.Cf ? 8 : 0), (d = 2));
        e[1] && ((c = this.Df ? 8 : 0), (d = 2));
      }
      b.j < c && (Oe(b), Qe(b, c, d));
    }
    b = this.xb;
  ...
  k.Vl = function () {
    ...
    this.ag() && (a = this.jd());
    if (this.u) {
      for (var b = 0, c = this.u.length; b < c; ++b) Ec(this.u[b]);
      this.u = null;
    }
    a
      ? (a.appendChild(this.a),
        ...
        this.f || ((this.f = this.Ad.bind(this)), window.addEventListener('resize', this.f, !1)))
      : (ld(this.a), this.f && (window.removeEventListener('resize', this.f, !1), (this.f = void 0)));
    this.Ad();
  };
  k.Wl = function () {
    this.render();
  ...
  k.Xl = function () {
    this.T && (Ec(this.T), (this.T = null));
    this.R && (Ec(this.R), (this.R = null));
    var a = this.Z();
    a &&
      (this.a.setAttribute('data-view', w(a)),
      (this.T = y(a, 'propertychange', this.Lh, this)),
      (this.R = y(a, 'change', this.Lh, this)));
    this.render();
  };
  k.El = function () {
    this.I && (this.I.forEach(Ec), (this.I = null));
    var a = this.Kc();
  ...
  k.Sp = function (a) {
    ...
    g &&
      ...
      !f ||
        (this.g && (kb(this.g) || bb(g.extent, this.g))) ||
        (this.b(new Id('movestart', this, f)), (this.g = Ya(this.g))),
      !this.g ||
        g.viewHints[0] ||
        g.viewHints[1] ||
        bb(g.extent, this.g) ||
        (this.b(new Id('moveend', this, g)), Ra(g.extent, this.g)));
  ...
  function rk(a) {
    ...
    if (void 0 === a.logo || ('boolean' === typeof a.logo && a.logo))
      ...
      'string' === typeof e
        ...
        : e instanceof HTMLElement
          ? (d[w(e).toString()] = e)
          : e && (xa('string' == typeof e.href, 44), xa('string' == typeof e.src, 45), (d[e.src] = e.href));
    }
    ...
    void 0 !== a.controls
      ? Array.isArray(a.controls)
        ? (f = new Yc(a.controls.slice()))
        : (xa(a.controls instanceof Yc, 47), (f = a.controls))
      : (f = xd());
    void 0 !== a.interactions
      ? Array.isArray(a.interactions)
        ? (h = new Yc(a.interactions.slice()))
        : (xa(a.interactions instanceof Yc, 48), (h = a.interactions))
      : (h = qh());
    void 0 !== a.overlays
      ? Array.isArray(a.overlays)
        ? (a = new Yc(a.overlays.slice()))
        : (xa(a.overlays instanceof Yc, 49), (a = a.overlays))
      : (a = new Yc());
    return { controls: f, interactions: h, keyboardEventTarget: b, logos: d, overlays: a, Up: e, values: c };
  }
  function sk(a) {
    Tc.call(this);
    this.g = a.id;
  ...
  k.Jl = function () {
    this.f && (ld(this.c), Ec(this.f), (this.f = null));
    var a = this.Me();
    a &&
      ((this.f = y(a, 'postrender', this.render, this)),
      yk(this),
      (a = this.v ? a.D : a.C),
    ...
    if (this.get(wk) && this.autoPan) {
      ...
      if (a && a.jd()) {
        ...
        Va(b, g) ||
          ...
          (c = a.Ja(c)),
          (b = [c[0] + b[0], c[1] + b[1]]),
          a.Z().animate({ center: a.Wa(b), duration: this.j.duration, easing: this.j.easing }));
      }
    }
  };
  k.Ql = function () {
  ...
  function Bk(a) {
    ...
    function c(a) {
      a = h.Tf({ clientX: a.clientX - n.offsetWidth / 2, clientY: a.clientY + n.offsetHeight / 2 });
      m.Ne(a);
    }
    a = a ? a : {};
    ...
    var h = (this.c = new G({ controls: new Yc(), interactions: new Yc(), view: a.view }));
    a.layers &&
    ...
    this.l = new sk({ position: [0, 0], positioning: 'bottom-left', element: e });
    this.c.jh(this.l);
    e = document.createElement('div');
    e.className =
      d +
      ' ol-unselectable ol-control' +
      (this.j && this.o ? ' ol-collapsed' : '') +
      (this.o ? '' : ' ol-uncollapsible');
    e.appendChild(this.C);
    e.appendChild(f);
    md.call(this, { element: e, render: a.render ? a.render : Ck, target: a.target });
    var l = this,
      m = this.l,
      n = this.l.Rd();
  ...
  k.setMap = function (a) {
    var b = this.a;
    a !== b &&
      (b && ((b = b.Z()) && Kc(b, Vc('rotation'), this.Ge, this), this.c.Le(null)),
      md.prototype.setMap.call(this, a),
      a &&
        (this.c.Le(this.C),
        ...
        (a = a.Z()))) &&
      (y(a, Vc('rotation'), this.Ge, this), jg(a) && (this.c.Ad(), Dk(this)));
  };
  k.Kl = function (a) {
    'view' === a.key &&
      ((a = a.oldValue) && Kc(a, Vc('rotation'), this.Ge, this), (a = this.a.Z()), y(a, Vc('rotation'), this.Ge, this));
  };
  k.Ge = function () {
  ...
  function Ck() {
    ...
    if (a.c && b.c) {
      ...
      b < 0.1 * f || e < 0.1 * d || b > 0.75 * f || e > 0.75 * d
        ? Dk(this)
        : Va(c, a) || ((a = this.c), (c = this.a.Z()), a.Z().ob(c.wa()));
    }
    Ek(this);
  }
  function Dk(a) {
    ...
    var c = b.Ob(),
      b = b.Z().dd(c);
    a = a.Z();
    rb(b, 1 / (0.1 * Math.pow(2, Math.log(7.5) / Math.LN2 / 2)));
    a.Qf(b);
  }
  function Ek(a) {
    var b = a.a,
  ...
  k.cn = function (a) {
    this.o !== a && ((this.o = a), this.element.classList.toggle('ol-uncollapsible'), !a && this.j && Fk(this));
  };
  k.bn = function (a) {
  ...
  function Gk(a) {
    ...
    this.B = void 0;
    this.D = '';
    md.call(this, { element: this.c, render: a.render ? a.render : Hk, target: a.target });
  ...
  function Kk(a) {
    ...
    if (b) {
      ...
      b = f + ' ' + c;
      a.D != b && ((a.o.innerHTML = b), (a.D = b));
      a.B != d && ((a.o.style.width = d + 'px'), (a.B = d));
  ...
  function Lk(a) {
    ...
    y(c, 'click', Pc);
    md.call(this, { element: d, render: a.render ? a.render : Nk });
  }
  v(Lk, md);
  ...
  function Nk(a) {
    if (a.frameState) {
      if (!this.na) {
        ...
        this.I = [b, e];
        c > d ? ((this.j = 1), (this.D = c - b)) : ((this.j = Mk), (this.l = d - e));
        this.na = !0;
      }
  ...
  k.vl = function (a) {
    ...
    b.animate({ resolution: b.constrainResolution(a), duration: this.T, easing: rd });
  };
  k.yl = function (a) {
    this.u ||
      a.b.target !== this.element.firstElementChild ||
      (cg(this.a.Z(), 1, 1), (this.C = a.clientX), (this.B = a.clientY), (this.u = !0));
  };
  k.wl = function (a) {
    if (this.u) {
      ...
      this.c = Pk(
        ...
        Ca(
          1 === this.j
            ...
            : (a.clientY - this.B + parseInt(b.style.top, 10)) / this.l,
          0,
          1
        )
      );
  ...
  k.xl = function () {
    if (this.u) {
      var a = this.a.Z();
      cg(a, 1, -1);
      a.animate({ resolution: a.constrainResolution(this.c), duration: this.T, easing: rd });
      this.u = !1;
    ...
    if (null !== a.alpha) {
      ...
      'boolean' === typeof a.absolute && a.absolute
        ...
        : 'number' === typeof a.webkitCompassHeading &&
          ...
          this.set(Uk, Ha(a.webkitCompassHeading));
    }
  ...
  k.vm = function () {
    if (Vd) {
      var a = this.Th();
      a && !this.a
        ? (this.a = y(window, 'deviceorientation', this.ap, this))
        : a || null === this.a || (Ec(this.a), (this.a = null));
    }
  };
  k.gg = function (a) {
    this.set(Sk, a);
  ...
  function Zk(a, b) {
    ...
    var l = 2 * (a.b + g) + 1,
      c = { strokeStyle: h, zj: g, size: l, lineCap: c, lineDash: f, lineJoin: d, miterLimit: e };
    if (void 0 === b) {
      var m = jd(l, l);
      a.u = m.canvas;
      b = l = a.u.width;
      a.rh(c, m, 0, 0);
      a.Va ? (a.D = a.u) : ((m = jd(c.size, c.size)), (a.D = m.canvas), a.qh(c, m, 0, 0));
    } else
      ((l = Math.round(l)),
          ...
          ? ((e = a.Ya),
            void 0 === e.b &&
              ...
              (e.b +=
                ...
                (void 0 !== e.j ? e.j : '-') +
                ',' +
                (void 0 !== e.o ? e.o.toString() : '-') +
                ',' +
                (void 0 !== e.c ? e.c.toString() : '-'))),
            (e = e.b))
          : (e = '-'),
        a.Va
          ? ((f = a.Va),
            void 0 === f.a &&
              (f.a =
                f.b instanceof CanvasPattern || f.b instanceof CanvasGradient
                  ? w(f.b).toString()
                  : 'f' + (f.b ? gd(f.b) : '-')),
            (f = f.a))
          : (f = '-'),
        (a.c && e == a.c[1] && f == a.c[2] && a.b == a.c[3] && a.i == a.c[4] && a.j == a.c[5] && a.o == a.c[6]) ||
          (a.c = [
            'r' +
              e +
              f +
              (void 0 !== a.b ? a.b.toString() : '-') +
              (void 0 !== a.i ? a.i.toString() : '-') +
              (void 0 !== a.j ? a.j.toString() : '-') +
              (void 0 !== a.o ? a.o.toString() : '-'),
            e,
            f,
            a.b,
            a.i,
  ...
  k.rh = function (a, b, c, d) {
    ...
    this.Va && ((c = this.Va.b), null === c && (c = Sh), (b.fillStyle = id(c)), b.fill());
    this.Ya &&
  ...
  k.qh = function (a, b, c, d) {
    ...
    b.fill();
    this.Ya &&
      ((b.strokeStyle = a.strokeStyle), (b.lineWidth = a.zj), a.lineDash && b.setLineDash(a.lineDash), b.stroke());
    b.closePath();
  };
  function $k(a) {
    a = a || {};
  ...
  function dl(a) {
    if ('function' !== typeof a) {
      ...
      else (xa(a instanceof bl, 41), (b = [a]));
      a = function () {
        return b;
      };
    }
  ...
  function fl() {
    if (!el) {
      var a = new al({ color: 'rgba(255,255,255,0.4)' }),
        b = new wj({ color: '#3399CC', width: 1.25 });
  ...
  function gl() {
    var a = {},
      b = [255, 255, 255, 1],
      c = [0, 153, 255, 1];
    a.Polygon = [new bl({ fill: new al({ color: [255, 255, 255, 0.5] }) })];
    a.MultiPolygon = a.Polygon;
    a.LineString = [
      new bl({ stroke: new wj({ color: b, width: 5 }) }),
      new bl({ stroke: new wj({ color: c, width: 3 }) })
    ];
    a.MultiLineString = a.LineString;
    a.Circle = a.Polygon.concat(a.LineString);
    a.Point = [
      new bl({
        image: new $k({ radius: 6, fill: new al({ color: c }), stroke: new wj({ color: b, width: 1.5 }) }),
        zIndex: Infinity
      })
    ];
  ...
  function hl(a) {
    ...
    if ('function' === typeof a)
      ...
      else (xa(a instanceof bl, 41), (c = [a]));
      b = function () {
        return c;
      };
    }
  ...
  function ll(a, b, c) {
    ...
    else for (a = a.firstChild; a; a = a.nextSibling) ll(a, b, c);
    return c;
  }
  function ml(a) {
    ...
    return function (e, f, g) {
      ...
      h.onload = function () {
        if (!h.status || (200 <= h.status && 300 > h.status)) {
          ...
          else 'xml' == a ? (e = h.responseXML) || (e = pl(h.responseText)) : 'arraybuffer' == a && (e = h.response);
          e ? c.call(this, b.Oa(e, { featureProjection: g }), b.kb(e)) : d.call(this);
        } else d.call(this);
      }.bind(this);
      h.onerror = function () {
        d.call(this);
  ...
  function Fl(a, b, c) {
    var d;
    c &&
      (d = { dataProjection: c.dataProjection ? c.dataProjection : a.kb(b), featureProjection: c.featureProjection });
    return Gl(a, d);
  }
  function Gl(a, b) {
    return tb({ dataProjection: a.defaultDataProjection, featureProjection: a.f }, b);
  }
  function Hl(a, b, c) {
    var d = c ? Tb(c.featureProjection) : null,
      e = c ? Tb(c.dataProjection) : null,
      f;
    d && e && !dc(d, e)
      ? a instanceof of
  ...
  function Kl(a, b, c, d, e, f) {
    ...
    if (1 === l) ((g = a[b]), (h = a[b + 1]));
      ...
      l = 0;
      m = g.length;
      for (n = !1; l < m; ) ((e = l + ((m - l) >> 1)), (h = +ia(g[e], c)), 0 > h ? (l = e + 1) : ((m = e), (n = !h)));
      e = n ? l : ~l;
      0 > e
        ? ((c = (c - g[-e - 2]) / (g[-e - 1] - g[-e - 2])),
          (b += (-e - 2) * d),
          (g = Ja(a[b], a[b + d], c)),
          (h = Ja(a[b + 1], a[b + d + 1], c)))
  ...
  function Ll(a, b, c, d, e, f) {
    ...
    c = [];
    var g;
    for (g = 0; g < d - 1; ++g) c.push(Ja(a[(b - 1) * d + g], a[b * d + g], f));
    c.push(e);
    return c;
  }
  function Ml(a, b, c, d, e, f) {
    ...
    for (f = b.length; e < f; ++e) {
      ...
      if (g != h) {
        if (d < a[g + c - 1]) break;
        else if (d <= a[h - 1]) return Ll(a, g, h, c, d, !1);
        g = h;
      }
    }
    return null;
  ...
  k.Kb = function (a, b, c, d) {
    if (d < Sa(this.G(), a, b)) return d;
    this.u != this.i && ((this.D = Math.sqrt(yf(this.A, 0, this.A.length, this.a, 0))), (this.u = this.i));
  ...
  k.nn = function (a, b) {
    return 'XYM' != this.ja && 'XYZM' != this.ja
      ? null
      : Ll(this.A, 0, this.A.length, this.a, a, void 0 !== b ? b : !1);
  };
  k.X = function () {
    return Ff(this.A, 0, this.A.length, this.a);
  };
  ...
  function di(a) {
    a.j != a.i && ((a.c = a.wh(0.5, a.c)), (a.j = a.i));
    return a.c;
  }
  k.hd = function (a) {
    var b = [];
  ...
  k.Kb = function (a, b, c, d) {
    if (d < Sa(this.G(), a, b)) return d;
    this.j != this.i && ((this.u = Math.sqrt(zf(this.A, 0, this.c, this.a, 0))), (this.j = this.i));
    return Bf(this.A, 0, this.c, this.a, this.u, !1, a, b, c, d);
  };
  k.rn = function (a, b, c) {
    return ('XYM' != this.ja && 'XYZM' != this.ja) || !this.A.length
      ? null
      : Ml(this.A, this.c, this.a, a, void 0 !== b ? b : !1, void 0 !== c ? c : !1);
  };
  k.X = function () {
  ...
  k.rk = function (a) {
    ...
    } else ((this.A = a.ga().slice()), (a = a.Bb().slice()), this.c.push());
    this.c.push(a);
    this.s();
  };
  k.clone = function () {
  ...
  k.Kb = function (a, b, c, d) {
    ...
    if (this.C != this.i) {
      var e = this.c,
        ...
        h;
      var l = 0;
      for (h = e.length; l < h; ++l) var m = e[l], g = zf(this.A, f, m, this.a, g), f = m[m.length - 1];
      this.B = Math.sqrt(g);
      this.C = this.i;
    }
    e = fi(this);
  ...
  k.sn = function () {
    var a = fi(this),
      ...
      e;
    var f = 0;
    for (e = b.length; f < e; ++f) var g = b[f], d = d + wf(a, c, g, this.a), c = g[g.length - 1];
    return d;
  };
  k.X = function (a) {
    if (void 0 !== a) {
  ...
  k.ma = function (a, b) {
    if (a) {
      ...
      var c = this.a,
        ...
        g;
      var h = 0;
      for (g = a.length; h < g; ++h) ((e = Ef(b, e, a[h], c, d[f])), (d[f++] = e), (e = e[e.length - 1]));
      d.length = f;
  ...
  function Rl(a, b) {
    ...
    if ('number' === typeof a.x && 'number' === typeof a.y) var c = 'Point';
      ...
      for (h = d.length; l < h; ++l)
        ((f.length = 0), Df(f, 0, d[l], e.length), Sf(f, 0, f.length, e.length) ? g.push([d[l]]) : c.push(d[l]));
      for (; c.length; ) {
        d = c.shift();
        e = !1;
  ...
  k.yg = function (a, b) {
    ...
    if (a.features) {
      ...
      a = 0;
      for (e = d.length; a < e; ++a) c.push(this.Rc(d[a], b));
      return c;
    }
    return [this.Rc(a, b)];
  };
  ...
  k.Zc = function (a, b) {
    ...
    delete d[a.c];
    c.attributes = wb(d) ? {} : d;
    b && b.featureProjection && (c.spatialReference = { wkid: Tb(b.featureProjection).mb.split(':').pop() });
    return c;
  };
  k.he = function (a, b) {
    b = Gl(this, b);
    var c = [],
      d;
    var e = 0;
    for (d = a.length; e < d; ++e) c.push(this.Zc(a[e], b));
    return { features: c };
  };
  function Xl(a) {
    this.kc = a;
  ...
  function wm(a) {
    ...
    if (a.a) {
      var c = 0;
      for (b = a.a.length; c < b; ++c) Kc(a.a[c], 'change', a.s, a);
    }
  }
  function um(a) {
    var b;
  ...
  k.Kb = function (a, b, c, d) {
    ...
    var e = this.a,
      f;
    var g = 0;
    for (f = e.length; g < f; ++g) d = e[g].Kb(a, b, c, d);
    return d;
  };
  k.Mc = function (a, b) {
    var c = this.a,
      d;
    var e = 0;
    for (d = c.length; e < d; ++e) if (c[e].Mc(a, b)) return !0;
    return !1;
  };
  k.se = function (a) {
    Ya(a);
    for (var b = this.a, c = 0, d = b.length; c < d; ++c) cb(a, b[c].G());
    return a;
  };
  k.Vf = function () {
    return vm(this.a);
  ...
  k.Vd = function (a) {
    ...
    if (e) return ((a = new tm(null)), wm(a), (a.a = c), um(a), a.s(), (this.f[b] = a));
    this.g = a;
    return this;
  };
  k.U = function () {
  ...
  k.Xa = function (a) {
    var b = this.a,
      c;
    var d = 0;
    for (c = b.length; d < c; ++d) if (b[d].Xa(a)) return !0;
    return !1;
  };
  k.rotate = function (a, b) {
  ...
  v(xm, Il);
  function ym(a, b) {
    return a ? Hl((0, zm[a.type])(a), !1, b) : null;
  }
  function Am(a, b) {
    return (0, Bm[a.U()])(Hl(a, !0, b), b);
  }
  var zm = {
      Point: function (a) {
  ...
  k.yg = function (a, b) {
    if ('FeatureCollection' === a.type) {
      ...
      var d;
      var e = 0;
      for (d = a.length; e < d; ++e) c.push(this.Rc(a[e], b));
    } else c = [this.Rc(a, b)];
    return c;
  };
  k.Cg = function (a, b) {
  ...
  k.Fg = function (a) {
    ...
    a
      ? 'name' == a.type
        ? (b = Tb(a.properties.name))
        : 'EPSG' == a.type
          ? (b = Tb('EPSG:' + a.properties.code))
          : xa(!1, 36)
  ...
  k.Oa = function (a, b) {
    return ml(a) ? Em(this, a, b) : nl(a) ? this.zc(a, b) : 'string' === typeof a ? ((a = pl(a)), Em(this, a, b)) : [];
  };
  function Em(a, b, c) {
    var d = [];
    for (b = b.firstChild; b; b = b.nextSibling) b.nodeType == Node.ELEMENT_NODE && la(d, a.zc(b, c));
    return d;
  }
  k.Sc = function (a, b) {
    if (ml(a)) return null;
    if (nl(a)) return this.aj(a, b);
  ...
  k.kb = function (a) {
    return ml(a) ? this.Eg(a) : nl(a) ? this.kf(a) : 'string' === typeof a ? ((a = pl(a)), this.Eg(a)) : null;
  };
  k.Eg = function () {
  ...
  function Fm(a) {
    ...
    this.schemaLocation = '';
    this.b = {};
    this.b['http://www.opengis.net/gml'] = { featureMember: sl(Fm.prototype.be), featureMembers: sl(Fm.prototype.be) };
    Cm.call(this);
  }
  v(Fm, Cm);
  var Gm = /^[\s\xa0]*$/;
      ...
      for (u in g) {
        ...
        for (h = f.length; l < h; ++l)
          (-1 === f[l].indexOf(':') ? 'p0' : f[l].split(':')[0]) === u &&
            (n[f[l].split(':').pop()] = 'featureMembers' == c ? rl(this.wg, this) : sl(this.wg, this));
        e[g[u]] = n;
      }
  ...
  k.gf = function (a, b) {
    ...
    if ((a = N(null, this.Zg, a, b, this))) return Hl(a, !1, c);
  };
  k.wg = function (a, b) {
    var c;
    ...
    for (a = a.firstElementChild; a; a = a.nextElementSibling) {
      ...
      if (
        ...
        Gm.test(g) && (g = void 0);
        d[f] = g;
      } else ('boundedBy' !== f && (e = f), (d[f] = this.gf(a, b)));
    }
    b = new H(d);
    e && b.Tc(e);
    c && b.jc(c);
  ...
  k.fj = function (a, b) {
    if ((a = this.ff(a, b))) return ((b = new C(null)), b.ba('XYZ', a), b);
  };
  k.dj = function (a, b) {
    if ((a = N([], this.Nj, a, b, this))) return new Q(a);
  };
  k.cj = function (a, b) {
    if ((a = N([], this.Mj, a, b, this))) return ((b = new P(null)), Nl(b, a), b);
  };
  k.ej = function (a, b) {
    if ((a = N([], this.Oj, a, b, this))) return ((b = new R(null)), Pl(b, a), b);
  };
  k.Xi = function (a, b) {
    Al(this.Rj, a, b, this);
  };
  ...
  k.hf = function (a, b) {
    if ((a = this.ff(a, b))) return ((b = new O(null)), b.ba('XYZ', a), b);
  };
  k.wp = function (a, b) {
    if ((a = N(null, this.ke, a, b, this))) return a;
  };
  k.bj = function (a, b) {
    if ((a = this.ff(a, b))) return ((b = new Jf(null)), Kf(b, 'XYZ', a), b);
  };
  k.jf = function (a, b) {
    if ((a = N([null], this.zf, a, b, this)) && a[0]) {
      ...
      var c = a[0],
        ...
        e;
      var f = 1;
      for (e = a.length; f < e; ++f) (la(c, a[f]), d.push(c.length));
      b.ba('XYZ', c, d);
      return b;
    }
  };
  ...
  k.Mj = {
    'http://www.opengis.net/gml': { lineStringMember: rl(Fm.prototype.Mh), lineStringMembers: rl(Fm.prototype.Mh) }
  };
  k.Oj = { 'http://www.opengis.net/gml': { polygonMember: rl(Fm.prototype.Yi), polygonMembers: rl(Fm.prototype.Yi) } };
  k.Rj = { 'http://www.opengis.net/gml': { Point: rl(Fm.prototype.ff) } };
  k.Kj = { 'http://www.opengis.net/gml': { LineString: rl(Fm.prototype.hf) } };
  k.Sj = { 'http://www.opengis.net/gml': { Polygon: rl(Fm.prototype.jf) } };
  k.le = { 'http://www.opengis.net/gml': { LinearRing: sl(Fm.prototype.wp) } };
  k.aj = function (a, b) {
  ...
  k = Sm.prototype;
  k.Ap = function (a, b) {
    if ((a = N([], this.Lj, a, b, this))) return ((b = new P(null)), Nl(b, a), b);
  };
  k.Bp = function (a, b) {
    if ((a = N([], this.Pj, a, b, this))) return ((b = new R(null)), Pl(b, a), b);
  };
  k.ph = function (a, b) {
    Al(this.Hj, a, b, this);
  };
  ...
  k.Zi = function (a, b) {
    if ((a = N([null], this.Ij, a, b, this))) return ((b = new O(null)), b.ba('XYZ', a), b);
  };
  k.vp = function (a, b) {
  ...
  k.Bg = function (a, b) {
    ...
    a.getAttribute('srsDimension')
      ? (d = Nm(a.getAttribute('srsDimension')))
      : a.getAttribute('dimension')
        ? (d = Nm(a.getAttribute('dimension')))
        : e && (d = Nm(e));
  ...
  k.ke = { 'http://www.opengis.net/gml': { pos: sl(Sm.prototype.xp), posList: sl(Sm.prototype.Bg) } };
  k.zf = { 'http://www.opengis.net/gml': { interior: Sm.prototype.cm, exterior: Sm.prototype.yk } };
  k.Zg = {
  ...
  k.Lj = { 'http://www.opengis.net/gml': { curveMember: rl(Sm.prototype.ph), curveMembers: rl(Sm.prototype.ph) } };
  k.Pj = { 'http://www.opengis.net/gml': { surfaceMember: rl(Sm.prototype.Aj), surfaceMembers: rl(Sm.prototype.Aj) } };
  k.Hj = { 'http://www.opengis.net/gml': { LineString: rl(Fm.prototype.hf), Curve: rl(Sm.prototype.Zi) } };
  k.Uj = { 'http://www.opengis.net/gml': { Polygon: rl(Fm.prototype.jf), Surface: rl(Sm.prototype.gj) } };
  k.Vj = { 'http://www.opengis.net/gml': { patches: sl(Sm.prototype.Ep) } };
  k.Ij = { 'http://www.opengis.net/gml': { segments: sl(Sm.prototype.Hp) } };
  k.Jj = { 'http://www.opengis.net/gml': { lowerCorner: rl(Sm.prototype.Bg), upperCorner: rl(Sm.prototype.Bg) } };
  k.Qj = { 'http://www.opengis.net/gml': { PolygonPatch: sl(Sm.prototype.Fp) } };
  k.Tj = { 'http://www.opengis.net/gml': { LineStringSegment: sl(Sm.prototype.zp) } };
  function Tm(a, b, c) {
    var d = c[c.length - 1];
    c = d.hasZ;
    d = d.srsName;
  ...
  var Um = { 'http://www.opengis.net/gml': { lowerCorner: J(Pm), upperCorner: J(Pm) } };
  k = Sm.prototype;
  k.jn = function (a, b, c) {
    var d = c[c.length - 1].srsName;
    d && a.setAttribute('srsName', d);
    Bl({ node: a }, Um, yl, [b[0] + ' ' + b[1], b[2] + ' ' + b[3]], c, ['lowerCorner', 'upperCorner'], this);
  };
  k.ki = function (a, b, c) {
    var d = c[c.length - 1].srsName;
    d && a.setAttribute('srsName', d);
  ...
  k.Se = function (a, b, c) {
    ...
    'Polygon' === a.nodeName || 'PolygonPatch' === a.nodeName
      ? ((b = b.Sd()), Bl({ node: a, hasZ: e, srsName: d }, Vm, this.hn, b, c, void 0, this))
      : 'Surface' === a.nodeName &&
        ((e = jl(a.namespaceURI, 'patches')),
        a.appendChild(e),
  ...
  k.Re = function (a, b, c) {
    ...
    'LineString' === a.nodeName || 'LineStringSegment' === a.nodeName
      ? ((d = jl(a.namespaceURI, 'posList')), a.appendChild(d), Tm(d, b, c))
      : 'Curve' === a.nodeName &&
        ((d = jl(a.namespaceURI, 'segments')),
        a.appendChild(d),
  ...
  k.mi = function (a, b, c) {
    ...
    b = b.Td();
    Bl({ node: a, hasZ: e, srsName: f, surface: d }, Wm, this.o, b, c, void 0, this);
  };
  k.kn = function (a, b, c) {
    var d = c[c.length - 1],
      e = d.srsName,
    ...
    b = b.Zd();
    Bl({ node: a, hasZ: d, srsName: e }, Xm, wl('pointMember'), b, c, void 0, this);
  };
  k.li = function (a, b, c) {
    var d = c[c.length - 1],
      e = d.hasZ,
    ...
    f && a.setAttribute('srsName', f);
    b = b.gd();
    Bl({ node: a, hasZ: e, srsName: f, curve: d }, Ym, this.o, b, c, void 0, this);
  };
  k.oi = function (a, b, c) {
  ...
  k.pi = function (a, b, c) {
    var d = this.a(b, c);
    d && (a.appendChild(d), this.Se(d, b, c));
  };
  k.ln = function (a, b, c) {
  ...
  k.od = function (a, b, c) {
    ...
    Array.isArray(b)
      ? d.dataProjection
        ? (f = hc(b, d.featureProjection, d.dataProjection))
        : (f = b)
      : (f = Hl(b, !0, d));
  ...
  k.ii = function (a, b, c) {
    ...
    for (m in g) {
      ...
      null !== l &&
        ...
        h.push(l),
        m == f || l instanceof of
          ? m in d.lb[e] || (d.lb[e][m] = J(this.od, this))
          : m in d.lb[e] || (d.lb[e][m] = J(Pm)));
    }
    var m = tb({}, d);
    m.node = a;
    Bl(m, d.lb, wl(void 0, e), h, c, b);
  };
  var Wm = { 'http://www.opengis.net/gml': { surfaceMember: J(Sm.prototype.pi), polygonMember: J(Sm.prototype.pi) } },
    Xm = { 'http://www.opengis.net/gml': { pointMember: J(Sm.prototype.ln) } },
    Ym = { 'http://www.opengis.net/gml': { lineStringMember: J(Sm.prototype.ji), curveMember: J(Sm.prototype.ji) } },
    Vm = { 'http://www.opengis.net/gml': { exterior: J(Sm.prototype.oi), interior: J(Sm.prototype.oi) } },
    Zm = {
      'http://www.opengis.net/gml': {
  ...
  k.ke = { 'http://www.opengis.net/gml': { coordinates: sl(an.prototype.$i) } };
  k.zf = { 'http://www.opengis.net/gml': { innerBoundaryIs: an.prototype.am, outerBoundaryIs: an.prototype.bp } };
  k.Gj = { 'http://www.opengis.net/gml': { coordinates: rl(an.prototype.$i) } };
  k.Zg = {
    'http://www.opengis.net/gml': {
      Point: sl(Fm.prototype.fj),
      MultiPoint: sl(Fm.prototype.dj),
  ...
  k.Pe = function (a, b, c) {
    ...
    'LineStringSegment' !== a.nodeName && d && a.setAttribute('srsName', d);
    'LineString' === a.nodeName || 'LineStringSegment' === a.nodeName
      ? ((d = cn(a.namespaceURI)), a.appendChild(d), dn(d, b, c))
      : 'Curve' === a.nodeName &&
        ((d = jl(a.namespaceURI, 'segments')),
        a.appendChild(d),
        (a = jl(d.namespaceURI, 'LineStringSegment')),
  ...
  function dn(a, b, c) {
    ...
    d = d.srsName;
    b = b.X();
    for (var e = b.length, f = Array(e), g, h = 0; h < e; ++h) ((g = b[h]), (f[h] = en(g, d, c)));
    Pm(a, f.join(' '));
  }
  k.Qe = function (a, b, c) {
    var d = c[c.length - 1],
    ...
    'PolygonPatch' !== a.nodeName && d && a.setAttribute('srsName', d);
    'Polygon' === a.nodeName || 'PolygonPatch' === a.nodeName
      ? ((b = b.Sd()), Bl({ node: a, hasZ: e, srsName: d }, fn, this.dn, b, c, void 0, this))
      : 'Surface' === a.nodeName &&
        ((e = jl(a.namespaceURI, 'patches')),
        a.appendChild(e),
        (a = jl(e.namespaceURI, 'PolygonPatch')),
  ...
  k.di = function (a, b, c) {
    ...
    f && a.setAttribute('srsName', f);
    b = b.gd();
    Bl({ node: a, hasZ: e, srsName: f, curve: d }, gn, this.a, b, c, void 0, this);
  };
  k.fi = function (a, b, c) {
    var d = c[c.length - 1];
    c = d.hasZ;
  ...
  k.fn = function (a, b, c) {
    ...
    b = b.Zd();
    Bl({ node: a, hasZ: e, srsName: d }, hn, wl('pointMember'), b, c, void 0, this);
  };
  k.gn = function (a, b, c) {
    var d = jl(a.namespaceURI, 'Point');
    a.appendChild(d);
  ...
  k.ei = function (a, b, c) {
    ...
    f && a.setAttribute('srsName', f);
    b = b.Td();
    Bl({ node: a, hasZ: e, srsName: f, surface: d }, jn, this.a, b, c, void 0, this);
  };
  k.hi = function (a, b, c) {
    var d = this.jg(b, c);
  ...
  k.en = function (a, b, c) {
    var d = c[c.length - 1].srsName;
    d && a.setAttribute('srsName', d);
    Bl({ node: a }, kn, yl, [b[0] + ' ' + b[1], b[2] + ' ' + b[3]], c, ['lowerCorner', 'upperCorner'], this);
  };
  var bn = {
      'http://www.opengis.net/gml': {
    ...
    fn = { 'http://www.opengis.net/gml': { outerBoundaryIs: J(an.prototype.gi), innerBoundaryIs: J(an.prototype.gi) } },
    hn = { 'http://www.opengis.net/gml': { pointMember: J(an.prototype.gn) } },
    gn = { 'http://www.opengis.net/gml': { lineStringMember: J(an.prototype.bi), curveMember: J(an.prototype.bi) } };
  ...
  var ln = {
    ...
    jn = { 'http://www.opengis.net/gml': { surfaceMember: J(an.prototype.hi), polygonMember: J(an.prototype.hi) } },
    kn = { 'http://www.opengis.net/gml': { lowerCorner: J(Pm), upperCorner: J(Pm) } };
  function mn(a) {
    a = a ? a : {};
    Cm.call(this);
  ...
  function tn(a, b) {
    var c = b[0];
    if ((a = N({ flatCoordinates: [], layoutOptions: {} }, un, a, b))) {
      b = a.flatCoordinates;
  ...
  function vn(a, b) {
    var c = b[0];
    if ((a = N({ flatCoordinates: [], ends: [], layoutOptions: {} }, wn, a, b))) {
      b = a.flatCoordinates;
      delete a.flatCoordinates;
      var d = a.ends;
      delete a.ends;
  ...
  var zn = { rte: tn, trk: vn, wpt: xn },
    An = K(nn, { rte: rl(tn), trk: rl(vn), wpt: rl(xn) }),
    rn = K(nn, { text: I(S, 'linkText'), type: I(S, 'linkType') }),
    un = K(nn, {
      name: I(S),
      cmt: I(S),
      desc: I(S),
      ...
      rtept: function (a, b) {
        var c = N({}, Bn, a, b);
        c && ((b = b[b.length - 1]), on(b.flatCoordinates, b.layoutOptions, a, c));
      }
    }),
    Bn = K(nn, { ele: I(Km), time: I(Jm) }),
    wn = K(nn, {
      name: I(S),
      cmt: I(S),
      desc: I(S),
  ...
  mn.prototype.xg = function (a, b) {
    if (!ja(nn, a.namespaceURI)) return null;
  ...
  mn.prototype.zc = function (a, b) {
    return ja(nn, a.namespaceURI)
      ? 'gpx' == a.localName && (a = N([], An, a, [Fl(this, a, b)]))
        ? (En(this, a), a)
        : []
      : [];
  };
  function Fn(a, b, c) {
    ...
    Bl({ node: a }, Gn, yl, [b.linkText, b.linkType], c, Hn);
  }
  function In(a, b, c) {
    var d = c[c.length - 1],
    ...
    d = zl(f, b);
    Bl({ node: a, properties: f }, Ln, yl, d, c, b);
  }
  var Hn = ['text', 'type'],
    Gn = K(nn, { text: J(Pm), type: J(Pm) }),
    ...
    Rn = K(nn, {
      ...
      trkseg: vl(
        J(function (a, b, c) {
          Bl({ node: a, geometryLayout: b.ja, properties: {} }, Pn, Qn, b.X(), c);
        })
      )
    }),
    Qn = wl('trkpt'),
    ...
    Sn = { Point: 'wpt', LineString: 'rte', MultiLineString: 'trk' };
  function Tn(a, b) {
    if ((a = a.V())) if ((a = Sn[a.U()])) return jl(b[b.length - 1].node.namespaceURI, a);
  }
  var Un = K(nn, {
    rte: J(function (a, b, c) {
      ...
      if ((b = b.V())) ((b = Hl(b, !0, d)), (a.geometryLayout = b.ja), (e.rtept = b.X()));
    ...
    trk: J(function (a, b, c) {
      var d = c[0],
        e = b.N();
      a = { node: a, properties: e };
      if ((b = b.V())) ((b = Hl(b, !0, d)), (e.trkseg = b.gd()));
    ...
    wpt: J(function (a, b, c) {
      var d = c[0],
        e = c[c.length - 1];
      e.properties = b.N();
      if ((b = b.V())) ((b = Hl(b, !0, d)), (e.geometryLayout = b.ja), In(a, b.X(), c));
    })
  });
  ...
  k.ae = function (a, b) {
    ...
    for (m = d.length; n < m; ++n) {
      ...
      if ('B' == p.charAt(0)) {
        ...
        'H' == p.charAt(0) &&
          ((q = $n.exec(p))
            ? ((h = parseInt(q[1], 10)), (g = parseInt(q[2], 10) - 1), (f = 2e3 + parseInt(q[3], 10)))
            : (q = Zn.exec(p)) && (a[q[1]] = q[2].trim()));
    }
  ...
  function eo(a) {
    a = a || {};
    this.o = void 0 !== a.anchor ? a.anchor : [0.5, 0.5];
    this.u = null;
    ...
    var f = this.ra,
      g = this.j,
      h = zh.get(d, f, g);
    h || ((h = new bo(b, d, c, f, e, g)), zh.set(d, f, g, h));
    this.b = h;
  ...
  k.Hc = function () {
    ...
    if ('top-left' != this.i) {
      ...
      if ('top-right' == this.i || 'bottom-right' == this.i) a[0] = -a[0] + b[0];
      if ('bottom-left' == this.i || 'bottom-right' == this.i) a[1] = -a[1] + b[1];
    }
    return (this.u = a);
  };
  k.Lo = function () {
  ...
  function fo(a) {
    ...
    this.Va = void 0 !== a.fill ? a.fill : new al({ color: '#333' });
    this.Ya = void 0 !== a.stroke ? a.stroke : null;
  ...
  function go(a) {
    ...
    ho ||
      ...
      (ro = 'NO_IMAGE'),
      (so = new wj({ color: io, width: 1 })),
      (to = new wj({ color: [51, 51, 51, 1], width: 2 })),
      (uo = new fo({ font: 'bold 16px Helvetica', fill: jo, stroke: to, scale: 0.8 })),
      (vo = new bl({ fill: jo, image: qo, text: uo, stroke: so, zIndex: 0 })),
      (ho = [vo]));
    this.defaultDataProjection = Tb('EPSG:4326');
  ...
  var wo = ['http://www.google.com/kml/ext/2.2'],
    ...
    yo = { fraction: 'fraction', pixels: 'pixels', insetPixels: 'pixels' };
  function zo(a, b) {
    var c = [0, 0],
      d = 'start';
    if (a.Y()) {
  ...
  function Ao(a, b, c, d, e) {
    return function () {
      ...
      if (a) return f ? ((f = zo(a[0], g)), a.concat(f)) : a;
      if (b) {
        var h = Bo(b, c, d);
        return f ? ((f = zo(h[0], g)), h.concat(f)) : h;
      }
      return f ? ((f = zo(c[0], g)), c.concat(f)) : c;
    };
  }
  function Bo(a, b, c) {
  ...
  function Ko(a, b) {
    var c = N({}, Lo, a, b);
    if ((a = N(null, Mo, a, b))) return ((b = new O(null)), b.ba('XYZ', a), b.H(c), b);
  }
  function No(a, b) {
    var c = N({}, Lo, a, b);
    if ((a = N(null, Mo, a, b))) return ((b = new D(null)), b.ba('XYZ', a, [a.length]), b.H(c), b);
  }
  function Oo(a, b) {
    a = N([], Po, a, b);
    if (!a) return null;
    if (!a.length) return new tm(a);
    var c = !0,
      d = a[0].U(),
      e;
    var f = 1;
    ...
    if (c)
      if ('Point' == d) {
        ...
        d = g.ga();
        f = 1;
        for (e = a.length; f < e; ++f) ((b = a[f]), la(d, b.ga()));
        g = new Q(null);
        g.ba(c, d);
        Qo(g, a);
      } else
        'LineString' == d
          ? ((g = new P(null)), Nl(g, a), Qo(g, a))
          : 'Polygon' == d
            ? ((g = new R(null)), Pl(g, a), Qo(g, a))
  ...
  function Ro(a, b) {
    var c = N({}, Lo, a, b);
    if ((a = N(null, Mo, a, b))) return ((b = new C(null)), b.ba('XYZ', a), b.H(c), b);
  }
  function So(a, b) {
    var c = N({}, Lo, a, b);
    if ((a = N([null], To, a, b)) && a[0]) {
      ...
      var d = a[0],
        ...
        f;
      var g = 1;
      for (f = a.length; g < f; ++g) (la(d, a[g]), e.push(d.length));
      b.ba('XYZ', d, e);
      b.H(c);
      return b;
    }
  ...
  function Uo(a, b) {
    ...
    b = b.outline;
    void 0 === b || b || (e = null);
    return [new bl({ fill: a, image: c, stroke: e, text: d, zIndex: void 0 })];
  }
  function Qo(a, b) {
    var c = b.length,
      d = Array(b.length),
  ...
  var $o = K(xo, { displayName: I(S), value: I(S) }),
    Xo = K(xo, {
      Data: function (a, b) {
    ...
    cp = K(xo, { minLodPixels: I(Km), maxLodPixels: I(Km), minFadeExtent: I(Km), maxFadeExtent: I(Km) }),
    Lo = K(xo, { extrude: I(Hm), altitudeMode: I(S) }),
    Ho = K(xo, { coordinates: sl(Do) }),
    To = K(xo, {
    ...
    Mo = K(xo, { coordinates: sl(Do) }),
    fp = K(xo, { href: I(Eo) }, K(wo, { x: I(Km), y: I(Km), w: I(Km), h: I(Km) })),
    gp = K(xo, {
      Icon: I(function (a, b) {
    ...
    dp = K(xo, { LinearRing: sl(Go) }),
    hp = K(xo, { color: I(Co), scale: I(Fo) }),
    ip = K(xo, { color: I(Co), width: I(Km) }),
    Po = K(xo, { LineString: rl(Ko), LinearRing: rl(No), MultiGeometry: rl(Oo), Point: rl(Ro), Polygon: rl(So) }),
    jp = K(wo, { Track: rl(Io) }),
    lp = K(xo, {
      ExtendedData: Wo,
      Region: Yo,
    ...
    kp = K(xo, { href: I(Eo) }),
    ep = K(xo, { LinearRing: sl(Go) }),
    mp = K(xo, { Style: I(Uo), key: I(S), styleUrl: I(Eo) }),
    op = K(
      xo,
      {
        ExtendedData: Wo,
      ...
      K(wo, {
        MultiTrack: I(function (a, b) {
          if ((a = N([], jp, a, b))) return ((b = new P(null)), Nl(b, a), b);
        }, 'geometry'),
        Track: I(Io, 'geometry')
      })
    ),
    pp = K(xo, { color: I(Co), fill: I(Hm), outline: I(Hm) }),
    ap = K(xo, {
    ...
    Vo = K(xo, {
      IconStyle: function (a, b) {
        if ((a = N({}, gp, a, b))) {
          ...
          if (g) {
            ...
            e === oo
              ? ((h = ko), (l = mo), (m = lo))
              : /^http:\/\/maps\.(?:google|gstatic)\.com\//.test(e) && ((h = [0.5, 0]), (m = l = 'fraction'));
          var n,
            g = c.x,
            p = c.y;
      ...
      LineStyle: function (a, b) {
        (a = N({}, ip, a, b)) &&
          (b[b.length - 1].strokeStyle = new wj({
      ...
      PolyStyle: function (a, b) {
        if ((a = N({}, pp, a, b))) {
          b = b[b.length - 1];
          b.fillStyle = new al({ color: 'color' in a ? a.color : io });
          var c = a.fill;
          void 0 !== c && (b.fill = c);
          a = a.outline;
  ...
  k.vg = function (a, b) {
    ...
    if ((a = N([], c, a, b, this))) return a;
  };
  k.Dg = function (a, b) {
    var c = N({ geometry: null }, op, a, b);
    if (c) {
      var d = new H();
      a = a.getAttribute('id');
      null !== a && d.jc(a);
  ...
  k.Jp = function (a, b) {
    ...
    null !== c &&
      (b = Uo(a, b)) &&
      ((a = a.baseURI && 'about:blank' !== a.baseURI ? new URL('#' + c, a.baseURI).href : '#' + c), (this.b[a] = b));
  };
  k.Ip = function (a, b) {
    var c = a.getAttribute('id');
    null !== c &&
  ...
  k.zc = function (a, b) {
    if (!ja(xo, a.namespaceURI)) return [];
    var c = a.localName;
    if ('Document' == c || 'Folder' == c) return (c = this.vg(a, [Fl(this, a, b)])) ? c : [];
    if ('Placemark' == c) return (b = this.Dg(a, [Fl(this, a, b)])) ? [b] : [];
    if ('kml' == c) {
      c = [];
      for (a = a.firstElementChild; a; a = a.nextElementSibling) {
        var d = this.zc(a, b);
  ...
  k.Cp = function (a) {
    if (ml(a)) return qp(this, a);
    if (nl(a)) return rp(this, a);
    if ('string' === typeof a) return ((a = pl(a)), qp(this, a));
  };
  function qp(a, b) {
  ...
  function rp(a, b) {
    ...
    for (c = b.firstElementChild; c; c = c.nextElementSibling)
      if (ja(xo, c.namespaceURI) && 'name' == c.localName) return S(c);
    for (c = b.firstElementChild; c; c = c.nextElementSibling)
      if (
        ((b = c.localName),
        ja(xo, c.namespaceURI) &&
  ...
  k.Dp = function (a) {
    ...
    ml(a)
      ...
      : nl(a)
        ? la(b, tp(this, a))
        : 'string' === typeof a && ((a = pl(a)), la(b, sp(this, a)));
    return b;
  };
  function sp(a, b) {
    var c = [];
    for (b = b.firstChild; b; b = b.nextSibling) b.nodeType == Node.ELEMENT_NODE && la(c, tp(a, b));
    return c;
  }
  function tp(a, b) {
    var c,
  ...
  k.Gp = function (a) {
    var b = [];
    ml(a) ? la(b, up(this, a)) : nl(a) ? la(b, this.lf(a)) : 'string' === typeof a && ((a = pl(a)), la(b, up(this, a)));
    return b;
  };
  function up(a, b) {
    var c = [];
    for (b = b.firstChild; b; b = b.nextSibling) b.nodeType == Node.ELEMENT_NODE && la(c, a.lf(b));
    return c;
  }
  k.lf = function (a) {
    var b,
  ...
  function Fp(a, b, c) {
    ...
    if (0 < f.length) {
      var g = zl(a, f);
      Bl(d, Gp, Hp, [{ names: f, values: g }], c);
    }
    if ((f = b.Lc()))
      if ((f = f.call(b, 0)))
        ((f = Array.isArray(f) ? f[0] : f), this.j && (a.Style = f), (f = f.Na()) && (a.name = f.Na()));
  ...
  var Rp = K(xo, ['Document', 'Placemark']),
    Up = K(xo, {
      Document: J(function (a, b, c) {
        Bl({ node: a }, Sp, Tp, b, c, void 0, this);
      }),
      Placemark: J(Fp)
    }),
    Sp = K(xo, { Placemark: J(Fp) }),
    Vp = K(xo, {
      Data: J(function (a, b, c) {
        ...
        b = b.value;
        'object' == typeof b
          ? (null !== b && b.displayName && Bl(a, Vp, yl, [b.displayName], c, ['displayName']),
            null !== b && b.value && Bl(a, Vp, yl, [b.value], c, ['value']))
          : Bl(a, Vp, yl, [b], c, ['value']);
      }),
    ...
    Yp = K(xo, { href: J(Pm) }, K(wo, { x: J(Qm), y: J(Qm), w: J(Qm), h: J(Qm) })),
    ...
    bq = K(xo, ['color', 'scale']),
    cq = K(xo, { color: J(vp), scale: J(Qp) }),
    dq = K(xo, ['color', 'width']),
    eq = K(xo, { color: J(vp), width: J(Qm) }),
    Dp = K(xo, { LinearRing: J(Jp) }),
    Bp = K(xo, { LineString: J(Jp), Point: J(Jp), Polygon: J(Mp), GeometryCollection: J(wp) }),
    ...
    Gp = K(xo, {
      ExtendedData: J(function (a, b, c) {
        ...
        var d = b.names;
        b = b.values;
        for (var e = d.length, f = 0; f < e; f++) Bl(a, Vp, fq, [{ name: d[f], value: b[f] }], c);
      }),
      MultiGeometry: J(wp),
      LineString: J(Jp),
      LinearRing: J(Jp),
    ...
    Np = K(xo, { outerBoundaryIs: J(Cp), innerBoundaryIs: J(Cp) }),
    iq = K(xo, { color: J(vp) }),
    ...
    hq = K(xo, {
      IconStyle: J(function (a, b, c) {
        ...
        if (e) {
          ...
          h && h[0] && h[1] !== e[1] && (d.hotSpot = { x: h[0], Xg: 'pixels', y: e[1] - h[1], Yg: 'pixels' });
        }
        d.Icon = g;
        e = b.a;
        1 !== e && (d.scale = e);
  ...
  function xp(a, b) {
    if (a) return jl(b[b.length - 1].node.namespaceURI, Wp[a.U()]);
  }
  var jq = wl('color'),
    Lp = wl('coordinates'),
    fq = wl('Data'),
  ...
  (function (a) {
    ...
    b.prototype = {
      ...
      Gg: function () {
        for (var a = this.Ka() + this.ea, b = this.lc, c = '', d = this.ea; d < a; ) {
          ...
          if (1 === p) 128 > e && (n = e);
            ...
            128 === (q & 192) &&
              128 === (r & 192) &&
              ((n = ((e & 15) << 12) | ((q & 63) << 6) | (r & 63)), 2047 >= n || (55296 <= n && 57343 >= n)) &&
              (n = null);
          } else if (4 === p) {
            q = b[d + 1];
            r = b[d + 2];
            ...
            128 === (q & 192) &&
              128 === (r & 192) &&
              128 === (u & 192) &&
              ((n = ((e & 15) << 18) | ((q & 63) << 12) | ((r & 63) << 6) | (u & 63)), 65535 >= n || 1114112 <= n) &&
              (n = null);
          }
          null === n
            ? ((n = 65533), (p = 1))
            : 65535 < n &&
              ((n -= 65536), (c += String.fromCharCode(((n >>> 10) & 1023) | 55296)), (n = 56320 | (n & 1023)));
      ...
      mq: function (a) {
        a &= 7;
        if (a === b.c) for (; 127 < this.lc[this.ea++]; );
        else if (a === b.b) this.ea = this.Ka() + this.ea;
        else if (a === b.a) this.ea += 4;
        else if (a === b.i) this.ea += 8;
  ...
  (function (a) {
    ...
    function e(a, b, c) {
      ...
      else 3 == a ? (b.type = c.Ka()) : 4 == a && (b.Ef = c.ea);
    }
    function f(a, b) {
      this.version = 1;
      this.name = null;
    ...
    function l(a, b, c) {
      3 === a && ((a = new m(c, c.Ka() + c.ea)), a.length && (b[a.name] = a));
    }
    c.prototype = {
      clone: function () {
    ...
    d.prototype.Oh = function () {
      ...
      for (var b = a.Ka() + a.ea, d = 1, e = 0, f = 0, g = 0, h = [], l; a.ea < b; )
        if ((e || ((e = a.Ka()), (d = e & 7), (e >>= 3)), e--, 1 === d || 2 === d))
          ((f += a.ce()), (g += a.ce()), 1 === d && (l && h.push(l), (l = [])), l.push(new c(f, g)));
    ...
    d.prototype.bbox = function () {
      ...
      a.ea = this.Ef;
      for (
        var b = a.Ka() + a.ea, c = 1, d = 0, e = 0, f = 0, g = Infinity, h = -Infinity, l = Infinity, m = -Infinity;
        a.ea < b;
      )
        if ((d || ((d = a.Ka()), (c = d & 7), (d >>= 3)), d--, 1 === c || 2 === c))
          ((e += a.ce()), (f += a.ce()), e < g && (g = e), e > h && (h = e), f < l && (l = f), f > m && (m = f));
  ...
  function lq(a) {
    El.call(this);
    a = a ? a : {};
    this.defaultDataProjection = new Bb({ code: '', units: 'tile-pixels' });
      ...
      if (!c || -1 != c.indexOf(f)) {
        ...
        for (var h = 0, l = g.length; h < l; ++h) {
          if (e === kq) {
            ...
            var x = n.type;
            1 === x
              ? (m = 1 === q.length ? 'Point' : 'MultiPoint')
              : 2 === x
                ? (m = 1 === q.length ? 'LineString' : 'MultiLineString')
                : 3 === x && (m = 'Polygon');
            q = n.properties;
            q[this.i] = p;
            ...
            if (0 === q) u = null;
              ...
              mq(x, E, B);
              1 === q
                ? (u = 1 === x.length ? new C(null) : new Q(null))
                : 2 === q
                  ? 1 === x.length
                    ? (u = new O(null))
                    : (u = new P(null))
  ...
  var pq = [null],
    ...
    sq = K(pq, {
      node: function (a, b) {
        ...
        d.Sh[e] = f;
        a = N({ fe: {} }, rq, a, b);
        wb(a.fe) || ((f = new C(f)), Hl(f, !1, c), (c = new H(f)), c.jc(e), c.H(a.fe), d.features.push(c));
      },
      way: function (a, b) {
        var c = b[0],
          d = a.getAttribute('id');
        a = N({ md: [], fe: {} }, qq, a, b);
        b = b[b.length - 1];
        for (var e = [], f = 0, g = a.md.length; f < g; f++) la(e, b.Sh[a.md[f]]);
        a.md[0] == a.md[a.md.length - 1]
          ? ((f = new D(null)), f.ba('XY', e, [e.length]))
          : ((f = new O(null)), f.ba('XY', e));
        Hl(f, !1, c);
        c = new H(f);
        c.jc(d);
        c.H(a.fe);
  ...
  nq.prototype.zc = function (a, b) {
    b = Fl(this, a, b);
    return 'osm' == a.localName && ((a = N({ Sh: {}, features: [] }, sq, a, [b])), a.features) ? a.features : [];
  };
  ...
  uq.prototype.read = function (a) {
    return ml(a) ? this.a(a) : nl(a) ? this.b(a) : 'string' === typeof a ? ((a = pl(a)), this.a(a)) : null;
  };
  function vq() {}
  v(vq, uq);
  ...
  var xq = [null, 'http://www.opengis.net/ows/1.1'],
    ...
    Fq = K(xq, { Voice: I(S), Facsimile: I(S) }),
    Jq = K(xq, {
      Constraint: tl(function (a, b) {
        var c = a.getAttribute('name');
        if (c) return N({ name: c }, Eq, a, b);
      })
    }),
    Lq = K(xq, {
      IndividualName: I(S),
    ...
    yq = K(xq, { Title: I(S), ServiceTypeVersion: I(S), ServiceType: I(S) }),
    zq = K(xq, {
      ProviderName: I(S),
      ProviderSite: I(tq),
  ...
  function Uq(a, b, c, d, e, f, g) {
    ...
    var h = [],
      l;
    var m = 0;
    for (l = a.length; m < l; ++m) h[m] = Vq(a[m], b, c, d, e, f, g);
    return h;
  }
  ...
  Sq.prototype.yg = function (a, b) {
    if ('Topology' == a.type) {
      ...
      var g = this.a,
        E;
      for (E in a)
        (this.b && -1 == this.b.indexOf(E)) ||
          ('GeometryCollection' === a[E].type
            ? ((l = a[E]), e.push.apply(e, Uq(l, f, c, d, g, E, b)))
            : ((l = a[E]), e.push(Vq(l, f, c, d, g, E, b))));
      return e;
    }
    return [];
  };
  ...
  var Wq = {
    ...
    Polygon: function (a, b) {
      var c = [],
        d;
      var e = 0;
      for (d = a.arcs.length; e < d; ++e) c[e] = Tq(a.arcs[e], b);
      return new D(c);
    },
    MultiPoint: function (a, b, c) {
      ...
      if (b && c) {
        var e = 0;
        for (d = a.length; e < d; ++e) Xq(a[e], b, c);
      }
      return new Q(a);
    },
    ...
    MultiPolygon: function (a, b) {
      ...
      for (e = a.arcs.length; f < e; ++f) {
        ...
        var h = [];
        var l = 0;
        for (d = g.length; l < d; ++l) h[l] = Tq(g[l], b);
        c[f] = h;
      }
      return new R(c);
    }
  ...
  Yq.prototype.j = function (a) {
    if (ml(a)) return $q(a);
    if (nl(a)) return N({}, ar, a, []);
    if ('string' === typeof a) return ((a = pl(a)), $q(a));
  };
  Yq.prototype.g = function (a) {
    if (ml(a)) return br(this, a);
    if (nl(a)) return cr(this, a);
    if ('string' === typeof a) return ((a = pl(a)), br(this, a));
  };
  function br(a, b) {
    for (b = b.firstChild; b; b = b.nextSibling) if (b.nodeType == Node.ELEMENT_NODE) return cr(a, b);
  }
  var dr = { 'http://www.opengis.net/gml': { boundedBy: I(Fm.prototype.gf, 'bounds') } };
  function cr(a, b) {
    var c = {},
  ...
  var er = { 'http://www.opengis.net/wfs': { totalInserted: I(Mm), totalUpdated: I(Mm), totalDeleted: I(Mm) } },
    fr = {
  ...
  function $q(a) {
    for (a = a.firstChild; a; a = a.nextSibling) if (a.nodeType == Node.ELEMENT_NODE) return N({}, ar, a, []);
  }
  var hr = { 'http://www.opengis.net/wfs': { PropertyName: J(Pm) } };
  function ir(a, b) {
    ...
    'http://www.opengis.net/wfs': {
        ...
        if (2 === e) {
          ...
          for (n in h) {
            ...
            null !== m &&
              ...
              l.push(m),
              n == g || m instanceof of
                ? n in e.lb[f] || (e.lb[f][n] = J(a.ai, a))
                : n in e.lb[f] || (e.lb[f][n] = J(Pm)));
          }
          var n = tb({}, e);
          n.node = d;
          Bl(n, e.lb, wl(void 0, f), l, c, b);
        } else Sm.prototype.ii(d, b, c);
      }),
      Update: J(function (a, b, c) {
        ...
        if (void 0 !== e) {
          ...
          Bl({ gmlVersion: d.gmlVersion, node: a, hasZ: d.hasZ, srsName: d.srsName }, kr, wl('Property'), g, c);
          ir(a, e);
        }
      }),
      ...
      Property: J(function (a, b, c) {
        ...
        void 0 !== b.value &&
          null !== b.value &&
          ((d = jl('http://www.opengis.net/wfs', 'Value')),
          a.appendChild(d),
          b.value instanceof of
            ? 2 === e
              ? an.prototype.ai(d, b.value, c)
              : Sm.prototype.od(d, b.value, c)
            : Pm(d, b.value));
      }),
  ...
  var mr = {
    'http://www.opengis.net/wfs': {
      Query: J(function (a, b, c) {
        ...
        if ((d = d.filter))
          ((g = jl('http://www.opengis.net/ogc', 'Filter')), a.appendChild(g), Bl({ node: g }, mr, wl(d.kc), [d], c));
      })
    },
    'http://www.opengis.net/ogc': {
  ...
  Yq.prototype.Eg = function (a) {
    for (a = a.firstChild; a; a = a.nextSibling) if (a.nodeType == Node.ELEMENT_NODE) return this.kf(a);
    return null;
  };
  ...
  function vr(a) {
    var b = [];
    a = a.Sd();
    for (var c = 0, d = a.length; c < d; ++c) b.push('(' + ur(a[c]) + ')');
    return b.join(',');
  }
  function wr(a) {
    var b = a.U(),
  ...
  var xr = {
    ...
    MultiPolygon: function (a) {
      var b = [];
      a = a.Td();
      for (var c = 0, d = a.length; c < d; ++c) b.push('(' + vr(a[c]) + ')');
      return b.join(',');
    },
    GeometryCollection: function (a) {
      var b = [];
      a = a.Vf();
      for (var c = 0, d = a.length; c < d; ++c) b.push(wr(a[c]));
      return b.join(',');
    }
  };
  k = sr.prototype;
  k.ae = function (a, b) {
    return (a = this.wd(a, b)) ? ((b = new H()), b.Ra(a), b) : null;
  };
  k.zg = function (a, b) {
    var c = [];
    a = this.wd(a, b);
    ...
    b = [];
    for (var d = 0, e = c.length; d < e; ++d) ((a = new H()), a.Ra(c[d]), b.push(a));
    return b;
  };
  k.wd = function (a, b) {
    a = new yr(new zr(a));
  ...
  k.Wg = function (a, b) {
    if (1 == a.length) return this.ge(a[0], b);
  ...
  k.tg = function () {
    if (Dr(this, 2)) {
      var a = Ir(this);
      if (Dr(this, 3)) return a;
    } else if (Er(this)) return null;
    throw Error(Fr(this));
  };
  k.sg = function () {
    if (Dr(this, 2)) {
  ...
  k.fp = function () {
    if (Dr(this, 2)) {
      var a;
      if (2 == this.b.type) for (a = [this.tg()]; Dr(this, 5); ) a.push(this.tg());
      else a = Jr(this);
      if (Dr(this, 3)) return a;
    } else if (Er(this)) return [];
    throw Error(Fr(this));
  ...
  k.gp = function () {
    if (Dr(this, 2)) {
      for (var a = [this.ug()]; Dr(this, 5); ) a.push(this.ug());
      if (Dr(this, 3)) return a;
    } else if (Er(this)) return [];
    throw Error(Fr(this));
  };
  ...
  function Jr(a) {
    for (var b = [Ir(a)]; Dr(a, 5); ) b.push(Ir(a));
    return b;
  }
  function Kr(a) {
    for (var b = [a.sg()]; Dr(a, 5); ) b.push(a.sg());
    return b;
  }
  function Er(a) {
  ...
  var Hr = { POINT: C, LINESTRING: O, POLYGON: D, MULTIPOINT: Q, MULTILINESTRING: P, MULTIPOLYGON: R },
    Gr = {
  ...
  Lr.prototype.b = function (a) {
    ...
    return (a = N({ version: this.version }, Mr, a, [])) ? a : null;
  };
  function Nr(a, b) {
    return N({}, Or, a, b);
  }
  ...
  function Rr(a, b) {
    if ((b = Nr(a, b))) return ((a = [Nm(a.getAttribute('width')), Nm(a.getAttribute('height'))]), (b.size = a), b);
  }
  function Sr(a, b) {
    return N([], Tr, a, b);
  }
  var Ur = [null, 'http://www.opengis.net/wms'],
    ...
    as = K(Ur, { ContactPerson: I(S), ContactOrganization: I(S) }),
    bs = K(Ur, { AddressType: I(S), Address: I(S), City: I(S), StateOrProvince: I(S), PostCode: I(S), Country: I(S) }),
    Yr = K(Ur, { Format: rl(S) }),
    Zr = K(Ur, {
      Name: I(S),
      Title: I(S),
      ...
      BoundingBox: tl(function (a) {
        var b = [
            Lm(a.getAttribute('minx')),
            Lm(a.getAttribute('miny')),
            Lm(a.getAttribute('maxx')),
            Lm(a.getAttribute('maxy'))
          ],
      ...
      AuthorityURL: tl(function (a, b) {
        if ((b = Nr(a, b))) return ((b.name = a.getAttribute('name')), b);
      }),
      Identifier: tl(S),
      MetadataURL: tl(function (a, b) {
        if ((b = Nr(a, b))) return ((b.type = a.getAttribute('type')), b);
      }),
      DataURL: tl(Nr),
    ...
    ds = K(Ur, { Title: I(S), OnlineResource: I(tq), LogoURL: I(Rr) }),
    cs = K(Ur, {
    ...
    Xr = K(Ur, { GetCapabilities: I(Pr), GetMap: I(Pr), GetFeatureInfo: I(Pr) }),
    Qr = K(Ur, {
      Format: tl(S),
    ...
    gs = K(Ur, { Get: I(Nr), Post: I(Nr) }),
    es = K(Ur, { Name: I(S), Title: I(S), Abstract: I(S), LegendURL: tl(Rr), StyleSheetURL: I(Nr), StyleURL: I(Nr) }),
    Or = K(Ur, { Format: I(S), OnlineResource: I(tq) }),
    Tr = K(Ur, { Keyword: rl(S) });
  function hs(a) {
    a = a ? a : {};
  ...
  var ls = [null, 'http://www.opengis.net/wmts/1.0'],
    ...
    os = K(
      ...
      {
        Style: tl(function (a, b) {
          if ((b = N({}, qs, a, b))) return ((a = 'true' === a.getAttribute('isDefault')), (b.isDefault = a), b);
        }),
        Format: tl(S),
    ...
    vs = K(ls, { TileMatrix: I(S), MinTileRow: I(Mm), MaxTileRow: I(Mm), MinTileCol: I(Mm), MaxTileCol: I(Mm) }),
    ss = K(ls, { Default: I(S), Value: tl(S) }, K(ms, { Identifier: I(S) })),
    ts = K(ms, { LowerCorner: rl(ks), UpperCorner: rl(ks) }),
    ps = K(
      ls,
      {
      ...
      K(ms, { SupportedCRS: I(S), Identifier: I(S) })
    ),
    ws = K(
      ls,
      {
  ...
  k.Am = function () {
    var a = this.Uh();
    a && ((this.f = Vb(Tb('EPSG:4326'), a)), this.a && this.set('position', this.f(this.a)));
  };
  k.Bm = function () {
    if (Wd) {
      var a = this.Vh();
      a && void 0 === this.c
        ? (this.c = navigator.geolocation.watchPosition(this.np.bind(this), this.op.bind(this), this.Gh()))
  ...
  k.Kb = function (a, b, c, d) {
    ...
    if (b < d) {
      if (b)
        for (d = this.pd() / Math.sqrt(b), c[0] = e[0] + d * a, c[1] = e[1] + d * f, d = 2; d < this.a; ++d)
          c[d] = e[d];
  ...
  k.Xa = function (a) {
    var b = this.G();
    return qb(a, b)
      ? ((b = this.wa()), (a[0] <= b[0] && a[2] >= b[0]) || (a[1] <= b[1] && a[3] >= b[1]) ? !0 : db(a, this.sb, this))
      : !1;
  };
  k.ob = function (a) {
    var b = this.a,
  ...
  function As(a, b, c) {
    for (
      ...
      ((x = n.pop()),
        ...
        (r = a(E)),
        (u = b(r)),
        Fa(u[0], u[1], g[0], g[1], h[0], h[1]) < c
          ? (d.push(h[0], h[1]), (f = B.toString()), (p[f] = !0))
          : (n.push(B, E, E, x), m.push(h, u, u, g), l.push(f, r, r, e)));
    return d;
  }
  ...
  function Ds(a) {
    ...
    1 == a.showLabels &&
      ((this.na = a.lonLabelFormatter ? a.lonLabelFormatter : bf.bind(this, 'EW')),
      ...
      (this.B =
        void 0 !== a.lonLabelStyle
          ...
          : new fo({
              ...
              textBaseline: 'bottom',
              fill: new al({ color: 'rgba(0,0,0,1)' }),
              stroke: new wj({ color: 'rgba(255,255,255,1)', width: 3 })
            })),
      (this.C =
  ...
  var Es = new wj({ color: 'rgba(0,0,0,0.2)' }),
    Fs = [90, 45, 30, 20, 10, 5, 2, 1, 0.5, 0.2, 0.1, 0.05, 0.01, 0.005, 0.002, 0.001];
  ...
  k.Kh = function (a) {
    ...
    f.i &&
      ((f = f.G()), (h = lb(f)), (c = c.focus[0]), c < f[0] || c > f[2]) &&
      ((c = h * Math.ceil((f[0] - c) / h)), (d = [d[0] + c, d[1], d[2] + c, d[3]]));
    c = this.S[0];
    f = this.S[1];
    h = -1;
    ...
    g = h;
    if (-1 == g) ((this.i.length = this.c.length = 0), this.b && (this.b.length = 0), this.a && (this.a.length = 0));
    else {
      c = this.D(e);
      e = c[0];
      c = c[1];
      ...
      for (h = 0; p != this.g && h++ < f; ) ((p = Math.max(p - g, this.g)), (l = Gs(this, p, q, m, a, d, l)));
      p = Ca(e, this.g, this.f);
      for (h = 0; p != this.f && h++ < f; ) ((p = Math.min(p + g, this.f)), (l = Gs(this, p, q, m, a, d, l)));
      this.i.length = l;
      this.b && (this.b.length = l);
      c = Math.floor(c / g) * g;
      e = Ca(c, this.l, this.o);
      l = Hs(this, e, a, d, 0);
      for (h = 0; e != this.l && h++ < f; ) ((e = Math.max(e - g, this.l)), (l = Hs(this, e, a, d, l)));
      e = Ca(c, this.l, this.o);
      for (h = 0; e != this.o && h++ < f; ) ((e = Math.min(e + g, this.o)), (l = Hs(this, e, a, d, l)));
      this.c.length = l;
      this.a && (this.a.length = l);
    }
    b.Ma(null, this.pa);
    a = 0;
    for (e = this.i.length; a < e; ++a) ((g = this.i[a]), b.zb(g));
    a = 0;
    for (e = this.c.length; a < e; ++a) ((g = this.c[a]), b.zb(g));
    if (this.b)
      for (a = 0, e = this.b.length; a < e; ++a) ((g = this.b[a]), this.B.xd(g.text), b.Cb(this.B), b.zb(g.Qd));
    if (this.a)
      for (a = 0, e = this.a.length; a < e; ++a) ((g = this.a[a]), this.C.xd(g.text), b.Cb(this.C), b.zb(g.Qd));
  };
  k.setMap = function (a) {
    this.v && (this.v.K('postcompose', this.Kh, this), this.v.render());
    a && (a.J('postcompose', this.Kh, this), a.render());
    this.v = a;
  };
  ...
  function Ys(a) {
    a = a ? a : {};
    Dg.call(this, { handleDownEvent: Zs, handleDragEvent: $s, handleUpEvent: at });
  ...
  function $s(a) {
    if (Bg(a)) {
      ...
      a = Math.sqrt(a * a + d * d);
      b = b.Z();
      b.g.rotation !== Te && void 0 !== this.g && ((d = c - this.g), og(b, b.Qa() - d));
      this.g = c;
  ...
  function Zs(a) {
    return Bg(a) && this.l(a) ? (cg(a.map.Z(), 1, 1), (this.a = this.g = void 0), !0) : !1;
  }
  function bt(a, b, c, d) {
    this.fb = a;
    this.Ua = b;
  ...
  function et(a, b, c, d, e, f, g, h, l) {
    if (a.B && pa(d, a.T)) var m = a.B;
    else (a.B || (a.B = []), (m = pf(a.coordinates, 0, a.coordinates.length, 2, d, a.B)), Fh(a.T, d));
    d = !wb(f);
    for (
      var n = 0,
        p = g.length,
      ...
      switch (z[0]) {
        ...
        case 4:
          ...
          for (bc && (A += e); q < r; q += 2) {
            z = m[q] - ba;
            bc = m[q + 1] - da;
            Je && ((z = Math.round(z)), (bc = Math.round(bc)));
            if (1 != L || A) {
              var ff = z + ba,
                rh = bc + da;
        ...
        case 5:
          ...
          for ((bc = z[10]) && (A += e); q < r; q += 2) {
            z = m[q] + fb;
            bc = m[q + 1] + ca;
            if (1 != L || A) (Kh(u, z, bc, L, L, A, -z, -bc), b.setTransform.apply(b, u));
            Ub = da.split('\n');
            uc = Ub.length;
            1 < uc ? ((Je = Math.round(1.5 * b.measureText('M').width)), (bc -= ((uc - 1) / 2) * Je)) : (Je = 0);
            for (zg = 0; zg < uc; zg++)
              ((ff = Ub[zg]), ba && b.strokeText(ff, z, bc), M && b.fillText(ff, z, bc), (bc += Je));
            (1 != L || A) && b.setTransform.apply(b, x);
          }
          ++n;
          break;
        case 6:
          if (h && ((q = z[1]), (q = h(q)))) return q;
          ++n;
          break;
        case 7:
          ga ? oa++ : a.Va(b, e);
        ...
        case 8:
          ...
          A = (z + 0.5) | 0;
          L = (bc + 0.5) | 0;
          if (A !== B || L !== E) (b.moveTo(z, bc), (B = A), (E = L));
          for (q += 2; q < r; q += 2)
            if (
              ((z = m[q]), (bc = m[q + 1]), (A = (z + 0.5) | 0), (L = (bc + 0.5) | 0), q == r - 2 || A !== B || L !== E)
            )
              (b.lineTo(z, bc), (B = A), (E = L));
          ++n;
          break;
        case 9:
          a.R = z[2];
          oa && (a.Va(b, e), (oa = 0), ha && (b.stroke(), (ha = 0)));
          b.fillStyle = z[1];
          ++n;
          break;
        case 10:
  ...
  k = it.prototype;
  k.Sf = function () {
    this.f || ((this.f = Ra(this.Ua)), 0 < this.c && Qa(this.f, (this.resolution * (this.c + 1)) / 2, this.f));
    return this.f;
  };
  function kt(a) {
    var b = a.i,
      ...
      h = b.lineWidth,
      l = b.miterLimit;
    (b.Md == c && b.Gd == d && pa(b.Hd, e) && b.Id == f && b.Jd == g && b.Kd == h && b.Ld == l) ||
      (b.eg != a.coordinates.length && (a.a.push([12]), (b.eg = a.coordinates.length)),
  ...
  k.mc = function (a, b) {
    ...
    void 0 !== c.strokeStyle &&
      ...
      dt(this, b),
      this.b.push(
        [10, c.strokeStyle, c.lineWidth, c.lineCap, c.lineJoin, c.miterLimit, c.lineDash, c.lineDashOffset, !0, 1],
        [1]
      ),
      (c = a.ga()),
  ...
  k.Ma = function (a, b) {
    ...
    this.i.lineWidth > this.c && ((this.c = this.i.lineWidth), (this.f = null));
  };
  function lt(a, b, c, d) {
    bt.call(this, a, b, c, d);
    this.f = null;
  ...
  k.pc = function (a, b) {
    ...
    if (void 0 !== c.fillStyle || void 0 !== d) {
      ...
      var e = 0,
        f;
      var g = 0;
      for (f = c.length; g < f; ++g) e = mt(this, d, e, c[g], a);
      gt(this, b);
    }
  };
  k.Te = function () {
  ...
  k.Ma = function (a, b) {
    var c = this.i;
    a ? ((a = a.b), (c.fillStyle = id(a ? a : Sh))) : (c.fillStyle = void 0);
    b
      ? ((a = b.a),
        ...
        c.lineWidth > this.c && ((this.c = c.lineWidth), (this.f = null)))
  ...
  function nt(a, b) {
    ...
    void 0 === e ||
      (c.Md == e && c.Gd == f && pa(c.Hd, g) && c.Id == h && c.Jd == l && c.Kd == m && c.Ld == n) ||
      (a.a.push([10, e, m, f, l, n, g, h, !0, 1]),
      (c.Md = e),
      (c.Gd = f),
      (c.Hd = g),
      (c.Id = h),
    ...
    if ('' !== this.Ia && this.g && (this.i || this.f)) {
      if (this.i) {
        ...
        if (!g || g.fillStyle != e.fillStyle) {
          ...
          this.a.push(h);
          this.b.push(h);
          g ? (g.fillStyle = e.fillStyle) : (this.S = { fillStyle: e.fillStyle });
        }
      }
      this.f &&
        ((e = this.f),
      ...
      e = this.g;
      g = this.C;
      (g && g.font == e.font && g.textAlign == e.textAlign && g.textBaseline == e.textBaseline) ||
        ((h = [11, e.font, e.textAlign, e.textBaseline]),
        this.a.push(h),
        this.b.push(h),
        g
          ? ((g.font = e.font), (g.textAlign = e.textAlign), (g.textBaseline = e.textBaseline))
          : (this.C = { font: e.font, textAlign: e.textAlign, textBaseline: e.textBaseline }));
      dt(this, f);
  ...
  ot.prototype.Cb = function (a) {
    if (a) {
      var b = a.Fa();
      b
        ? ((b = b.b), (b = id(b ? b : Sh)), this.i ? (this.i.fillStyle = b) : (this.i = { fillStyle: b }))
        : (this.i = null);
      var c = a.Ga();
      if (c) {
        var b = c.a,
      ...
      l = void 0 !== l ? l : 'middle';
      this.g
        ? ((m = this.g), (m.font = a), (m.textAlign = g), (m.textBaseline = l))
        : (this.g = { font: a, textAlign: g, textBaseline: l });
      this.Ia = void 0 !== f ? f : '';
      this.j = void 0 !== b ? b : 0;
      this.o = void 0 !== d ? d : 0;
      this.l = void 0 !== e ? e : !1;
  ...
  pt.prototype.Ea = function (a, b, c, d, e, f) {
    d = Math.round(d);
    var g = 2 * d + 1,
      h = Kh(this.j, d + 0.5, d + 0.5, 1 / b, -1 / b, -c, -a[0], -a[1]),
      l = this.g;
  ...
  pt.prototype.b = function (a, b) {
    ...
    void 0 === a && ((a = {}), (this.a[c] = a));
    c = a[b];
    void 0 === c && ((c = new wt[b](this.v, this.c, this.l, this.o)), (a[b] = c));
    return c;
  };
  ...
  function ut(a, b, c, d, e, f, g) {
    ...
    for (l = h.length; n < l; ++n) {
      ...
      for (m = ji.length - 1; 0 <= m; --m) {
        var q = p[ji[m]];
        if (void 0 !== q && (q = et(q, b, 1, c, d, e, q.b, f, g))) return q;
      }
    }
  }
  var wt = { Circle: lt, Image: ht, LineString: it, Polygon: lt, Text: ot };
  function xt(a) {
    Sc.call(this);
    this.a = a;
  }
  ...
  function Dt(a, b) {
    ...
    void 0 !== b &&
      ('string' === typeof b
        ? (a.logos[b] = '')
        : b && (xa('string' == typeof b.href, 44), xa('string' == typeof b.src, 45), (a.logos[b.src] = b.href)));
  }
  function Et(a, b, c, d) {
    b = w(b).toString();
    c = c.toString();
      ...
      for (r = B.ca; r <= B.$; ++r)
        for (u = B.da; u <= B.ia; ++u)
          if (g - x <= h) {
            ...
            0 == A.getState() && ((p[A.bb()] = !0), A.bb() in a.a || a.f([A, n, tc(c, A.ta), E]));
            l && l.call(m, A);
          } else b.Ug(x, r, u, e);
    }
  }
  ...
  Gt.prototype.u = function (a, b, c, d) {
    if (this.Ea(a, b, 0, mf, this)) return c.call(d, this.a, null);
  };
  ...
  function Mt(a, b, c, d, e, f) {
    ...
    if ((h = c.Y())) {
      var l = h.Ye();
      2 == l || 3 == l ? h.Bj(e, f) : (0 == l && h.load(), h.Nh(e, f), (g = !0));
    }
    if ((e = (0, c.Za)(b))) ((d = e.Vd(d)), (0, Nt[d.U()])(a, d, c, b));
    return g;
  }
  var Nt = {
    Point: function (a, b, c, d) {
      ...
      if ((e = c.Na())) ((a = a.b(c.Ba(), 'Text')), a.Cb(e), a.yc(b.ga(), 0, 2, 2, b, d));
    },
    LineString: function (a, b, c, d) {
      ...
      if ((e = c.Na())) ((a = a.b(c.Ba(), 'Text')), a.Cb(e), a.yc(di(b), 0, 2, 2, b, d));
    },
    Polygon: function (a, b, c, d) {
      ...
      if ((e = c.Na())) ((a = a.b(c.Ba(), 'Text')), a.Cb(e), a.yc(Wf(b), 0, 2, 2, b, d));
    },
    MultiPoint: function (a, b, c, d) {
      ...
      if ((e = c.Na())) ((a = a.b(c.Ba(), 'Text')), a.Cb(e), (c = b.ga()), a.yc(c, 0, c.length, b.qa(), b, d));
    },
    MultiLineString: function (a, b, c, d) {
      ...
      if ((e = c.Na())) ((a = a.b(c.Ba(), 'Text')), a.Cb(e), (c = ei(b)), a.yc(c, 0, c.length, 2, b, d));
    },
    MultiPolygon: function (a, b, c, d) {
      ...
      if ((e = c.Na())) ((a = a.b(c.Ba(), 'Text')), a.Cb(e), (c = gi(b)), a.yc(c, 0, c.length, 2, b, d));
    },
    GeometryCollection: function (a, b, c, d) {
      b = b.a;
      var e;
      var f = 0;
      for (e = b.length; f < e; ++f) (0, Nt[b[f].U()])(a, b[f], c, d);
    },
    Circle: function (a, b, c, d) {
      ...
      if ((e = c.Na())) ((a = a.b(c.Ba(), 'Text')), a.Cb(e), a.yc(b.wa(), 0, 2, 2, b, d));
    }
  };
  function Ot(a) {
    Gt.call(this, a);
    ...
    if ((p = this.f) && !p.i()) {
      ...
      if (m.u && h.i && !Va(l, d)) {
        for (var h = d[0], m = lb(l), L = 0; h < l[0]; )
          (--L, (n = m * L), (n = Jt(this, a, n)), p.La(x, e, n, g, f), (h += m));
        L = 0;
        for (h = d[2]; h > l[2]; ) (++L, (n = m * L), (n = Jt(this, a, n)), p.La(x, e, n, g, f), (h -= m));
        n = Jt(this, a, 0);
      }
      Vh(x, g, E / 2, A / 2);
      x != c && (It(this, 'render', x, a, n), c.drawImage(x.canvas, -r, -u), x.translate(-r, -u));
      x.globalAlpha = B;
    }
    q && c.restore();
    this.ef(c, a, b, n);
  ...
  Ot.prototype.sd = function (a) {
    function b(a) {
      var b = a.Lc();
      if (b) var d = b.call(a, m);
      else (b = c.f) && (d = b(a, m));
      if (d) {
        if (d) {
          b = !1;
          if (Array.isArray(d))
            for (var e = 0, f = d.length; e < f; ++e) b = Mt(q, a, d[e], Lt(m, n), this.D, this) || b;
          else b = Mt(q, a, d, Lt(m, n), this.D, this) || b;
          a = b;
        } else a = !1;
        this.c = this.c || a;
      }
    ...
    d.u &&
      h.projection.i &&
      !Va(p, a.extent) &&
      ((a = Math.max(lb(l) / 2, lb(p))), (l[0] = p[0] - a), (l[2] = p[2] + a));
    if (!this.c && this.l == m && this.v == f && this.o == g && Va(this.j, l)) return !0;
    this.f = null;
    this.c = !1;
    var q = new pt((0.5 * m) / n, l, m, d.T, c.c);
    d.Yd(l, m, e);
    if (g) {
      var r = [];
      d.$b(
  ...
  k.lg = function (a, b, c, d) {
    a = Gh(b.pixelToCoordinateTransform, a.slice());
    if (this.Ue(a, b)) return c.call(d, this.a, null);
  };
  k.Hi = function () {
    zt(this);
  };
  k.ng = function (a, b, c) {
    function d(a) {
      ...
      if (c) {
        if (c) {
          b = !1;
          if (Array.isArray(c))
            for (var d = c.length - 1; 0 <= d; --d) b = Mt(q, a, c[d], Lt(m, n), this.Hi, this) || b;
          else b = Mt(q, a, c, Lt(m, n), this.Hi, this) || b;
          a = b;
        } else a = !1;
        this.l = this.l || a;
      }
    ...
    void 0 === l && (l = Kt);
    g = Qa(g, p * m);
    if (!this.l && this.I == m && this.R == h && this.B == l && Va(this.D, g)) return !0;
    this.f && a.postRenderFunctions.push(ek(this.f, c));
    this.l = !1;
    var q = new dk((0.5 * m) / n, g, e.c);
    b.Yd(g, m, f);
    if (l) {
      var r = [];
      b.$b(
  ...
  v($t, Tc);
  function au(a) {
    if ('string' === typeof a) return [new Ac({ html: a })];
    if (a instanceof Ac) return [a];
    if (Array.isArray(a)) {
      for (var b = a.length, c = Array(b), d = 0; d < b; d++) {
        var e = a[d];
        c[d] = 'string' === typeof e ? new Ac({ html: e }) : e;
      }
      return c;
    }
    return null;
  ...
  function U(a) {
    ...
    this.I = a.url;
    a.loader ? (this.B = a.loader) : void 0 !== this.I && (xa(this.C, 7), (this.B = Dl(this.I, this.C)));
  ...
  k.yb = function (a) {
    ...
    if (eu(this, b, a)) {
      fu(this, b, a);
      var c = a.V();
      c ? ((b = c.G()), this.a && this.a.Ca(b, a)) : (this.g[b] = a);
  ...
  function eu(a, b, c) {
    var d = !0,
      e = c.a;
    void 0 !== e ? (e.toString() in a.o ? (d = !1) : (a.o[e.toString()] = c)) : (xa(!(b in a.l), 30), (a.l[b] = c));
    return d;
  }
  k.cd = function (a) {
    cu(this, a);
  ...
  function cu(a, b) {
    ...
    for (c = e.length; g < c; g++)
      ((h = e[g]),
        (l = w(h).toString()),
        fu(a, l, h),
        (b = h.V()) ? ((l = b.G()), d.push(l), f.push(h)) : (a.g[l] = h));
    a.a && a.a.load(d, f);
    g = 0;
    for (c = e.length; g < c; g++) a.b(new gu('addfeature', e[g]));
  }
  function du(a, b) {
    var c = !1;
  ...
  k.clear = function (a) {
    if (a) {
      for (var b in this.v) this.v[b].forEach(Ec);
      this.f || ((this.v = {}), (this.o = {}), (this.l = {}));
    } else if (this.a) {
      this.a.forEach(this.Ig, this);
      for (var c in this.g) this.Ig(this.g[c]);
    }
    this.f && this.f.clear();
    this.a && this.a.clear();
    this.R.clear();
  ...
  k.sh = function (a, b) {
    ...
    if (this.f) return this.f.forEach(a, b);
  };
  function hu(a, b, c) {
    a.$b([b[0], b[1], b[0], b[1]], function (a) {
      if (a.V().sb(b)) return c.call(void 0, a);
    });
  }
  k.$b = function (a, b, c) {
    if (this.a) return Lj(this.a, a, b, c);
    if (this.f) return this.f.forEach(b, c);
  };
  k.th = function (a, b, c) {
    return this.$b(a, function (d) {
      if (d.V().Xa(a) && (d = b.call(c, d))) return d;
    });
  };
  k.Ah = function () {
    return this.f;
  ...
  k.Xe = function () {
    if (this.f) var a = this.f.a;
    else this.a && ((a = Ij(this.a)), wb(this.g) || la(a, vb(this.g)));
    return a;
  };
  k.zh = function (a) {
    var b = [];
  ...
  k.Oi = function (a) {
    ...
    var b = w(a).toString(),
      c = a.V();
    c
      ? ((c = c.G()), b in this.g ? (delete this.g[b], this.a && this.a.Ca(c, a)) : this.a && Hj(this.a, c, a))
      : b in this.g || (this.a && this.a.remove(a), (this.g[b] = a));
    c = a.a;
    void 0 !== c
      ? ((c = c.toString()),
        b in this.l ? (delete this.l[b], (this.o[c] = a)) : this.o[c] !== a && (iu(this, a), (this.o[c] = a)))
      : b in this.l || (iu(this, a), (this.l[b] = a));
    this.s();
  ...
  k.Yd = function (a, b, c) {
    ...
    for (e = a.length; f < e; ++f) {
      ...
      }) || (this.B.call(this, g, b, c), d.Ca(g, { extent: g.slice() }));
    }
  };
  k.Gb = function (a) {
    var b = w(a).toString();
  ...
  v(gu, Oc);
  function ju(a) {
    Dg.call(this, { handleDownEvent: ku, handleEvent: lu, handleUpEvent: mu });
    this.T = !1;
    this.fa = null;
    this.u = !1;
  ...
  function ku(a) {
    this.T = !this.u;
    return this.u ? ((this.fa = a.pixel), this.l || uu(this, a), !0) : this.vk(a) ? ((this.fa = a.pixel), !0) : !1;
  }
  function mu(a) {
    var b = !0;
    tu(this, a);
      ...
      ? (this.l
          ? this.u || c
            ...
            : wu(this, a)
              ? this.Cf(a) && this.Pd()
              : su(this, a)
          : (uu(this, a), this.g === pu && this.Pd()),
        (b = !1))
      : this.u && ((this.l = null), xu(this));
    return b;
  }
  function tu(a, b) {
    ...
    a.l
      ? ((e = b.coordinate),
        ...
        a.g === pu
          ? (d = a.a)
          : a.g === ou
            ? ((d = a.a[0]), (d = d[d.length - 1]), wu(a, b) && (e = a.l.slice()))
            : ((d = a.a), (d = d[d.length - 1])),
        (d[0] = e[0]),
        (d[1] = e[1]),
        a.Za(a.a, c),
        a.B && a.B.V().ma(e),
        c instanceof D && a.g !== ou
          ? (a.C || (a.C = new H(new O(null))), (e = c.Ch(0)), (b = a.C.V()), b.ba(e.ja, e.ga()))
          : a.I && ((b = a.C.V()), b.ma(a.I)),
        yu(a))
      : ((b = b.coordinate.slice()), a.B ? a.B.V().ma(b) : ((a.B = new H(new C(b))), yu(a)));
    return !0;
  }
  function wu(a, b) {
    var c = !1;
    if (a.j) {
      ...
      a.g === qu
        ? (d = a.a.length > a.Sa)
        : a.g === ou && ((d = a.a[0].length > a.Sa), (e = [a.a[0][0], a.a[0][a.a[0].length - 2]]));
      if (d)
  ...
  function uu(a, b) {
    ...
    a.g === pu
      ? (a.a = b.slice())
      : a.g === ou
        ? ((a.a = [[b.slice(), b.slice()]]), (a.I = a.a[0]))
        : ((a.a = [b.slice(), b.slice()]), a.g === vu && (a.I = a.a));
  ...
  k.Pd = function () {
    var a = xu(this),
      b = this.a,
      c = a.V();
    this.g === qu ? (b.pop(), this.Za(b, c)) : this.g === ou && (b[0].pop(), this.Za(b, c), (b = c.X()));
    'MultiPoint' === this.R
      ? a.Ra(new Q([b]))
      : 'MultiLineString' === this.R
        ? a.Ra(new P([b]))
        : 'MultiPolygon' === this.R && a.Ra(new R([b]));
  ...
  function xu(a) {
    a.l = null;
    var b = a.j;
    b && ((a.j = null), (a.B = null), (a.C = null), a.pa.ha().clear(!0));
    return b;
  }
  k.vn = function (a) {
    var b = a.V();
  ...
  function Au(a) {
    ...
    Dg.call(this, { handleDownEvent: Bu, handleDragEvent: Cu, handleEvent: Du, handleUpEvent: Eu });
    this.u = new T({
    ...
    (a = Hu(this, c, d)) && e
      ? ((c = a[0] == e[0] || a[0] == e[2] ? a[0] : null),
        ...
        null !== c && null !== d
          ? (this.a = Ju(b(a)))
          : null !== c
            ? (this.a = Ku(b([c, e[1]]), b([c, e[3]])))
            : null !== d && (this.a = Ku(b([e[0], d]), b([e[2], d]))))
      : ((a = d.Wa(c)), this.g([a[0], a[1], a[0], a[1]]), (this.a = Ju(a)));
    return !0;
  }
  function Cu(a) {
    this.a && ((a = a.coordinate), this.g(this.a(a)), Iu(this, a));
    return !0;
  }
  function Eu() {
    this.a = null;
  ...
  function Iu(a, b) {
    var c = a.B;
    c ? c.V().ma(b) : ((c = new H(new C(b))), (a.B = c), a.I.ha().yb(c));
  }
  ...
  Au.prototype.g = function (a) {
    this.j = a ? a : null;
    var b = this.l;
    b ? (a ? b.Ra(Yf(a)) : b.Ra(void 0)) : ((this.l = b = a ? new H(Yf(a)) : new H({})), this.u.ha().yb(b));
  ...
  function Nu(a) {
    Dg.call(this, { handleDownEvent: Ou, handleDragEvent: Pu, handleEvent: Qu, handleUpEvent: Ru });
  ...
  function Uu(a, b) {
    a.C || ((a.C = !0), a.b(new Vu('modifystart', a.u, b)));
  }
  function Wu(a, b) {
    Xu(a, b);
    a.g && !a.u.dc() && (a.B.ha().Gb(a.g), (a.g = null));
    Kc(b, 'change', a.si, a);
  }
  function Xu(a, b) {
    a = a.a;
  ...
  k.Ha = function (a) {
    this.g && !a && (this.B.ha().Gb(this.g), (this.g = null));
  ...
  k.si = function (a) {
    this.l || ((a = a.target), Wu(this, a), this.kg(a));
  };
  k.xn = function (a) {
    Wu(this, a.element);
  };
  ...
  k.yn = function (a, b) {
    var c = b.wa(),
      d = { feature: a, geometry: b, index: 0, la: [c, c] };
  ...
  k.zn = function (a, b) {
    var c = b.a;
    for (b = 0; b < c.length; ++b) this.T[c[b].U()].call(this, a, c[b]);
  };
  function Yu(a, b) {
    var c = a.g;
    c ? c.V().ma(b) : ((c = new H(new C(b))), (a.g = c), a.B.ha().yb(c));
  }
  function Zu(a, b) {
    return a.index - b.index;
  }
  function Ou(a) {
    if (!this.ad(a)) return !1;
    ...
    if (c) {
      ...
      for (var g = 0, h = e.length; g < h; ++g) {
        ...
        if ('Circle' === l.geometry.U() && 1 === l.index)
          ((m = $u(b, l)), df(m, c) && !f[n][0] && (this.j.push([l, 0]), (f[n][0] = l)));
        else if (df(m[0], c) && !f[n][0]) (this.j.push([l, 0]), (f[n][0] = l));
        else if (df(m[1], c) && !f[n][1]) {
          if (
            ('LineString' !== l.geometry.U() && 'MultiLineString' !== l.geometry.U()) ||
            !f[n][0] ||
            0 !== f[n][0].index
          )
      ...
      d.length && Uu(this, a);
      for (a = d.length - 1; 0 <= a; --a) this.bm.apply(this, d[a]);
    }
    return !!this.g;
  }
  function Pu(a) {
    ...
    for (var b = 0, c = this.j.length; b < c; ++b) {
      ...
      switch (g.U()) {
        ...
        case 'Circle':
          ((l[0] = l[1] = a),
            0 === e.index ? ((this.l = !0), g.ob(a)) : ((this.l = !0), g.Uc(jf(g.wa(), a))),
            (this.l = !1));
      }
  ...
  function Ru(a) {
    for (var b, c, d = this.j.length - 1; 0 <= d; --d)
      if (((b = this.j[d][0]), (c = b.geometry), 'Circle' === c.U())) {
        var e = c.wa(),
          f = b.Pf[0];
        b = b.Pf[1];
        f.la[0] = f.la[1] = e;
        ...
        Hj(this.a, Za(e), f);
        Hj(this.a, c.G(), b);
      } else Hj(this.a, Na(b.la), b);
    this.C && (this.b(new Vu('modifyend', this.u, a)), (this.C = !1));
    return !1;
  }
  function Qu(a) {
    if (!(a instanceof ee)) return !0;
    this.R = a;
    var b;
    dg(a.map.Z())[1] || 'pointermove' != a.type || this.D || ((this.va = a.pixel), Tu(this, a.pixel, a.map));
  ...
  function Tu(a, b, c) {
    ...
    if (0 < f.length) {
      ...
      if (n <= a.fa) {
        b = {};
        if ('Circle' === g.geometry.U() && 1 === g.index) ((a.pa = !0), Yu(a, l));
        else
          for (
            n = c.Ja(h[0]),
              g = c.Ja(h[1]),
            ...
            if (((l = f[m].la), (df(h[0], l[0]) && df(h[1], l[1])) || (df(h[0], l[1]) && df(h[1], l[0])))) b[w(l)] = !0;
            else break;
        b[w(h)] = !0;
        a.Sa = b;
        return;
  ...
  function av(a, b) {
    var c = b.geometry;
    return 'Circle' === c.U() && 1 === b.index
      ? ((a = hf(c.wa(), a)), (c = Math.sqrt(a) - c.pd()), c * c)
      : kf(a, b.la);
  }
  function $u(a, b) {
    var c = b.geometry;
  ...
  k.bm = function (a, b) {
    for (var c = a.la, d = a.feature, e = a.geometry, f = a.depth, g = a.index, h; b.length < e.qa(); ) b.push(0);
    switch (e.U()) {
      case 'MultiLineString':
        h = e.X();
    ...
    if (this.R && 'pointerdrag' != this.R.type) {
      ...
      for (h in c) {
        ...
        q &&
          ...
          (this.l = !1),
          (d = []),
          void 0 !== m && (this.a.remove(m), d.push(m.la[0])),
          void 0 !== l && (this.a.remove(l), d.push(l.la[1])),
          void 0 !== m &&
            void 0 !== l &&
            ((m = { depth: g.depth, feature: g.feature, geometry: g.geometry, index: n, la: d }),
            this.a.Ca(Na(m.la), m)),
          bv(this, f, e, g.depth, -1),
          this.g && (this.B.ha().Gb(this.g), (this.g = null)),
          (b.length = 0));
      }
  ...
  function dv(a) {
    ...
    if (e) {
      ...
      f.we(
        a.pixel,
        function (a, b) {
          if (this.o(a, b)) return (l.push(a), (a = w(a)), (this.a[a] = b), !this.l);
        }.bind(this),
      ...
      f.we(
        ...
        function (a, e) {
          if (this.o(a, e))
            return (
              (!b && !d) || ja(g.a, a)
                ? (c || d) && ja(g.a, a) && (h.push(a), (e = w(a)), delete this.a[e])
                : (l.push(a), (a = w(a)), (this.a[a] = e)),
              !this.l
            );
        }.bind(this),
        { layerFilter: this.u, hitTolerance: this.j }
  ...
  var gv = 'select';
  function hv(a) {
    Dg.call(this, { handleEvent: iv, handleDownEvent: mf, handleUpEvent: jv });
    a = a ? a : {};
  ...
  k.yb = function (a, b) {
    ...
    if (d) {
      var e = this.fa[d.U()];
      e && ((this.T[c] = d.G(Oa())), e.call(this, a, d));
    }
  ...
  k.ui = function (a) {
    if (a instanceof gu) var b = a.feature;
    else a instanceof bd && (b = a.element);
    this.yb(b);
  };
  k.vi = function (a) {
    if (a instanceof gu) var b = a.feature;
  ...
  k.setMap = function (a) {
    ...
    b && (c.forEach(Ec), (c.length = 0), d.forEach(this.Bk, this));
    Dg.prototype.setMap.call(this, a);
    a &&
      (this.j
        ? c.push(y(this.j, 'add', this.ui, this), y(this.j, 'remove', this.vi, this))
        : this.l && c.push(y(this.l, 'addfeature', this.ui, this), y(this.l, 'removefeature', this.vi, this)),
    ...
    if (0 < g.length) {
      ...
      if (a.R && !a.C) {
        if (
          ...
          ((e = !0), (f = c > b ? m[1] : m[0]), (l = d.Ja(f)));
      } else
        a.C &&
          ((f = h ? $e(c, g[0].feature.V()) : af(c, m)),
          (l = d.Ja(f)),
          jf(b, l) <= a.g &&
            ((e = !0),
            a.R &&
  ...
  function iv(a) {
    ...
    b.nq && ((a.coordinate = b.vertex.slice(0, 2)), (a.pixel = b.wq));
    return Eg.call(this, a);
  }
  function jv() {
    var a = vb(this.u);
    a.length && (a.forEach(this.Dj, this), (this.u = {}));
    return !1;
  }
  function kv(a, b) {
  ...
  function mv(a) {
    Dg.call(this, { handleDownEvent: nv, handleDragEvent: ov, handleMoveEvent: pv, handleUpEvent: qv });
    a = a ? a : {};
    this.a = null;
  ...
  function pv(a) {
    var b = a.map.a;
    rv(this, a.pixel, a.map)
      ? (b.classList.remove(this.a ? 'ol-grab' : 'ol-grabbing'), b.classList.add(this.a ? 'ol-grabbing' : 'ol-grab'))
  ...
  function rv(a, b, c) {
    return c.we(
      b,
      function (a) {
        if (!this.j || ja(this.j.a, a)) return a;
      }.bind(a),
      { layerFilter: a.C, hitTolerance: a.l }
    );
  }
  ...
  function V(a) {
    ...
    this.g(
      function (a) {
        ...
        var b = (255 * a) | 0,
          c = this.B[b];
        c || ((c = [new bl({ image: new eo({ opacity: a, src: this.I }) })]), (this.B[b] = c));
        return c;
      }.bind(this)
    );
    this.set(Pt, null);
  ...
  k.Sl = function (a) {
    ...
    for (d = c.length; f < d; f += 4)
      if ((e = 4 * c[f + 3])) ((c[f] = this.j[e]), (c[f + 1] = this.j[e + 1]), (c[f + 2] = this.j[e + 2]));
    a.putImageData(b, 0, 0);
  };
  k.jj = function (a) {
    this.set(wv, a);
  ...
  yv.prototype.u = function (a, b, c, d) {
    if (this.Y()) {
      if (this.a.ha().Ea !== ua) return Gt.prototype.u.apply(this, arguments);
    ...
    h.c.forEach(function (a) {
      ...
      a: {
        ...
        for (l = 0; l < h; l++) {
          ...
          g[l] = ca;
          for (m = l + 1; m < h; m++)
            for (ca = -g[m][l] / g[l][l], Ub = l; Ub < h + 1; Ub++) g[m][Ub] = l == Ub ? 0 : g[m][Ub] + ca * g[l][Ub];
        }
        l = Array(h);
        for (m = h - 1; 0 <= m; m--)
          for (l[m] = g[m][h] / g[m][m], ca = m - 1; 0 <= ca; ca--) g[ca][h] -= g[ca][m] * l[m];
        g = l;
      }
      g &&
        (p.save(),
  ...
  function Gv(a, b, c, d, e, f) {
    ...
    var g = b.G(),
      h = g ? pb(c, g) : c,
      g = Av(a, b, nb(h), d);
    this.j = new Dv(a, b, h, this.l, 0.5 * g);
    this.c = d;
    this.i = c;
    a = Fv(this.j);
    ...
    e = 2;
    f = [];
    this.Hb && ((e = 0), (f = this.Hb.f));
    Is.call(this, c, d, this.o, e, f);
  }
  v(Gv, Is);
  Gv.prototype.ka = function () {
    1 == this.state && (Ec(this.ee), (this.ee = null));
  ...
  Gv.prototype.de = function () {
    ...
    2 == a &&
      (this.g = Cv(
        ...
        this.i,
        this.j,
        [{ extent: this.Hb.G(), image: this.Hb.Y() }],
        0
      ));
    this.state = a;
    this.s();
    ...
    if (0 == this.state) {
      ...
      2 == a || 3 == a
        ...
        : ((this.ee = y(
            ...
            function () {
              var a = this.Hb.getState();
              if (2 == a || 3 == a) (Ec(this.ee), (this.ee = null), this.de());
            },
            this
          )),
          this.Hb.load());
  ...
  Ov.prototype.Jc = function (a, b, c, d) {
    b = Iv(this, b);
    var e = this.R;
    if (e && this.T == this.i && e.resolution == b && e.a == c && Va(e.G(), a)) return e;
    a = a.slice();
    rb(a, this.va);
  ...
  k.tk = function (a, b, c, d, e) {
    var f = new pt((0.5 * b) / c, a, b, this.f.T, this.Sa);
    this.f.Yd(a, b, e);
    var g = !1;
    this.f.$b(
      a,
      function (a) {
        ...
        if (!(d = g)) {
          ...
          if (e) {
            ...
            Array.isArray(e) || (e = [e]);
            d = 0;
            for (h = e.length; d < h; ++d) p = Mt(f, a, e[d], Lt(b, c), this.qo, this) || p;
            d = p;
          } else d = !1;
        }
        g = d;
    ...
    this.l[0] != d[0] || this.l[1] != d[1]
      ? ((this.g.canvas.width = d[0]), (this.g.canvas.height = d[1]), (this.l[0] = d[0]), (this.l[1] = d[1]))
  ...
  Rv.prototype.lg = function (a, b, c, d) {
    if (this.M && this.M.Y())
      if (this.a.ha() instanceof Pv) {
        ...
        if (this.Ea(e, b, 0, mf, this)) return c.call(d, this.a, null);
      } else {
  ...
  Vv.prototype.sd = function (a, b) {
    ...
    for (z = x.ca; z <= x.$; ++z)
      for (M = x.da; M <= x.ia; ++M) {
        ...
        Wv(this, ba) || (ba = Ms(ba));
        Wv(this, ba)
          ? 2 == ba.getState() && ((A[p][ba.ta.toString()] = ba), ga || -1 != this.g.indexOf(ba) || (ga = !0))
          : pc(n, ba.ta, L, ha, oa) || ((ba = qc(n, ba.ta, ha, oa)) && L(p + 1, ba));
      }
    z = a.viewHints;
    z = z[0] || z[1];
    if (
      !(
        (this.f && 16 < Date.now() - a.time && z) ||
        (!ga && this.o && Va(this.o, u) && this.mf == m && r == this.R && (z || ((q * c) / E) * r == this.f))
      )
    ) {
      if ((z = this.c))
        ((M = l.Xd(p, c, f)),
          ...
          (ga = z.canvas),
          ga.width != ba || ga.height != M
            ? ((this.R = r), (ga.width = ba), (ga.height = M))
            : (z.clearRect(0, 0, ba, M), (r = this.R)));
      this.g.length = 0;
    ...
    b = Kh(
      ...
      b,
      0,
      ((this.o[0] - e[0]) / this.f) * c,
      ((e[1] - this.o[3]) / this.f) * c
    );
  ...
  k.ng = function (a, b, c) {
    var d = this.c,
      ...
      E = a.extent,
      A = rc(m, E, p);
    if (this.o && Aa(this.o, A) && this.l == l.i) u = this.D;
    else {
      ...
      for (var z = new Float32Array(4), Ub, M = 0, ba = b.length; M < ba; ++M)
        for (Ub in ((da = c[b[M]]), da))
          ((ha = da[Ub]),
            ...
            nk(d, ha, q, x * r),
            e.drawArrays(5, 0, 4));
      oa ? ((this.o = A), (this.D = u), (this.l = l.i)) : ((this.D = this.o = null), (this.l = -1), (a.animate = !0));
    }
    ...
    Ft(
      ...
      function (a) {
        2 != a.getState() ||
          ...
          a.bb() in uc.a ||
          uc.f([a, tc(m, a.ta), m.Da(a.ta[0]), q, x * r]);
      },
      this
    );
    Bt(a, l);
  ...
  v(dw, Vv);
  var ew = { image: ji, hybrid: ['Polygon', 'LineString'] },
    fw = { hybrid: ['Image', 'Text'], vector: ji };
  k = dw.prototype;
  k.sd = function (a, b) {
    var c = this.a,
      d = c.i;
        ...
        for (ga = L.length; oa < ga; ++oa) {
          ...
          if (fb) {
            ...
            if (fb) {
              var uc = !1;
              if (Array.isArray(fb))
                for (var bc = 0, Je = fb.length; bc < Je; ++bc) uc = Mt(Ub, ba, fb[bc], ca, this.Fi, this) || uc;
              else uc = Mt(Ub, ba, fb, ca, this.Fi, this) || uc;
              ba = uc;
            } else ba = !1;
            this.I = this.I || ba;
            u.Nd = u.Nd || ba;
          ...
          ((ha = l.c[l.a[B]]),
            ...
            'tile-pixels' == ha.a.a
              ? ((da = p.Aa(A, this.l)),
                ...
                (M = ((n / r) * A) / q),
                Ih(z, M, M),
                Jh(z, Math.round(((da[0] - x[0]) / A) * r), Math.round(((x[3] - da[3]) / A) * r)))
              : (Ih(z, da, -da), Jh(z, -x[0], -x[3])),
  ...
  k.ef = function (a, b, c) {
    ...
    if (f)
      for (
        var g = b.pixelRatio,
          h = b.viewState.rotation,
          l = b.size,
          m = Math.round((g * l[0]) / 2),
          l = Math.round((g * l[1]) / 2),
          n = this.g,
          d = d.ha().nb(),
          p = e.tileGrid,
  ...
  function hw(a, b, c, d, e, f, g, h, l, m, n) {
    ...
    if (jb(f))
      if (
        ((h = a.G()) && (e ? (e = pb(e, h)) : (e = h)), (d = Av(a, c, nb(f), d.Da(this.o[0]))), !isFinite(d) || 0 >= d)
      )
        this.state = 4;
      else if (((this.l = new Dv(a, c, f, e, d * (void 0 !== m ? m : 0.5))), this.l.c.length))
        if (
          ((this.g = b.tc(d)),
          (c = Fv(this.l)),
          e && (a.i ? ((c[1] = Ca(c[1], e[1], e[3])), (c[3] = Ca(c[3], e[1], e[3]))) : (c = pb(c, e))),
          jb(c))
        ) {
          a = oc(b, c, this.g);
          for (b = a.ca; b <= a.$; b++) for (c = a.da; c <= a.ia; c++) (m = l(this.g, b, c, g)) && this.a.push(m);
  ...
  hw.prototype.ka = function () {
    1 == this.state && (this.yd.forEach(Ec), (this.yd = null));
    Ls.prototype.ka.call(this);
  };
  ...
  hw.prototype.de = function () {
    var a = [];
    this.a.forEach(function (b) {
      b && 2 == b.getState() && a.push({ extent: this.c.Aa(b.ta), image: b.Y() });
    }, this);
    this.a.length = 0;
    if (a.length) {
      var b = this.o[0],
      ...
      this.a.forEach(function (b) {
        ...
        if (0 == c || 1 == c) {
          ...
          var d = y(
            ...
            function () {
              var c = b.getState();
              if (2 == c || 3 == c || 4 == c) (Ec(d), a--, a || (this.yd.forEach(Ec), (this.yd = null), this.de()));
            },
            this
          );
          this.yd.push(d);
  ...
  function jw(a, b) {
    for (var c = a.length, d = Array(c), e = 0; e < c; ++e) d[e] = iw(a[e], b);
    return kw(d);
  }
  function kw(a) {
    return 1 === a.length
  ...
  nw.prototype.fd = function (a) {
    for (var b, c; ow(this); ) {
      ...
      c = b.ta[0].toString();
      var d;
      if ((d = c in a)) ((b = b.ta), (d = za(a[c], b[1], b[2])));
      if (d) break;
      else Nc(this.pop());
    }
  };
  ...
  function yt(a, b, c, d, e) {
    ...
    for (var f = !0, g, h, l = d.ca; l <= d.$; ++l)
      for (var m = d.da; m <= d.ia; ++m)
        ((g = a.Sb(c, l, m)),
          (h = !1),
          b.b.hasOwnProperty(g) && ((g = b.get(g)), (h = 2 === g.getState()) && (h = !1 !== e(g))),
          h || (f = !1));
    return f;
  }
  k.Wf = function () {
  ...
  function rw(a, b, c) {
    ...
    if (a.u && d.c) {
      ...
      a = tc(c, e);
      d = zc(d);
      Ta(d, a) ? (b = e) : ((e = lb(d)), (a[0] += e * Math.ceil((d[0] - a[0]) / e)), (b = c.bg(a, b)));
    }
    e = b[0];
    d = b[1];
    a = b[2];
  ...
  k.Ta = function (a) {
    var b = this.c;
    return !this.tileGrid || (b && !dc(b, a))
      ? ((b = w(a).toString()), b in this.v || (this.v[b] = vc(a)), this.v[b])
      : this.tileGrid;
  };
  k.Wd = function (a) {
    var b = this.c;
    if (!b || dc(b, a)) return this.a;
    a = w(a).toString();
  ...
  k.Nc = function (a, b, c, d, e) {
    if (this.c && e && !dc(this.c, e)) {
      ...
      d.key = b;
      g ? ((d.i = g), f.replace(a, d)) : f.set(a, d);
      return d;
    }
        ...
        if (l.i) {
          ...
          do {
            if (2 == b.getState()) {
              b.i = null;
              break;
            } else 1 == b.getState() ? (c = b) : 0 == b.getState() ? (c.i = b.i) : (c = b);
            b = c.i;
          } while (b);
        }
        a.a.replace(g, l);
      }
    } else ((l = vw(a, b, c, d, e, f, h)), a.a.set(g, l));
    return l;
  }
  k.Pb = function (a) {
    if (this.I != a) {
  ...
  k.Qb = function (a, b) {
    if ((a = Tb(a))) ((a = w(a).toString()), a in this.v || (this.v[a] = b));
  };
  function uw(a, b) {
    a.Y().src = b;
  }
  ...
  function zw(a) {
    ...
    var b = void 0 !== a.projection ? a.projection : 'EPSG:3857',
      c =
        void 0 !== a.tileGrid
          ? a.tileGrid
          : xc({ extent: zc(b), maxZoom: a.maxZoom, minZoom: a.minZoom, tileSize: a.tileSize });
    X.call(this, {
      attributions: a.attributions,
      cacheSize: a.cacheSize,
  ...
  k.Yd = function (a, b, c) {
    ...
    b !== this.resolution && (this.clear(), (this.resolution = b), Dw(this), this.cd(this.features));
  };
  k.Yp = function (a) {
    this.distance = a;
    this.sa();
  ...
  function Gw(a) {
    a = a || {};
    Hv.call(this, { attributions: a.attributions, logo: a.logo, projection: a.projection, resolutions: a.resolutions });
  ...
  k.Jc = function (a, b, c, d) {
    ...
    c = this.T ? c : 1;
    var e = this.M;
    if (e && this.I == this.i && e.resolution == b && e.a == c && Va(e.G(), a)) return e;
  ...
  k.ho = function (a) {
    a != this.f && ((this.f = a), (this.M = null), this.s());
  };
  k.io = function (a) {
    tb(this.v, a);
    this.M = null;
  ...
  function Hw(a) {
    Hv.call(this, { projection: a.projection, resolutions: a.resolutions });
    this.R = void 0 !== a.crossOrigin ? a.crossOrigin : null;
  ...
  k.Jc = function (a, b, c) {
    ...
    c = this.T ? c : 1;
    var d = this.M;
    if (d && this.B == this.i && d.resolution == b && d.a == c && Va(d.G(), a)) return d;
  ...
  function Iw(a) {
    ...
    Hv.call(this, { attributions: a.attributions, logo: a.logo, projection: Tb(a.projection) });
  ...
  k.Jc = function (a, b, c, d) {
    ...
    if ((f = this.M) && this.R == this.i && f.resolution == b && f.a == c && Va(f.G(), g)) return f;
  ...
  v(Nw, zw);
  var Ow = new Ac({ html: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors.' });
  Fj.df = {};
  Fj.df.Af = function () {};
  (function (a) {
    function b(a, b, c) {
      ...
      return function (c) {
        ...
        if (c.imageOps) {
          ...
          for (c = 0; c < h; ++c) {
            ...
            var L = f,
              oa = g;
            n = b ? new ImageData(n, L, oa) : { data: n, width: L, height: oa };
            l[m] = n;
          }
          f = a(l, e).data;
        } else {
    ...
    function f(a) {
      ...
      var c = [];
      if (b) for (var f = 0; f < b; ++f) c[f] = d(a, this.gh.bind(this, f));
      else c[0] = e(a, this.gh.bind(this, 0));
      this.qe = c;
      this.Ed = [];
    ...
    f.prototype.pp = function (a, b, c) {
      this.dk({ inputs: a, Qh: b, callback: c });
      this.dh();
    };
    f.prototype.dk = function (a) {
      for (this.Ed.push(a); this.Ed.length > this.fk; ) this.Ed.shift().callback(null, null);
    };
    f.prototype.dh = function () {
      if (0 === this.oe && 0 < this.Ed.length) {
        var a = (this.Gf = this.Ed.shift()),
          ...
          e = this.qe.length;
        this.oe = e;
        if (1 === e) this.qe[0].postMessage({ buffers: d, meta: a.Qh, imageOps: this.Ff, width: b, height: c }, d);
        else
          for (var f = 4 * Math.ceil(a.inputs[0].data.length / 4 / e), g = 0; g < e; ++g) {
            for (var h = g * f, B = [], E = 0, A = d.length; E < A; ++E) B.push(d[g].slice(h, h + f));
            this.qe[g].postMessage({ buffers: B, meta: a.Qh, imageOps: this.Ff, width: b, height: c }, B);
          }
      }
    };
    f.prototype.gh = function (a, b) {
      this.Jq || ((this.bd[a] = b.data), --this.oe, 0 === this.oe && this.gk());
    };
  ...
  function Pw(a) {
    ...
    for (var b = Rw(this.g), c = {}, d = 0, e = b.length; d < e; ++d) c[w(b[d].layer)] = b[d];
    this.f = null;
    this.I = {
      animate: !1,
      attributions: {},
  ...
  Pw.prototype.v = function (a, b) {
    this.B = new Fj.df.Af({ operation: a, $l: 'image' === this.va, rp: 1, lib: b, threads: this.Sa });
    this.s();
  };
  Pw.prototype.Y = function (a, b, c, d) {
    c = !0;
    for (var e, f = 0, g = this.g.length; f < g; ++f)
      if (((e = this.g[f].a.ha()), 'ready' !== e.getState())) {
        c = !1;
        break;
      }
    if (!c) return null;
    ...
    this.f && ((d = this.f.resolution), (c = this.f.G()), (b === d && bb(a, c)) || (this.f = null));
  ...
  Pw.prototype.pa = function (a, b, c, d) {
    if (!b && c) {
      ...
      if (e === this.l.viewState.resolution && bb(b, this.l.extent)) {
        if (this.f) var f = this.f.Y().getContext('2d');
        else ((f = jd(Math.round(lb(b) / e), Math.round(mb(b) / e))), (this.f = new Ks(b, e, 1, this.j, f.canvas)));
  ...
  function Qw(a) {
    for (var b = a.length, c = Array(b), d = 0; d < b; ++d) {
      var e = d,
        ...
        g = null;
      f instanceof pw
        ? ((f = new cw({ source: f })), (g = new Vv(f)))
        : f instanceof Hv && ((f = new Uv({ source: f })), (g = new zv(f)));
      c[e] = g;
    }
    return c;
  }
  ...
  var Zw = [
    ...
    Yw = {
      terrain: { Lb: 'jpg', opaque: !0 },
      'terrain-background': { Lb: 'jpg', opaque: !0 },
      'terrain-labels': { Lb: 'png', opaque: !1 },
      'terrain-lines': { Lb: 'png', opaque: !1 },
      'toner-background': { Lb: 'png', opaque: !0 },
      toner: { Lb: 'png', opaque: !0 },
      'toner-hybrid': { Lb: 'png', opaque: !1 },
      'toner-labels': { Lb: 'png', opaque: !1 },
      'toner-lines': { Lb: 'png', opaque: !1 },
      'toner-lite': { Lb: 'png', opaque: !0 },
    ...
    if (!(d.b.length <= a[0])) {
      ...
      g
        ? ((c = c.mb.split(':').pop()),
          ...
          (a = (1 == g.length ? g[0] : g[Ia((a[1] << a[0]) + a[2], g.length)])
  ...
  function dx(a) {
    ...
    if (a.url)
      if (a.jsonp) gw(a.url, this.og.bind(this), this.Ve.bind(this));
      else {
    ...
    else a.tileJSON ? this.og(a.tileJSON) : xa(!1, 51);
  }
  v(dx, X);
  k = dx.prototype;
  k.Ao = function (a) {
  ...
  k.og = function (a) {
    ...
    if (void 0 !== a.attribution && !this.j) {
      b = void 0 !== e ? e : b.G();
      e = {};
      for (var g; f <= d; ++f) ((g = f.toString()), (e[g] = [oc(c, b, f)]));
      this.ua([new Ac({ html: a.attribution, tileRanges: e })]);
    }
    this.f = a;
    bu(this, 'ready');
  };
  ...
  function ex(a) {
    pw.call(this, { projection: Tb('EPSG:3857'), state: 'loading' });
    this.v = void 0 !== a.preemptive ? a.preemptive : !0;
    this.l = lw;
    this.g = void 0;
    this.f = a.jsonp || !1;
    if (a.url)
      if (this.f) gw(a.url, this.pg.bind(this), this.We.bind(this));
      else {
        var b = new XMLHttpRequest();
    ...
    else a.tileJSON ? this.pg(a.tileJSON) : xa(!1, 51);
  }
  v(ex, pw);
  k = ex.prototype;
  k.Eo = function (a) {
  ...
  k.zk = function (a, b, c, d, e) {
    this.tileGrid
      ? ((b = this.tileGrid.Be(a, b)), fx(this.Nc(b[0], b[1], b[2], 1, this.c), a, c, d, e))
      : !0 === e
        ? setTimeout(function () {
            c.call(d, null);
          }, 0)
  ...
  k.pg = function (a) {
    ...
    if (g) {
      ...
      if (void 0 !== a.attribution) {
        b = void 0 !== e ? e : b.G();
        for (e = {}; f <= d; ++f) ((g = f.toString()), (e[g] = [oc(c, b, f)]));
        this.ua([new Ac({ html: a.attribution, tileRanges: e })]);
      }
      bu(this, 'ready');
    } else bu(this, 'error');
  ...
  function hx(a) {
    if (0 == a.state)
      if (((a.state = 1), a.l)) gw(a.o, a.Ji.bind(a), a.De.bind(a));
      else {
        var b = new XMLHttpRequest();
  ...
  k.Fo = function (a, b, c, d) {
    ...
    if (!(e.b.length <= b[0])) {
      var f = e.Da(b[0]),
        ...
        h = this.C;
      h && ((e = Ka(e, h, this.o)), (g = Qa(g, f * h, g)));
      h = {
        SERVICE: 'WMS',
        VERSION: '1.3.0',
        REQUEST: 'GetFeatureInfo',
  ...
  k.Fc = function (a, b, c) {
    ...
    if (!(d.b.length <= a[0])) {
      ...
      var e = d.Da(a[0]),
        ...
        g = this.C;
      g && ((d = Ka(d, g, this.o)), (f = Qa(f, e * g, f)));
      1 != b && (d = La(d, b, this.o));
  ...
  nx.prototype.ka = function () {
    for (var a = 0, b = this.a.length; a < b; ++a) {
      var c = this.a[a],
        d = this.c[c];
      d.j--;
      d.j || (delete this.c[c], Nc(d));
    }
    this.a.length = 0;
    this.c = null;
    1 == this.state && (this.g.forEach(Ec), (this.g.length = 0));
    this.i && Nc(this.i);
    this.state = 5;
    this.s();
    this.l.forEach(Ec);
  ...
  nx.prototype.load = function () {
    ...
    1 == this.state &&
      this.a.forEach(
        function (c) {
          var d = this.c[c];
          0 == d.state ? (d.Pg(this.S), d.load()) : 3 == d.state ? (b = !0) : 4 == d.state && ma(this.a, c);
          if (1 == d.state) {
            var e = y(
              d,
              'change',
  ...
  k.load = function () {
    0 == this.state && (Ns(this, 1), this.u(this, this.l), this.v(null, NaN, null));
  };
  k.$o = function (a, b) {
    this.ig(b);
    this.mj(a);
  ...
  qx.prototype.Ta = function (a) {
    var b = a.mb,
      c = this.f[b];
    c || ((c = this.tileGrid), (c = this.f[b] = wc(a, void 0, c ? c.gb(c.minZoom) : void 0)));
    return c;
  };
  ...
  function Z(a) {
    ...
    var d = (this.T = void 0 !== a.requestEncoding ? a.requestEncoding : 'KVP'),
      e = a.tileGrid,
      f = { layer: this.B, style: this.R, tilematrixset: this.l };
    'KVP' == d && tb(f, { Service: 'WMTS', Request: 'GetTile', Version: this.fa, Format: this.C });
    var g = this.f,
  ...
  function ux(a) {
    ...
    f.reverse();
    b = [0, -b[1], b[0], 0];
    b = new lc({ extent: b, origin: ib(b), resolutions: f });
  ...
  yx.prototype.add = function (a, b, c, d, e) {
    ...
    for (f = this.a.length; g < f; ++g) {
      ...
      if (h.width >= b + this.b && h.height >= c + this.b)
        return (
          (f = { offsetX: h.x + this.b, offsetY: h.y + this.b, image: this.f }),
          (this.c[a] = f),
  ...
  Ax.prototype.add = function (a, b, c, d, e, f) {
    if (b + this.b > this.i || c + this.b > this.i) return null;
    d = Bx(this, !1, a, b, c, d, f);
    if (!d) return null;
    a = Bx(this, !0, a, b, c, e ? e : ua, f);
    return { offsetX: d.offsetX, offsetY: d.offsetY, image: d.image, Zl: a.image };
  };
  function Bx(a, b, c, d, e, f, g) {
    ...
    for (l = h.length; m < l; ++m) {
      ...
      n ||
        m !== l - 1 ||
        (b ? ((n = Math.min(2 * a.c, a.i)), (a.c = n)) : ((n = Math.min(2 * a.a, a.i)), (a.a = n)),
        (n = new yx(n, a.b)),
        h.push(n),
        ++l);
    }
  ...
  t('ol.easing.upAndDown', function (a) {
    return 0.5 > a ? sd(2 * a) : 1 - sd(2 * (a - 0.5));
  });
  ...
  t('ol.loadingstrategy.tile', function (a) {
    return function (b, c) {
      ...
      var d = [];
      c = [c, 0, 0];
      for (c[1] = b.ca; c[1] <= b.$; ++c[1]) for (c[2] = b.da; c[2] <= b.ia; ++c[2]) d.push(a.Aa(c));
      return d;
    };
  });
  t('ol.Map', G);
  ...
  t('ol.Observable.unByKey', function (a) {
    if (Array.isArray(a)) for (var b = 0, c = a.length; b < c; ++b) Ec(a[b]);
    else Ec(a);
  });
  ...
  t('ol.source.WMTS.optionsFromCapabilities', function (a, b) {
    ...
    var n =
      'projection' in b ? Tb(b.projection) : Tb(m.SupportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/, '$1:$3'));
    ...
    if ('OperationsMetadata' in a && 'GetTile' in a.OperationsMetadata)
      for (a = a.OperationsMetadata.GetTile.DCP.HTTP.Get, r = 0, p = a.length; r < p; ++r) {
        ...
        '' === m && (m = x[0]);
        if ('KVP' === m) ja(x, 'KVP') && u.push(a[r].href);
        else break;
      }
    u.length ||
      ((m = 'REST'),
