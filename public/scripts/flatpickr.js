...
!(function (e, n) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(n)
      : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).confirmDatePlugin = n());
})(this, function () {
  'use strict';
  var t = function () {
    return (t =
  ...
  return function (e) {
    var l,
      ...
      o = 'flatpickr-confirm';
    return function (c) {
      return c.config.noCalendar || c.isMobile
        ? {}
        : t(
            {
              onKeyDown: function (e, n, t, i) {
                var o = (function (n) {
                    try {
                      return 'function' != typeof n.composedPath ? n.target : n.composedPath()[0];
                    } catch (e) {
                      return n.target;
                    }
                  })(i),
                  r =
                    (!c.config.time_24hr && o === c.amPM) ||
                    (c.config.time_24hr &&
                      ((c.config.enableSeconds && o === c.secondElement) ||
                        (!c.config.enableSeconds && o === c.minuteElement)));
                c.config.enableTime && 'Tab' === i.key && r
                  ? (i.preventDefault(), l.focus())
                  : 'Enter' === i.key && o === l && c.close();
              },
              onReady: function () {
                (((l = c._createElement(
                  'div',
                  o + ' ' + (n.showAlways ? 'visible' : '') + ' ' + n.theme + 'Theme',
                  n.confirmText
                )).tabIndex = -1),
                  (l.innerHTML += n.confirmIcon),
                  l.addEventListener('click', c.close),
                  c.calendarContainer.appendChild(l),
                  c.loadedPlugins.push('confirmDate'));
              }
            },
            n.showAlways
              ? {}
              : {
                  onChange: function (e, n) {
                    var t =
                        ...
                        -1 !== c.loadedPlugins.indexOf('monthSelect'),
                      i = c.calendarContainer.querySelector('.' + o);
                    if (i)
                      return n && !c.config.inline && t && i
                        ? i.classList.add('visible')
                        : void i.classList.remove('visible');
                  }
                }
          );
    };
