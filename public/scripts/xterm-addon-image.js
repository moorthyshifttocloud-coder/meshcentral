  ...
  (() => {
    ...
    var e = {
            ...
            (t.InWasm = function (e) {
              if (e.d) {
                ...
                return 2 === t
                  ? i
                    ? () => r || (r = A(s))
                    : () => Promise.resolve(r || (r = A(s)))
                  : 1 === t
                    ? i
                      ? () => n || (n = new o.Module(r || (r = A(s))))
                      : () => (n ? Promise.resolve(n) : o.compile(r || (r = A(s))).then((e) => (n = e)))
                    : i
                      ? (e) => new o.Instance(n || (n = new o.Module(r || (r = A(s)))), e)
                      : (e) =>
                          n
                            ? o.instantiate(n, e)
                            : o.instantiate(r || (r = A(s)), e).then((e) => (n = e.module) && e.instance);
              }
        ...
        939: (e, t) => {
          ...
          function r(e, t, A, i = 255) {
            return (((255 & i) << 24) | ((255 & A) << 16) | ((255 & t) << 8) | (255 & e)) >>> 0;
          }
          function n(e, t, A) {
          ...
          function o(e, t, A) {
            return (
              A < 0 && (A += 1),
              A > 1 && (A -= 1),
              6 * A < 1 ? t + 6 * (e - t) * A : 2 * A < 1 ? e : 3 * A < 2 ? t + (e - t) * (4 - 6 * A) : t
            );
          }
          function a(e, t, A) {
            return (
              (4278190080 |
                (Math.round((A / 100) * 255) << 16) |
                (Math.round((t / 100) * 255) << 8) |
                Math.round((e / 100) * 255)) >>>
              0
            );
          }
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.DEFAULT_FOREGROUND =
              ...
              t.PALETTE_ANSI_256 =
              t.PALETTE_VT340_GREY =
              t.PALETTE_VT340_COLOR =
              t.normalizeHLS =
              t.normalizeRGB =
              t.nearestColorIndex =
              t.fromRGBA8888 =
              ...
              t.BIG_ENDIAN =
                void 0),
            (t.BIG_ENDIAN = 255 === new Uint8Array(new Uint32Array([4278190080]).buffer)[0]),
            t.BIG_ENDIAN && console.warn('BE platform detected. This version of node-sixel works only on LE properly.'),
            (t.red = A),
            (t.green = i),
            (t.blue = s),
            (t.alpha = function (e) {
            ...
            (t.normalizeRGB = a),
            (t.normalizeHLS = function (e, t, A) {
              return (function (e, t, A) {
                if (!A) {
                  const e = Math.round(255 * t);
                  return r(e, e, e);
                }
                const i = t < 0.5 ? t * (1 + A) : t + A - t * A,
                  s = 2 * t - i;
                return r(
                  n(0, 255, Math.round(255 * o(i, s, e + 1 / 3))),
                  n(0, 255, Math.round(255 * o(i, s, e))),
                  n(0, 255, Math.round(255 * o(i, s, e - 1 / 3)))
                );
              })((e + 240) / 360, t / 100, A / 100);
            }),
            (t.PALETTE_VT340_COLOR = new Uint32Array([
              a(0, 0, 0),
              a(20, 20, 80),
              a(80, 13, 13),
              a(20, 80, 20),
            ...
            (t.PALETTE_VT340_GREY = new Uint32Array([
              a(0, 0, 0),
              a(13, 13, 13),
              a(26, 26, 26),
              a(40, 40, 40),
            ...
            (t.PALETTE_ANSI_256 = (() => {
              ...
              for (let A = 0; A < 6; ++A)
                for (let i = 0; i < 6; ++i) for (let s = 0; s < 6; ++s) e.push(r(t[A], t[i], t[s]));
              for (let t = 8; t <= 238; t += 10) e.push(r(t, t, t));
              return new Uint32Array(e);
            })()),
            (t.DEFAULT_BACKGROUND = r(0, 0, 0, 255)),
            (t.DEFAULT_FOREGROUND = r(255, 255, 255, 255)));
        },
        591: (e, t, A) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }),
          ...
          const h = {
            ...
            sixelColor: i.DEFAULT_FOREGROUND,
            fillColor: i.DEFAULT_BACKGROUND,
            palette: i.PALETTE_VT340_COLOR,
            paletteLimit: s.LIMITS.PALETTE_SIZE,
            truncate: !0
          };
          function g(e) {
            const t = new a(),
              A = { env: { handle_band: t.handle_band.bind(t), mode_parsed: t.mode_parsed.bind(t) } };
            return WebAssembly.instantiate(n || r, A).then((A) => ((n = n || A.module), new l(e, A.instance || A, t)));
          }
          t.DecoderAsync = g;
          class l {
            constructor(e, t, A) {
              if (
                ((this._PIXEL_OFFSET = s.LIMITS.MAX_WIDTH + 4),
                (this._canvas = o),
                (this._bandWidths = []),
                (this._maxWidth = 0),
                (this._minWidth = s.LIMITS.MAX_WIDTH),
                (this._lastOffset = 0),
                (this._currentHeight = 0),
                (this._opts = Object.assign({}, h, e)),
                this._opts.paletteLimit > s.LIMITS.PALETTE_SIZE)
              )
                throw new Error(`DecoderOptions.paletteLimit must not exceed ${s.LIMITS.PALETTE_SIZE}`);
              if (t) ((A.bandHandler = this._handle_band.bind(this)), (A.modeHandler = this._initCanvas.bind(this)));
              else {
                const e = n || (n = new WebAssembly.Module(r));
                t = new WebAssembly.Instance(e, {
                  env: { handle_band: this._handle_band.bind(this), mode_parsed: this._initCanvas.bind(this) }
                });
              }
              ((this._instance = t),
            ...
            _initCanvas(e) {
              if (2 === e) {
                ...
                if (e > this._canvas.length) {
                  if (this._opts.memoryLimit && 4 * e > this._opts.memoryLimit)
                ...
                if (2 === this._level) {
                  const e = Math.min(this._rasterWidth, s.LIMITS.MAX_WIDTH) * this._rasterHeight;
                  if (e > this._canvas.length) {
                    if (this._opts.memoryLimit && 4 * e > this._opts.memoryLimit)
                      throw (this.release(), new Error('image exceeds memory limit'));
                    this._canvas = new Uint32Array(e);
            ...
            _realloc(e, t) {
              ...
              if (A > this._canvas.length) {
                if (this._opts.memoryLimit && 4 * A > this._opts.memoryLimit)
                  throw (this.release(), new Error('image exceeds memory limit'));
                const e = new Uint32Array(65536 * Math.ceil(A / 65536));
                (e.set(this._canvas), (this._canvas = e));
              }
            }
            _handle_band(e) {
              const t = this._PIXEL_OFFSET;
              let A = this._lastOffset;
              if (2 === this._mode) {
                let i = this.height - this._currentHeight,
                  s = 0;
                for (; s < 6 && i > 0; ) (this._canvas.set(this._pSrc.subarray(t * s, t * s + e), A + e * s), s++, i--);
                ((this._lastOffset += e * s), (this._currentHeight += s));
              } else if (1 === this._mode) {
                (this._realloc(A, 6 * e),
                  (this._maxWidth = Math.max(this._maxWidth, e)),
                  (this._minWidth = Math.min(this._minWidth, e)));
                for (let i = 0; i < 6; ++i) this._canvas.set(this._pSrc.subarray(t * i, t * i + e), A + e * i);
            ...
            init(
              e = this._opts.fillColor,
              t = this._opts.palette,
              A = this._opts.paletteLimit,
              i = this._opts.truncate
            ) {
              (this._wasm.init(this._opts.sixelColor, e, A, i ? 1 : 0),
                t && this._palette.set(t.subarray(0, s.LIMITS.PALETTE_SIZE)),
            ...
            decode(e, t = 0, A = e.length) {
              let i = t;
              for (; i < A; ) {
                const t = Math.min(A - i, s.LIMITS.CHUNK_SIZE);
                (this._chunk.set(e.subarray(i, (i += t))), this._wasm.decode(0, t));
              }
            }
            decodeString(e, t = 0, A = e.length) {
              let i = t;
              for (; i < A; ) {
                const t = Math.min(A - i, s.LIMITS.CHUNK_SIZE);
                for (let A = 0, s = i; A < t; ++A, ++s) this._chunk[A] = e.charCodeAt(s);
                ((i += t), this._wasm.decode(0, t));
              }
            }
            get data32() {
              if (0 === this._mode || !this.width || !this.height) return o;
              const e = this._wasm.current_width();
              if (2 === this._mode) {
                let t = this.height - this._currentHeight;
                if (t > 0) {
                  const A = this._PIXEL_OFFSET;
                  let i = this._lastOffset,
                    s = 0;
                  for (; s < 6 && t > 0; )
                    (this._canvas.set(this._pSrc.subarray(A * s, A * s + e), i + e * s), s++, t--);
                  t && this._canvas.fill(this._fillColor, i + e * s);
                }
              ...
              if (1 === this._mode) {
                ...
                for (let e = 0; e < this._bandWidths.length; ++e) {
                  const s = this._bandWidths[e];
                  for (let e = 0; e < 6; ++e) (t.set(this._canvas.subarray(i, (i += s)), A), (A += this.width));
                }
                if (e) {
                  const i = this._PIXEL_OFFSET,
                    s = this._wasm.current_height();
                  for (let r = 0; r < s; ++r) t.set(this._pSrc.subarray(i * r, i * r + e), A + this.width * r);
                }
                return t;
              }
              return o;
          ...
          ((t.Decoder = l),
            (t.decode = function (e, t) {
              ...
              return (
                A.init(),
                'string' == typeof e ? A.decodeString(e) : A.decode(e),
                { width: A.width, height: A.height, data32: A.data32, data8: A.data8 }
              );
            }),
        ...
        795: (e, t, A) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }), (t.IIPHandler = void 0));
          const i = A(463),
            s = A(699),
            r = A(669),
            n = A(389),
            o = A(462),
            a = { name: 'Unnamed file', size: 0, width: 'auto', height: 'auto', preserveAspectRatio: 1, inline: 0 };
          t.IIPHandler = class {
            constructor(e, t, A, i) {
              ((this._opts = e),
                (this._renderer = t),
                ...
                (this._aborted = !1),
                (this._hp = new n.HeaderParser()),
                (this._header = a),
                (this._dec = new r.default(4194304)),
                (this._metrics = o.UNSUPPORTED_TYPE));
            }
            reset() {}
            start() {
              ((this._aborted = !1), (this._header = a), (this._metrics = o.UNSUPPORTED_TYPE), this._hp.reset());
            }
            put(e, t, A) {
              if (!this._aborted)
                if (4 === this._hp.state) this._dec.put(e, t, A) && (this._dec.release(), (this._aborted = !0));
                else {
                  const i = this._hp.parse(e, t, A);
                  if (-1 === i) return void (this._aborted = !0);
                  if (i > 0) {
                    if (
                      ((this._header = Object.assign({}, a, this._hp.fields)),
                      !this._header.inline || !this._header.size || this._header.size > this._opts.iipSizeLimit)
                    )
                      return void (this._aborted = !0);
                    (this._dec.init(this._header.size),
                      this._dec.put(e, i, A) && (this._dec.release(), (this._aborted = !0)));
                  }
                }
            }
            end(e) {
              ...
              if (
                ((s = e) &&
                  (s = !this._dec.end()) &&
                  ((this._metrics = (0, o.imageType)(this._dec.data8)),
                  (s = 'unsupported' !== this._metrics.mime) &&
                    ((t = this._metrics.width),
                    (A = this._metrics.height),
                    (s = t && A && t * A < this._opts.pixelLimit) &&
                      (([t, A] = this._resize(t, A).map(Math.floor)), (s = t && A && t * A < this._opts.pixelLimit)))),
                !s)
              )
                return (this._dec.release(), !0);
              const r = new Blob([this._dec.data8], { type: this._metrics.mime });
              if ((this._dec.release(), !window.createImageBitmap)) {
                ...
                return new Promise((r) => {
                  (s.addEventListener('load', () => {
                    ...
                    const o = i.ImageRenderer.createCanvas(window.document, t, A);
                    (null === (n = o.getContext('2d')) || void 0 === n || n.drawImage(s, 0, 0, t, A),
                      this._storage.addImage(o),
                      r(!0));
                  }),
                    (s.src = e),
                    setTimeout(() => r(!0), 1e3));
              ...
              return createImageBitmap(r, { resizeWidth: t, resizeHeight: A }).then(
                (e) => (this._storage.addImage(e), !0)
              );
            }
            _resize(e, t) {
              var A, i, r, n;
              const o =
                  (null === (A = this._renderer.dimensions) || void 0 === A ? void 0 : A.css.cell.width) ||
                  s.CELL_SIZE_DEFAULT.width,
                a =
                  (null === (i = this._renderer.dimensions) || void 0 === i ? void 0 : i.css.cell.height) ||
                  s.CELL_SIZE_DEFAULT.height,
                h =
                  (null === (r = this._renderer.dimensions) || void 0 === r ? void 0 : r.css.canvas.width) ||
                  o * this._coreTerminal.cols,
                g =
                  (null === (n = this._renderer.dimensions) || void 0 === n ? void 0 : n.css.canvas.height) ||
                  a * this._coreTerminal.rows,
                l = this._dim(this._header.width, h, o),
                c = this._dim(this._header.height, g, a);
              if (!l && !c) {
                const A = h / e,
                  i = (g - a) / t,
                  s = Math.min(A, i);
                return s < 1 ? [e * s, t * s] : [e, t];
              }
              return l ? (!this._header.preserveAspectRatio && l && c ? [l, c] : [l, (t * l) / e]) : [(e * c) / t, c];
            }
            _dim(e, t, A) {
              return 'auto' === e
                ? 0
                : e.endsWith('%')
                  ? (parseInt(e.slice(0, -1)) * t) / 100
                  : e.endsWith('px')
        ...
        389: (e, t) => {
          ...
          function i(e) {
            ...
            for (let A = 0; A < e.length; ++A) {
              if (e[A] < 48 || e[A] > 57) throw new Error('illegal char');
              t = 10 * t + e[A] - 48;
            }
            return t;
          }
          ...
          (Object.defineProperty(t, '__esModule', { value: !0 }), (t.HeaderParser = void 0));
          const r = {
              inline: i,
              size: i,
              name: function (e) {
                if ('undefined' != typeof Buffer) return Buffer.from(A(e), 'base64').toString();
                const t = atob(A(e)),
          ...
          t.HeaderParser = class {
            constructor() {
              ((this.state = 0),
                (this._buffer = new Uint32Array(o)),
                (this._position = 0),
                (this._key = ''),
                (this.fields = {}));
            }
            ...
            parse(e, t, A) {
              ...
              for (let a = t; a < A; ++a) {
                ...
                switch (t) {
                  case 59:
                    if (!this._storeValue(s)) return this._a();
                    ((i = 2), (s = 0));
                    break;
                  case 61:
                    if (0 === i) {
                      for (let e = 0; e < n.length; ++e) if (r[e] !== n[e]) return this._a();
                      ((i = 2), (s = 0));
                    } else if (2 === i) {
                      if (!this._storeKey(s)) return this._a();
                      ((i = 3), (s = 0));
                    } else if (3 === i) {
                      if (s >= o) return this._a();
                      r[s++] = t;
                    }
                    break;
                  case 58:
                    return 3 !== i || this._storeValue(s) ? ((this.state = 4), a + 1) : this._a();
                  default:
                    if (s >= o) return this._a();
                    r[s++] = t;
                }
              }
              return ((this.state = i), (this._position = s), -2);
            }
            _a() {
              return ((this.state = 1), -1);
            }
            _storeKey(e) {
              const t = A(this._buffer.subarray(0, e));
            ...
            _storeValue(e) {
              if (this._key) {
                try {
                  ...
                  this.fields[this._key] = r[this._key] ? r[this._key](t) : t;
                } catch (e) {
                  return !1;
                }
                return !0;
        ...
        462: (e, t) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.UNSUPPORTED_TYPE = void 0),
            (t.imageType = function (e) {
              if (e.length < 24) return t.UNSUPPORTED_TYPE;
              const A = new Uint32Array(e.buffer, e.byteOffset, 6);
              if (1196314761 === A[0] && 169478669 === A[1] && 1380206665 === A[3])
                return {
                  mime: 'image/png',
              ...
              if (255 === e[0] && 216 === e[1] && 255 === e[2]) {
                const [t, A] = (function (e) {
                  ...
                  let A = 4,
                    i = (e[A] << 8) | e[A + 1];
                  for (;;) {
                    if (((A += i), A >= t)) return [0, 0];
                    if (255 !== e[A]) return [0, 0];
                    if (192 === e[A + 1] || 194 === e[A + 1])
                      return A + 8 < t ? [(e[A + 7] << 8) | e[A + 8], (e[A + 5] << 8) | e[A + 6]] : [0, 0];
                    ((A += 2), (i = (e[A] << 8) | e[A + 1]));
                  }
                })(e);
                return { mime: 'image/jpeg', width: t, height: A };
              }
              return 944130375 !== A[0] || (55 !== e[4] && 57 !== e[4]) || 97 !== e[5]
                ? t.UNSUPPORTED_TYPE
                : { mime: 'image/gif', width: (e[7] << 8) | e[6], height: (e[9] << 8) | e[8] };
            }),
            (t.UNSUPPORTED_TYPE = { mime: 'unsupported', width: 0, height: 0 }));
        },
        463: (e, t, A) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }), (t.ImageRenderer = void 0));
          const i = A(939),
            s = A(540);
          class r extends s.Disposable {
            static createCanvas(e, t, A) {
              const i = (e || document).createElement('canvas');
              return ((i.width = 0 | t), (i.height = 0 | A), i);
            }
            static createImageData(e, t, A, i) {
              if ('function' != typeof ImageData) {
                const s = e.createImageData(t, A);
                return (i && s.data.set(new Uint8ClampedArray(i, 0, t * A * 4)), s);
              }
              return i ? new ImageData(new Uint8ClampedArray(i, 0, t * A * 4), t, A) : new ImageData(t, A);
            }
            ...
            constructor(e) {
              (super(),
                (this._terminal = e),
                (this._optionsRefresh = this._register(new s.MutableDisposable())),
                (this._oldOpen = this._terminal._core.open),
                (this._terminal._core.open = (e) => {
                  var t;
                  (null === (t = this._oldOpen) || void 0 === t || t.call(this._terminal._core, e), this._open());
                }),
                this._terminal._core.screenElement && this._open(),
                (this._optionsRefresh.value = this._terminal._core.optionsService.onOptionChange((e) => {
                  var t;
                  'fontSize' === e &&
                    (this.rescaleCanvas(),
                    null === (t = this._renderService) || void 0 === t || t.refreshRows(0, this._terminal.rows));
                })),
                this._register(
                  (0, s.toDisposable)(() => {
                    var e;
                    (this.removeLayerFromDom(),
                      this._terminal._core &&
                        this._oldOpen &&
                        ((this._terminal._core.open = this._oldOpen), (this._oldOpen = void 0)),
                      this._renderService &&
                        this._oldSetRenderer &&
                        ((this._renderService.setRenderer = this._oldSetRenderer), (this._oldSetRenderer = void 0)),
                      (this._renderService = void 0),
                      (this.canvas = void 0),
                      (this._ctx = void 0),
                      null === (e = this._placeholderBitmap) || void 0 === e || e.close(),
            ...
            showPlaceholder(e) {
              ...
              (e
                ? this._placeholder ||
                  -1 === this.cellSize.height ||
                  this._createPlaceHolder(Math.max(this.cellSize.height + 1, 24))
                : (null === (t = this._placeholderBitmap) || void 0 === t || t.close(),
                  (this._placeholderBitmap = void 0),
                  (this._placeholder = void 0)),
                null === (A = this._renderService) || void 0 === A || A.refreshRows(0, this._terminal.rows));
            }
            get dimensions() {
              var e;
            ...
            clearLines(e, t) {
              ...
              null === (A = this._ctx) ||
                ...
                A.clearRect(
                  0,
                  e * ((null === (i = this.dimensions) || void 0 === i ? void 0 : i.css.cell.height) || 0),
                  (null === (s = this.dimensions) || void 0 === s ? void 0 : s.css.canvas.width) || 0,
                  (++t - e) * ((null === (r = this.dimensions) || void 0 === r ? void 0 : r.css.cell.height) || 0)
                );
            }
            clearAll() {
              var e, t, A;
              null === (e = this._ctx) ||
                ...
                e.clearRect(
                  0,
                  0,
                  (null === (t = this.canvas) || void 0 === t ? void 0 : t.width) || 0,
                  (null === (A = this.canvas) || void 0 === A ? void 0 : A.height) || 0
                );
            }
            draw(e, t, A, i, s = 1) {
              if (!this._ctx) return;
              const { width: r, height: n } = this.cellSize;
              if (-1 === r || -1 === n) return;
              this._rescaleImage(e, r, n);
              const o = e.actual,
                a = Math.ceil(o.width / r),
                h = (t % a) * r,
                g = Math.floor(t / a) * n,
                l = A * r,
                c = i * n,
                d = s * r + h > o.width ? o.width - h : s * r,
                I = g + n > o.height ? o.height - g : n;
              this._ctx.drawImage(
                o,
                Math.floor(h),
                Math.floor(g),
            ...
            extractTile(e, t) {
              const { width: A, height: i } = this.cellSize;
              if (-1 === A || -1 === i) return;
              this._rescaleImage(e, A, i);
              const s = e.actual,
                n = Math.ceil(s.width / A),
                o = (t % n) * A,
                a = Math.floor(t / n) * i,
                h = A + o > s.width ? s.width - o : A,
                g = a + i > s.height ? s.height - a : i,
                l = r.createCanvas(this.document, h, g),
                c = l.getContext('2d');
              return c
                ? (c.drawImage(
                    s,
            ...
            drawPlaceholder(e, t, A = 1) {
              if (this._ctx) {
                const { width: i, height: s } = this.cellSize;
                if (-1 === i || -1 === s) return;
                if (
                  (this._placeholder
                    ? s >= this._placeholder.height && this._createPlaceHolder(s + 1)
                    : this._createPlaceHolder(Math.max(s + 1, 24)),
                  !this._placeholder)
                )
                  return;
                this._ctx.drawImage(
            ...
            _rescaleImage(e, t, A) {
              if (t === e.actualCellSize.width && A === e.actualCellSize.height) return;
              const { width: i, height: s } = e.origCellSize;
              if (t === i && A === s)
                return ((e.actual = e.orig), (e.actualCellSize.width = i), void (e.actualCellSize.height = s));
              const n = r.createCanvas(
                  this.document,
                  Math.ceil((e.orig.width * t) / i),
                  Math.ceil((e.orig.height * A) / s)
                ),
                o = n.getContext('2d');
              o &&
                (o.drawImage(e.orig, 0, 0, n.width, n.height),
                (e.actual = n),
                (e.actualCellSize.width = t),
                (e.actualCellSize.height = A));
            }
            _open() {
              ((this._renderService = this._terminal._core._renderService),
                ...
                (this._renderService.setRenderer = (e) => {
                  var t;
                  (this.removeLayerFromDom(),
                    null === (t = this._oldSetRenderer) || void 0 === t || t.call(this._renderService, e));
                }));
            }
            insertLayerToDom() {
              var e, t;
              this.document && this._terminal._core.screenElement
                ? this.canvas ||
                  ((this.canvas = r.createCanvas(
                    this.document,
                    (null === (e = this.dimensions) || void 0 === e ? void 0 : e.css.canvas.width) || 0,
                    (null === (t = this.dimensions) || void 0 === t ? void 0 : t.css.canvas.height) || 0
                  )),
                  this.canvas.classList.add('xterm-image-layer'),
                  this._terminal._core.screenElement.appendChild(this.canvas),
                  (this._ctx = this.canvas.getContext('2d', { alpha: !0, desynchronized: !0 })),
                  this.clearAll())
            ...
            _createPlaceHolder(e = 24) {
              ...
              const A = 32,
                s = r.createCanvas(this.document, A, e),
                n = s.getContext('2d', { alpha: !1 });
              if (!n) return;
              const o = r.createImageData(n, A, e),
                a = new Uint32Array(o.data.buffer),
                h = (0, i.toRGBA8888)(0, 0, 0),
                g = (0, i.toRGBA8888)(255, 255, 255);
              a.fill(h);
              for (let t = 0; t < e; ++t) {
                const e = t % 2,
                  i = t * A;
                for (let t = 0; t < A; t += 2) a[i + t + e] = g;
              }
              n.putImageData(o, 0, 0);
              const l = (screen.width + A - 1) & -32 || 4096;
              this._placeholder = r.createCanvas(this.document, l, e);
              const c = this._placeholder.getContext('2d', { alpha: !1 });
              if (c) {
                for (let e = 0; e < l; e += A) c.drawImage(s, e, 0);
                r.createImageBitmap(this._placeholder).then((e) => (this._placeholderBitmap = e));
              } else this._placeholder = void 0;
            }
            get document() {
              var e;
              return null === (e = this._terminal._core._coreBrowserService) || void 0 === e
                ? void 0
                : e.window.document;
            }
          }
        ...
        699: (e, t, A) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }), (t.ImageStorage = t.CELL_SIZE_DEFAULT = void 0));
          const i = A(463);
          t.CELL_SIZE_DEFAULT = { width: 7, height: 14 };
          class s {
            get ext() {
          ...
          t.ImageStorage = class {
            ...
            _getStoredPixels() {
              let e = 0;
              for (const t of this._images.values())
                t.orig &&
                  ((e += t.orig.width * t.orig.height),
                  t.actual && t.actual !== t.orig && (e += t.actual.width * t.actual.height));
              return e;
            }
            _delImg(e) {
            ...
            wipeAlternate() {
              var e;
              const t = [];
              for (const [A, i] of this._images.entries())
                'alternate' === i.bufferType && (null === (e = i.marker) || void 0 === e || e.dispose(), t.push(A));
            ...
            advanceCursor(e) {
              if (this._opts.sixelScrolling) {
                ...
                (-1 !== A.width && -1 !== A.height) || (A = t.CELL_SIZE_DEFAULT);
                const i = Math.ceil(e / A.height);
                for (let e = 1; e < i; ++e) this._terminal._core._inputHandler.lineFeed();
              }
            }
            addImage(e) {
              var A;
              ...
              (-1 !== i.width && -1 !== i.height) || (i = t.CELL_SIZE_DEFAULT);
              const s = Math.ceil(e.width / i.width),
                r = Math.ceil(e.height / i.height),
                n = ++this._lastId,
                o = this._terminal._core.buffer,
                a = this._terminal.cols,
                h = this._terminal.rows,
                g = o.x,
                l = o.y;
              let c = g,
                d = 0;
              (this._opts.sixelScrolling || ((o.x = 0), (o.y = 0), (c = 0)),
                this._terminal._core._inputHandler._dirtyRowTracker.markDirty(o.y));
              for (let e = 0; e < r; ++e) {
                const t = o.lines.get(o.y + o.ybase);
                for (let A = 0; A < s && !(c + A >= a); ++A) (this._writeToCell(t, c + A, n, e * s + A), d++);
                if (this._opts.sixelScrolling) e < r - 1 && this._terminal._core._inputHandler.lineFeed();
                else if (++o.y >= h) break;
                o.x = c;
              }
              (this._terminal._core._inputHandler._dirtyRowTracker.markDirty(o.y),
                this._opts.sixelScrolling ? (o.x = c) : ((o.x = g), (o.y = l)));
              const I = [];
              for (const [e, t] of this._images.entries())
                t.tileCount < 1 && (null === (A = t.marker) || void 0 === A || A.dispose(), I.push(e));
              for (const e of I) this._delImg(e);
              const C = this._terminal.registerMarker(0);
              (null == C ||
                C.onDispose(() => {
              ...
              const u = {
                ...
                origCellSize: i,
                actual: e,
                actualCellSize: Object.assign({}, i),
                marker: C || void 0,
                tileCount: d,
                bufferType: this._terminal.buffer.active.type
              };
              this._images.set(n, u);
            }
            render(e) {
              if (
                !this._renderer.canvas &&
                this._images.size &&
                (this._renderer.insertLayerToDom(), !this._renderer.canvas)
              )
                return;
              if ((this._renderer.rescaleCanvas(), !this._images.size))
                return (
                  this._fullyCleared ||
                    (this._renderer.clearAll(), (this._fullyCleared = !0), (this._needsFullClear = !1)),
                  void (this._renderer.canvas && this._renderer.removeLayerFromDom())
                );
              this._needsFullClear &&
                (this._renderer.clearAll(), (this._fullyCleared = !0), (this._needsFullClear = !1));
              const { start: t, end: A } = e,
                i = this._terminal._core.buffer,
                s = this._terminal._core.cols;
              this._renderer.clearLines(t, A);
              for (let e = t; e <= A; ++e) {
                const t = i.lines.get(e + i.ydisp);
                if (!t) return;
                for (let A = 0; A < s; ++A)
                  if (268435456 & t.getBg(A)) {
                    let i = t._extendedAttrs[A] || r;
                    const n = i.imageId;
                    if (void 0 === n || -1 === n) continue;
                    const o = this._images.get(n);
                    if (-1 !== i.tileId) {
                      const a = i.tileId,
                        h = A;
                      let g = 1;
                      ...
                      (A--,
                        o
                          ? o.actual && this._renderer.draw(o, a, h, e, g)
                          : this._opts.showPlaceholder && this._renderer.drawPlaceholder(h, e, g),
                        (this._fullyCleared = !1));
                    }
                  }
              }
            ...
            viewportResize(e) {
              ...
              const A = this._terminal._core.buffer,
                i = A.lines.length,
                s = this._viewportMetrics.cols - 1;
              for (let n = 0; n < i; ++n) {
                const i = A.lines.get(n);
                if (268435456 & i.getBg(s)) {
                  const A = i._extendedAttrs[s] || r,
                    n = A.imageId;
                  if (void 0 === n || -1 === n) continue;
                  const o = this._images.get(n);
                  if (!o) continue;
                  const a = Math.ceil(
                    ((null === (t = o.actual) || void 0 === t ? void 0 : t.width) || 0) / o.actualCellSize.width
                  );
                  if ((A.tileId % a) + 1 >= a) continue;
                  let h = !1;
                  for (let t = s + 1; t > e.cols; ++t)
                    if (4194303 & i._data[3 * t + 0]) {
                      h = !0;
                      break;
                    }
                  if (h) continue;
                  const g = Math.min(e.cols, a - (A.tileId % a) + s);
                  let l = A.tileId;
                  for (let e = s + 1; e < g; ++e) (this._writeToCell(i, e, n, ++l), o.tileCount++);
                }
              }
            ...
            getImageAtBufferCell(e, t) {
              var A, s;
              const n = this._terminal._core.buffer.lines.get(t);
              if (n && 268435456 & n.getBg(e)) {
                const t = n._extendedAttrs[e] || r;
                if (t.imageId && -1 !== t.imageId) {
                  const e = null === (A = this._images.get(t.imageId)) || void 0 === A ? void 0 : A.orig;
                  if (window.ImageBitmap && e instanceof ImageBitmap) {
                    const t = i.ImageRenderer.createCanvas(window.document, e.width, e.height);
                    return (
                      null === (s = t.getContext('2d')) || void 0 === s || s.drawImage(e, 0, 0, e.width, e.height),
                      t
                    );
                  }
                  return e;
            ...
            extractTileAtBufferCell(e, t) {
              const A = this._terminal._core.buffer.lines.get(t);
              if (A && 268435456 & A.getBg(e)) {
                const t = A._extendedAttrs[e] || r;
            ...
            _evictOldest(e) {
              var t;
              const A = this._getStoredPixels();
              let i = A;
              for (; this._pixelLimit < i + e && this._images.size; ) {
                const e = this._images.get(++this._lowestId);
                e &&
                  e.orig &&
                  ((i -= e.orig.width * e.orig.height),
                  e.actual && e.orig !== e.actual && (i -= e.actual.width * e.actual.height),
                  null === (t = e.marker) || void 0 === t || t.dispose(),
                  this._delImg(this._lowestId));
              }
              return A - i;
            }
            _writeToCell(e, t, A, i) {
              if (268435456 & e._data[3 * t + 2]) {
                const r = e._extendedAttrs[t];
                if (r) {
                  if (void 0 !== r.imageId) {
                    const e = this._images.get(r.imageId);
                    return (e && e.tileCount--, (r.imageId = A), void (r.tileId = i));
                  }
                  return void (e._extendedAttrs[t] = new s(r.ext, r.urlId, A, i));
                }
              }
              ((e._data[3 * t + 2] |= 268435456), (e._extendedAttrs[t] = new s(0, 0, A, i)));
            }
            _evictOnAlternate() {
              var e, t;
              ...
              for (let t = 0; t < this._terminal.rows; ++t) {
                const i = A.lines.get(t);
                if (i)
                  for (let t = 0; t < this._terminal.cols; ++t)
                    if (268435456 & i._data[3 * t + 2]) {
                      const A = null === (e = i._extendedAttrs[t]) || void 0 === e ? void 0 : e.imageId;
                      if (A) {
                        const e = this._images.get(A);
                        e && e.tileCount++;
                      }
                    }
              }
              const i = [];
              for (const [e, A] of this._images.entries())
                'alternate' !== A.bufferType ||
                  A.tileCount ||
                  (null === (t = A.marker) || void 0 === t || t.dispose(), i.push(e));
              for (const e of i) this._delImg(e);
            }
          };
        },
        566: (e, t, A) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }), (t.SixelHandler = void 0));
          const i = A(939),
            s = A(463),
            r = A(591),
            n = i.PALETTE_ANSI_256;
          function o(e) {
            return i.BIG_ENDIAN
              ? e
              : ((255 & e) << 24) | (((e >>> 8) & 255) << 16) | (((e >>> 16) & 255) << 8) | ((e >>> 24) & 255);
          }
          (n.set(i.PALETTE_VT340_COLOR),
            (t.SixelHandler = class {
              constructor(e, t, A) {
                ((this._opts = e),
                  (this._storage = t),
              ...
              reset() {
                this._dec &&
                  (this._dec.release(), this._dec._palette.fill(0), this._dec.init(0, n, this._opts.sixelPaletteLimit));
              }
              hook(e) {
                var t;
                  ...
                  const A =
                    1 === e.params[1]
                      ...
                      : (function (e, t) {
                          ...
                          if (!t) return A;
                          if (e.isInverse())
                            if (e.isFgDefault()) A = o(t.foreground.rgba);
                            else if (e.isFgRGB()) {
                              const t = e.constructor.toColorRGB(e.getFgColor());
                              A = (0, i.toRGBA8888)(...t);
                            } else A = o(t.ansi[e.getFgColor()].rgba);
                          else if (e.isBgDefault()) A = o(t.background.rgba);
                          else if (e.isBgRGB()) {
                            const t = e.constructor.toColorRGB(e.getBgColor());
                            A = (0, i.toRGBA8888)(...t);
                          } else A = o(t.ansi[e.getBgColor()].rgba);
                          return A;
                        })(
                          this._coreTerminal._core._inputHandler._curAttrData,
                          null === (t = this._coreTerminal._core._themeService) || void 0 === t ? void 0 : t.colors
                        );
                  this._dec.init(A, null, this._opts.sixelPaletteLimit);
                }
              }
              put(e, t, A) {
                if (!this._aborted && this._dec) {
                  if (((this._size += A - t), this._size > this._opts.sixelSizeLimit))
                    return (
                      console.warn('SIXEL: too much data, aborting'),
                      (this._aborted = !0),
                      void this._dec.release()
                    );
                  try {
                    this._dec.decode(e, t, A);
                  } catch (e) {
              ...
              unhook(e) {
                ...
                const A = this._dec.width,
                  i = this._dec.height;
                if (!A || !i) return (i && this._storage.advanceCursor(i), !0);
                const r = s.ImageRenderer.createCanvas(void 0, A, i);
                return (
                  null === (t = r.getContext('2d')) ||
                    void 0 === t ||
                    t.putImageData(new ImageData(this._dec.data8, A, i), 0, 0),
                  this._dec.memoryUsage > 4194304 && this._dec.release(),
                  this._storage.addImage(r),
                  !0
                );
              }
            }));
        ...
        732: (e, t, A) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            ...
            (t.equals = function (e, t, A = (e, t) => e === t) {
              if (e === t) return !0;
              if (!e || !t) return !1;
              if (e.length !== t.length) return !1;
              for (let i = 0, s = e.length; i < s; i++) if (!A(e[i], t[i])) return !1;
              return !0;
            }),
            ...
            (t.binarySearch = function (e, t, A) {
              return r(e.length, (i) => A(e[i], t));
            }),
            (t.binarySearch2 = r),
            (t.quickSelect = function e(t, A, i) {
              if ((t |= 0) >= A.length) throw new TypeError('invalid index');
              const s = A[Math.floor(A.length * Math.random())],
                r = [],
                n = [],
                o = [];
              for (const e of A) {
                const t = i(e, s);
                t < 0 ? r.push(e) : t > 0 ? n.push(e) : o.push(e);
              }
              return t < r.length ? e(t, r, i) : t < r.length + o.length ? o[0] : e(t - (r.length + o.length), n, i);
            }),
            (t.groupBy = function (e, t) {
              const A = [];
              let i;
              for (const s of e.slice(0).sort(t)) i && 0 === t(i[0], s) ? i.push(s) : ((i = [s]), A.push(i));
              return A;
            }),
            (t.groupAdjacentBy = function* (e, t) {
              let A, i;
              for (const s of e) (void 0 !== i && t(i, s) ? A.push(s) : (A && (yield A), (A = [s])), (i = s));
              A && (yield A);
            }),
            (t.forEachAdjacent = function (e, t) {
              for (let A = 0; A <= e.length; A++) t(0 === A ? void 0 : e[A - 1], A === e.length ? void 0 : e[A]);
            }),
            (t.forEachWithNeighbors = function (e, t) {
              for (let A = 0; A < e.length; A++)
                t(0 === A ? void 0 : e[A - 1], e[A], A + 1 === e.length ? void 0 : e[A + 1]);
            }),
            (t.sortedDiff = n),
            (t.delta = function (e, t, A) {
              const i = n(e, t, A),
                s = [],
                r = [];
              for (const t of i) (s.push(...e.slice(t.start, t.start + t.deleteCount)), r.push(...t.toInsert));
              return { removed: s, added: r };
            }),
            (t.top = function (e, t, A) {
              if (0 === A) return [];
              const i = e.slice(0, A).sort(t);
              return (o(e, t, i, A, e.length), i);
            }),
            (t.topAsync = function (e, t, A, s, r) {
              return 0 === A
                ? Promise.resolve([])
                : new Promise((n, a) => {
                    (async () => {
                      const n = e.length,
                        a = e.slice(0, A).sort(t);
                      for (let h = A, g = Math.min(A + s, n); h < n; h = g, g = Math.min(g + s, n)) {
                        if ((h > A && (await new Promise((e) => setTimeout(e))), r && r.isCancellationRequested))
            ...
            (t.coalesceInPlace = function (e) {
              let t = 0;
              for (let A = 0; A < e.length; A++) e[A] && ((e[t] = e[A]), (t += 1));
              e.length = t;
            }),
            (t.move = function (e, t, A) {
              e.splice(A, 0, e.splice(t, 1)[0]);
            }),
            ...
            (t.commonPrefixLength = function (e, t, A = (e, t) => e === t) {
              let i = 0;
              for (let s = 0, r = Math.min(e.length, t.length); s < r && A(e[s], t[s]); s++) i++;
              return i;
            }),
            (t.range = function (e, t) {
              let A = 'number' == typeof t ? e : 0;
              'number' == typeof t ? (A = e) : ((A = 0), (t = e));
              const i = [];
              if (A <= t) for (let e = A; e < t; e++) i.push(e);
              else for (let e = A; e > t; e--) i.push(e);
              return i;
            }),
            (t.index = function (e, t, A) {
              return e.reduce((e, i) => ((e[t(i)] = A ? A(i) : i), e), Object.create(null));
            }),
            (t.insert = function (e, t) {
              return (e.push(t), () => a(e, t));
            }),
            (t.remove = a),
            (t.arrayInsert = function (e, t, A) {
              const i = e.slice(0, t),
                s = e.slice(t);
              return i.concat(A, s);
            }),
            ...
            (t.insertInto = h),
            (t.splice = function (e, t, A, i) {
              const s = g(e, t);
              let r = e.splice(s, A);
              return (void 0 === r && (r = []), h(e, s, i), r);
            }),
            (t.compareBy = function (e, t) {
              return (A, i) => t(e(A), e(i));
            }),
            (t.tieBreakComparators = function (...e) {
              return (t, A) => {
                for (const i of e) {
                  const e = i(t, A);
                  if (!l.isNeitherLessOrGreaterThan(e)) return e;
                }
                return l.neitherLessOrGreaterThan;
              };
            }),
          ...
          function n(e, t, A) {
            const i = [];
            function s(e, t, A) {
              if (0 === t && 0 === A.length) return;
              const s = i[i.length - 1];
              s && s.start + s.deleteCount === e
                ? ((s.deleteCount += t), s.toInsert.push(...A))
                : i.push({ start: e, deleteCount: t, toInsert: A });
            }
            let r = 0,
              n = 0;
            for (;;) {
              ...
              const i = e[r],
                o = t[n],
                a = A(i, o);
              0 === a ? ((r += 1), (n += 1)) : a < 0 ? (s(r, 1, []), (r += 1)) : a > 0 && (s(r, 0, [o]), (n += 1));
            }
            return i;
          }
          function o(e, t, A, i, r) {
            for (const n = A.length; i < r; i++) {
              const r = e[i];
              if (t(r, A[n - 1]) < 0) {
                A.pop();
                const e = (0, s.findFirstIdxMonotonousOrArrLen)(A, (e) => t(r, e) < 0);
                A.splice(e, 0, r);
              }
            }
          }
          ...
          function h(e, t, A) {
            const i = g(e, t),
              ...
              r = A.length;
            e.length = s + r;
            for (let t = s - 1; t >= i; t--) e[t + r] = e[t];
            for (let t = 0; t < r; t++) e[t + i] = A[t];
          }
          function g(e, t) {
          ...
          (!(function (e) {
            ...
            (t.booleanComparator = (e, A) => (0, t.numberComparator)(e ? 1 : 0, A ? 1 : 0)),
            (t.ArrayQueue = class {
              constructor(e) {
              ...
              takeWhile(e) {
                ...
                const A = t === this.firstIdx ? null : this.items.slice(this.firstIdx, t);
                return ((this.firstIdx = t), A);
              }
              takeFromEndWhile(e) {
                let t = this.lastIdx;
                for (; t >= 0 && e(this.items[t]); ) t--;
                const A = t === this.lastIdx ? null : this.items.slice(t + 1, this.lastIdx + 1);
                return ((this.lastIdx = t), A);
              }
              peek() {
          ...
          class c {
            ...
            filter(e) {
              return new c((t) => this.iterate((A) => !e(A) || t(A)));
            }
            map(e) {
              return new c((t) => this.iterate((A) => t(e(A))));
            }
            some(e) {
              let t = !1;
              return (this.iterate((A) => ((t = e(A)), !t)), t);
            }
            findFirst(e) {
              let t;
              return (this.iterate((A) => !e(A) || ((t = A), !1)), t);
            }
            findLast(e) {
              let t;
              return (this.iterate((A) => (e(A) && (t = A), !0)), t);
            }
            findLastMaxBy(e) {
              let t,
                A = !0;
              return (this.iterate((i) => ((A || l.isGreaterThan(e(i, t))) && ((A = !1), (t = i)), !0)), t);
            }
          }
          t.CallbackIterable = c;
          class d {
            constructor(e) {
              this._indexMap = e;
            }
            static createSortPermutation(e, t) {
              const A = Array.from(e.keys()).sort((A, i) => t(e[A], e[i]));
              return new d(A);
            }
            apply(e) {
              return e.map((t, A) => e[this._indexMap[A]]);
            }
            inverse() {
        ...
        411: (e, t) => {
          function A(e, t, A = e.length - 1) {
            for (let i = A; i >= 0; i--) if (t(e[i])) return i;
            return -1;
          }
          function i(e, t, A = 0, i = e.length) {
            let s = A,
              r = i;
            for (; s < r; ) {
          ...
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.MonotonousArray = void 0),
            (t.findLast = function (e, t) {
              const i = A(e, t);
              if (-1 !== i) return e[i];
            }),
            (t.findLastIdx = A),
            (t.findLastMonotonous = function (e, t) {
              const A = i(e, t);
              return -1 === A ? void 0 : e[A];
            }),
            (t.findLastIdxMonotonous = i),
            (t.findFirstMonotonous = function (e, t) {
              const A = s(e, t);
              return A === e.length ? void 0 : e[A];
            }),
            (t.findFirstIdxMonotonousOrArrLen = s),
            (t.findFirstIdxMonotonous = function (e, t, A = 0, i = e.length) {
              const r = s(e, t, A, i);
              return r === e.length ? -1 : r;
            }),
            (t.findFirstMax = n),
            (t.findLastMax = function (e, t) {
            ...
            (t.findFirstMin = function (e, t) {
              return n(e, (e, A) => -t(e, A));
            }),
            (t.findMaxIdx = function (e, t) {
              if (0 === e.length) return -1;
              let A = 0;
              for (let i = 1; i < e.length; i++) t(e[i], e[A]) > 0 && (A = i);
              return A;
            }),
        ...
        33: (e, t) => {
          ...
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            ...
            (t.diffSets = function (e, t) {
              const A = [],
                i = [];
              for (const i of e) t.has(i) || A.push(i);
              for (const A of t) e.has(A) || i.push(A);
              return { removed: A, added: i };
            }),
            (t.diffMaps = function (e, t) {
              const A = [],
                i = [];
              for (const [i, s] of e) t.has(i) || A.push(s);
              for (const [A, s] of t) e.has(A) || i.push(s);
              return { removed: A, added: i };
            }),
            (t.intersection = function (e, t) {
              const A = new Set();
              for (const i of t) e.has(i) && A.add(i);
              return A;
            }));
          class i {
            static {
            ...
            constructor(e, t) {
              ((this.toKey = t), (this._map = new Map()), (this[A] = 'SetWithKey'));
            ...
            *values() {
            ...
            forEach(e, t) {
              this._map.forEach((A) => e.call(t, A, A, this));
            }
            [Symbol.iterator]() {
              return this.values();
            }
        ...
        577: (e, t) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            ...
            (t.transformErrorForSerialization = function (e) {
              if (e instanceof Error) {
                const { name: t, message: A } = e;
                return {
                  $isError: !0,
                  name: t,
                  message: A,
                  stack: e.stacktrace || e.stack,
                  noTelemetry: g.isErrorNoTelemetry(e)
                };
              }
              return e;
            }),
            (t.transformErrorFromSerialization = function (e) {
              let t;
              return (
                e.noTelemetry ? (t = new g()) : ((t = new Error()), (t.name = e.name)),
                (t.message = e.message),
                (t.stack = e.stack),
                t
              );
            }),
            (t.isCancellationError = s),
            (t.canceled = function () {
              const e = new Error(i);
            ...
            constructor() {
              ((this.listeners = []),
                (this.unexpectedErrorHandler = function (e) {
                  setTimeout(() => {
                    if (e.stack) {
                      if (g.isErrorNoTelemetry(e)) throw new g(e.message + '\n\n' + e.stack);
          ...
          ((t.ErrorHandler = A), (t.errorHandler = new A()));
          const i = 'Canceled';
          function s(e) {
            return e instanceof r || (e instanceof Error && e.name === i && e.message === i);
          }
          ...
          t.NotImplementedError = o;
          class a extends Error {
            constructor(e) {
              (super('NotSupported'), e && (this.message = e));
            }
          }
          t.NotSupportedError = a;
          ...
          t.ErrorNoTelemetry = g;
          class l extends Error {
            constructor(e) {
              (super(e || 'An unexpected bug occurred.'), Object.setPrototypeOf(this, l.prototype));
            }
          }
          t.BugIndicatingError = l;
        },
        355: (e, t) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.createSingleCallFunction = function (e, t) {
              const A = this;
              let i,
                s = !1;
              return function () {
                ...
                if (((s = !0), t))
                  try {
                    i = e.apply(A, arguments);
                  } finally {
                    t();
                  }
                else i = e.apply(A, arguments);
                return i;
              };
            }));
        },
          ...
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            ...
            (function (e) {
              ...
              ((e.empty = function () {
                ...
                (e.some = function (e, t) {
                  let A = 0;
                  for (const i of e) if (t(i, A++)) return !0;
                  return !1;
                }),
                (e.find = function (e, t) {
                ...
                (e.filter = function* (e, t) {
                  for (const A of e) t(A) && (yield A);
                }),
                (e.map = function* (e, t) {
                  let A = 0;
                  for (const i of e) yield t(i, A++);
                }),
                ...
                (e.reduce = function (e, t, A) {
                  let i = A;
                  for (const A of e) i = t(i, A);
                  return i;
                }),
                (e.slice = function* (e, t, A = e.length) {
                  for (t < 0 && (t += e.length), A < 0 ? (A += e.length) : A > e.length && (A = e.length); t < A; t++)
                    yield e[t];
                }),
                (e.consume = function (t, A = Number.POSITIVE_INFINITY) {
                  const i = [];
                  if (0 === A) return [i, t];
        ...
        540: (e, t, A) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.DisposableMap =
              t.ImmortalReference =
              t.AsyncReferenceCollection =
              t.ReferenceCollection =
              t.SafeDisposable =
              t.RefCountedDisposable =
              t.MandatoryMutableDisposable =
              t.MutableDisposable =
              t.Disposable =
              t.DisposableStore =
              t.DisposableTracker =
            ...
            (t.markAsSingleton = function (e) {
              return (a?.markAsSingleton(e), e);
            }),
            (t.isDisposable = d),
            (t.dispose = I),
            (t.disposeIfDisposable = function (e) {
              for (const t of e) d(t) && t.dispose();
              return [];
            }),
            (t.combinedDisposable = function (...e) {
              ...
              return (
                (function (e, t) {
                  if (a) for (const A of e) a.setParent(A, t);
                })(e, t),
                t
              );
            }),
            (t.toDisposable = C),
            (t.disposeOnReturn = function (e) {
              const t = new u();
              try {
                e(t);
              } finally {
          ...
          class h {
            ...
            getDisposableData(e) {
              ...
              return (
                t ||
                  ((t = { parent: null, source: null, isSingleton: !1, value: e, idx: h.idx++ }),
            ...
            getTrackedDisposables() {
              ...
              return [...this.livingDisposables.entries()]
                .filter(([, t]) => null !== t.source && !this.getRootParent(t, e).isSingleton)
                .flatMap(([e]) => e);
            }
            computeLeakingDisposables(e = 10, t) {
              ...
              if (t) A = t;
                ...
                const e = new Map(),
                  t = [...this.livingDisposables.values()].filter(
                    (t) => null !== t.source && !this.getRootParent(t, e).isSingleton
                  );
                if (0 === t.length) return;
                const i = new Set(t.map((e) => e.value));
                if (((A = t.filter((e) => !(e.parent && i.has(e.parent)))), 0 === A.length))
              ...
              function n(e) {
                ...
                return (
                  (function (e, t) {
                    for (; e.length > 0 && t.some((t) => ('string' == typeof t ? t === e[0] : e[0].match(t))); )
                      e.shift();
                  })(t, ['Error', /^trackDisposable \(.*\)$/, /^DisposableTracker.trackDisposable \(.*\)$/]),
                  t.reverse()
                );
              }
              const o = new r.SetMap();
              for (const e of A) {
                const t = n(e);
                for (let A = 0; A <= t.length; A++) o.add(t.slice(0, A).join('\n'), e);
              }
              A.sort((0, i.compareBy)((e) => e.idx, i.numberComparator));
              let a = '',
                h = 0;
              for (const t of A.slice(0, e)) {
                h++;
                const e = n(t),
                  i = [];
                for (let t = 0; t < e.length; t++) {
                  let r = e[t];
                  r = `(shared with ${o.get(e.slice(0, t + 1).join('\n')).size}/${A.length} leaks) at ${r}`;
                  const a = o.get(e.slice(0, t).join('\n')),
                    h = (0, s.groupBy)(
                      [...a].map((e) => n(e)[t]),
                      (e) => e
                    );
          ...
          class u {
            ...
            deleteAndLeak(e) {
              e && this._toDispose.has(e) && (this._toDispose.delete(e), c(e, null));
            }
          }
          t.DisposableStore = u;
          class B {
            ...
            constructor() {
              ((this._store = new u()), g(this), c(this._store, this));
            }
            dispose() {
          ...
          class Q {
            ...
            set value(e) {
              this._isDisposed || e === this._value || (this._value?.dispose(), e && c(e, this), (this._value = e));
            }
            clear() {
              this.value = void 0;
            }
            dispose() {
              ((this._isDisposed = !0), l(this), this._value?.dispose(), (this._value = void 0));
            }
            clearAndLeak() {
              const e = this._value;
              return ((this._value = void 0), e && c(e, null), e);
            }
          }
          ((t.MutableDisposable = Q),
            (t.MandatoryMutableDisposable = class {
              constructor(e) {
                ((this._disposable = new Q()), (this._isDisposed = !1), (this._disposable.value = e));
              }
              get value() {
            ...
            (t.SafeDisposable = class {
              constructor() {
                ((this.dispose = () => {}), (this.unset = () => {}), (this.isset = () => !1), g(this));
              }
              set(e) {
                let t = e;
                return (
            ...
            (t.ReferenceCollection = class {
              ...
              acquire(e, ...t) {
                let A = this.references.get(e);
                A || ((A = { counter: 0, object: this.createReferencedObject(e, ...t) }), this.references.set(e, A));
                const { object: i } = A,
                  s = (0, n.createSingleCallFunction)(() => {
                    0 == --A.counter && (this.destroyReferencedObject(e, A.object), this.references.delete(e));
                  });
                return (A.counter++, { object: i, dispose: s });
              }
            }),
            (t.AsyncReferenceCollection = class {
              ...
              async acquire(e, ...t) {
                const A = this.referenceCollection.acquire(e, ...t);
                try {
                  return { object: await A.object, dispose: () => A.dispose() };
                } catch (e) {
                  throw (A.dispose(), e);
                }
              }
          ...
          class _ {
            constructor() {
              ((this._store = new Map()), (this._isDisposed = !1), g(this));
            }
            dispose() {
              (l(this), (this._isDisposed = !0), this.clearAndDisposeAll());
            }
            clearAndDisposeAll() {
              if (this._store.size)
                try {
                  I(this._store.values());
                } finally {
                  this._store.clear();
                }
            }
        ...
        714: (e, t) => {
          var A;
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.SetMap = t.BidirectionalMap = t.CounterSet = t.Touch = void 0),
            (t.getOrSet = function (e, t, A) {
              let i = e.get(t);
              return (void 0 === i && ((i = A), e.set(t, i)), i);
            }),
            ...
            (t.mapsStrictEqualIgnoreOrder = function (e, t) {
              ...
              for (const [A, i] of e) if (!t.has(A) || t.get(A) !== i) return !1;
              for (const [A] of t) if (!e.has(A)) return !1;
              return !0;
            }),
            (function (e) {
            ...
            (t.BidirectionalMap = class {
              constructor(e) {
                if (((this._m1 = new Map()), (this._m2 = new Map()), e)) for (const [t, A] of e) this.set(t, A);
              }
              clear() {
            ...
            (t.SetMap = class {
              ...
              add(e, t) {
                ...
                (A || ((A = new Set()), this.map.set(e, A)), A.add(t));
              }
              delete(e, t) {
                const A = this.map.get(e);
                A && (A.delete(t), 0 === A.size && this.map.delete(e));
              }
              forEach(e, t) {
                const A = this.map.get(e);
                A && A.forEach(t);
        ...
        669: (e, t, A) => {
          ...
          const i = (0, A(65).InWasm)({
            ...
            s = new Uint8Array(
              'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.split('').map((e) => e.charCodeAt(0))
            ),
            r = new Uint32Array(1024);
          r.fill(4278190080);
          for (let e = 0; e < s.length; ++e) r[s[e]] = e << 2;
          for (let e = 0; e < s.length; ++e) r[256 + s[e]] = (e >> 4) | (((e << 4) & 255) << 8);
          for (let e = 0; e < s.length; ++e) r[512 + s[e]] = ((e >> 2) << 8) | (((e << 6) & 255) << 16);
          for (let e = 0; e < s.length; ++e) r[768 + s[e]] = e << 16;
          ...
          t.default = class {
            ...
            get data8() {
              return this._inst ? this._d.subarray(0, this._m32[1282]) : n;
            }
            release() {
              this._inst &&
                (this._mem.buffer.byteLength > this.keepSize
                  ? (this._inst = this._m32 = this._d = this._mem = null)
                  : ((this._m32[1280] = 0), (this._m32[1281] = 0), (this._m32[1282] = 0)));
            }
            init(e) {
              let t = this._m32;
              const A = 4 * (Math.ceil(e / 3) + 1288);
              (this._inst
                ? this._mem.buffer.byteLength < A &&
                  (this._mem.grow(Math.ceil((A - this._mem.buffer.byteLength) / 65536)),
                  (t = new Uint32Array(this._mem.buffer, 0)),
                  (this._d = new Uint8Array(this._mem.buffer, 5152)))
                : ((this._mem = new WebAssembly.Memory({ initial: Math.ceil(A / 65536) })),
                  (this._inst = i({ env: { memory: this._mem } })),
                  (t = new Uint32Array(this._mem.buffer, 0)),
                  t.set(r, 256),
                  (this._d = new Uint8Array(this._mem.buffer, 5152))),
                (t[1284] = e),
                (t[1283] = 4 * Math.ceil(e / 3)),
                (t[1280] = 0),
                (t[1281] = 0),
                (t[1282] = 0),
                (this._m32 = t));
            ...
            put(e, t, A) {
              ...
              const i = this._m32;
              return A - t + i[1280] > i[1283]
                ? 1
                : (this._d.set(e.subarray(t, A), i[1280]),
                  (i[1280] += A - t),
                  i[1280] - i[1281] >= 131072 ? this._inst.exports.dec() : 0);
            }
            end() {
    ...
    return (
      (() => {
        var e = i;
        (Object.defineProperty(e, '__esModule', { value: !0 }), (e.ImageAddon = void 0));
        const t = A(795),
          s = A(463),
          r = A(699),
          n = A(566),
        ...
        e.ImageAddon = class {
          constructor(e) {
            ((this._disposables = []),
              ...
              (this._defaultOpts = Object.assign({}, o, e)));
          }
          dispose() {
          ...
          activate(e) {
            if (
              ((this._terminal = e),
              (this._renderer = new s.ImageRenderer(e)),
              (this._storage = new r.ImageStorage(e, this._renderer, this._opts)),
              this._opts.enableSizeReports)
            ) {
              const t = e.options.windowOptions || {};
              ((t.getWinSizePixels = !0),
                (t.getCellSizePixels = !0),
                (t.getWinSizeChars = !0),
                (e.options.windowOptions = t));
            }
            if (
              (this._disposeLater(
                this._renderer,
                this._storage,
                e.parser.registerCsiHandler({ prefix: '?', final: 'h' }, (e) => this._decset(e)),
                e.parser.registerCsiHandler({ prefix: '?', final: 'l' }, (e) => this._decrst(e)),
                e.parser.registerCsiHandler({ final: 'c' }, (e) => this._da1(e)),
                e.parser.registerCsiHandler({ prefix: '?', final: 'S' }, (e) => this._xtermGraphicsAttributes(e)),
                e.onRender((e) => {
                  var t;
                  return null === (t = this._storage) || void 0 === t ? void 0 : t.render(e);
                }),
                e.parser.registerCsiHandler({ intermediates: '!', final: 'p' }, () => this.reset()),
                e.parser.registerEscHandler({ final: 'c' }, () => this.reset()),
                e._core._inputHandler.onRequestReset(() => this.reset()),
                e.buffer.onBufferChange(() => {
                  var e;
              ...
              const t = new n.SixelHandler(this._opts, this._storage, e);
              (this._handlers.set('sixel', t),
                this._disposeLater(e._core._inputHandler._parser.registerDcsHandler({ final: 'q' }, t)));
            }
            if (this._opts.iipSupport) {
              const A = new t.IIPHandler(this._opts, this._renderer, this._storage, e);
              (this._handlers.set('iip', A),
                this._disposeLater(e._core._inputHandler._parser.registerOscHandler(1337, A)));
            }
          }
          reset() {
            var e;
            ((this._opts.sixelScrolling = this._defaultOpts.sixelScrolling),
              ...
              null === (e = this._storage) || void 0 === e || e.reset());
          ...
          getImageAtBufferCell(e, t) {
            var A;
            return null === (A = this._storage) || void 0 === A ? void 0 : A.getImageAtBufferCell(e, t);
          }
          extractTileAtBufferCell(e, t) {
            var A;
            return null === (A = this._storage) || void 0 === A ? void 0 : A.extractTileAtBufferCell(e, t);
          }
          _report(e) {
            var t;
          ...
          _xtermGraphicsAttributes(e) {
            ...
            if (1 === e[0])
              switch (e[1]) {
                ...
                case 2:
                  ((this._opts.sixelPaletteLimit = this._defaultOpts.sixelPaletteLimit),
                    this._report(`[?${e[0]};0;${this._opts.sixelPaletteLimit}S`));
                  for (const e of this._handlers.values()) e.reset();
                  return !0;
                case 3:
                  return (
                    e.length > 2 && !(e[2] instanceof Array) && e[2] <= 4096
                      ? ((this._opts.sixelPaletteLimit = e[2]),
                        this._report(`[?${e[0]};0;${this._opts.sixelPaletteLimit}S`))
                      : this._report(`[?${e[0]};2S`),
                    !0
                  );
            ...
            if (2 === e[0])
              switch (e[1]) {
                case 1:
                  let a =
                      null === (A = null === (t = this._renderer) || void 0 === t ? void 0 : t.dimensions) ||
                      void 0 === A
                        ? void 0
                        : A.css.canvas.width,
                    h =
                      null === (s = null === (i = this._renderer) || void 0 === i ? void 0 : i.dimensions) ||
                      void 0 === s
                        ? void 0
                        : s.css.canvas.height;
                  if (!a || !h) {
                    const e = r.CELL_SIZE_DEFAULT;
                    ((a = ((null === (n = this._terminal) || void 0 === n ? void 0 : n.cols) || 80) * e.width),
                      (h = ((null === (o = this._terminal) || void 0 === o ? void 0 : o.rows) || 24) * e.height));
                  }
                  if (a * h < this._opts.pixelLimit) this._report(`[?${e[0]};0;${a.toFixed(0)};${h.toFixed(0)}S`);
                  else {
                  ...
                  return !0;
                case 4:
                  const g = Math.floor(Math.sqrt(this._opts.pixelLimit));
                  return (this._report(`[?${e[0]};0;${g};${g}S`), !0);
                default:
                  return (this._report(`[?${e[0]};2S`), !0);
              }
