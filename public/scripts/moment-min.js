!(function (e, a) {
  ...
  function G(e) {
    if (null == e._isValid) {
      ...
      if (
        (e._strict && (t = t && 0 === a.charsLeftOver && 0 === a.unusedTokens.length && void 0 === a.bigHour),
  ...
  function se(e, a) {
    ...
    for (t in a)
      l(a, t) &&
        (z(e[t]) && z(a[t]) ? ((s[t] = {}), I(s[t], e[t]), I(s[t], a[t])) : null != a[t] ? (s[t] = a[t]) : delete s[t]);
        ...
        (oe[a] =
          ...
          (function (s) {
            for (var e, n = s.match(ie), a = 0, r = n.length; a < r; a++)
              me[n[a]]
                ? (n[a] = me[n[a]])
                : (n[a] = (e = n[a]).match(/\[[\s\S]/) ? e.replace(/^\[|\]$/g, '') : e.replace(/\\/g, ''));
            return function (e) {
  ...
  function fe(e, a, t) {
    e.isValid() &&
      ...
      ('FullYear' === a && Le(e.year()) && 1 === e.month() && 29 === e.date()
        ? ((t = m(t)), e._d['set' + (e._isUTC ? 'UTC' : '') + a](t, e.month(), ze(t, e.month())))
  ...
  function qe(e, a, t, s, n, r, d) {
    ...
    return (
      e < 100 && 0 <= e
        ? ((i = new Date(e + 400, a, t, s, n, r, d)), isFinite(i.getFullYear()) && i.setFullYear(e))
          ...
          e._w &&
            ...
            d < 1 || d > ea(r, _, o)
              ...
              : null != m
                ...
                : ((u = Qe(r, d, i, _, o)), (s._a[g] = u.year), (s._dayOfYear = u.dayOfYear))),
          null != e._dayOfYear &&
            ((n = Oa(e._a[g], t[g])),
  ...
  function Aa(e) {
    if (e._f === M.ISO_8601) ja(e);
      ...
      for (
        ...
        ((t = o[u]),
          (a = (d.match(Se(t, e)) || [])[0]) &&
            (0 < (s = d.substr(0, d.indexOf(a))).length && h(e).unusedInput.push(s),
            ...
            null !== (a = Sa.exec(t._i))
              ...
              : (ja(t),
                !1 === t._isValid &&
                  ...
                  Pa(t),
                  !1 === t._isValid &&
                    (delete t._isValid, t._strict ? (t._isValid = !1) : M.createFromInputFallback(t)))))
          : F(r)
  ...
  function Ga(e, a) {
    ...
    return null === a
      ? null
      : 0 === (a = 60 * (e = ((a[a.length - 1] || []) + '').match(Ua) || ['-', 0, 0])[1] + m(e[2]))
        ? 0
        : '+' === e[0]
          ? a
          : -a;
                ...
                : 'object' == typeof s &&
                  ...
                  ((a = (function (e, a) {
                    ...
                    ((a = Va(a, e)),
                      e.isBefore(a)
                        ? (t = Xa(e, a))
                        : (((t = Xa(a, e)).milliseconds = -t.milliseconds), (t.months = -t.months)));
                    return t;
                  })(S(s.from), S(s.to))),
                  ((s = {}).ms = a.milliseconds),
                  (s.M = a.months)),
  ...
  ((n.add = Ne),
    ...
    (n.isSame = function (e, a) {
      ...
      return (
        ...
        ('millisecond' === (a = i(a) || 'millisecond')
          ? this.valueOf() === e.valueOf()
          : ((e = e.valueOf()), this.clone().startOf(a).valueOf() <= e && e <= this.clone().endOf(a).valueOf()))
      );
    }),
        ...
        n !== e &&
          (!a || this._changeInProgress
            ...
            : this._changeInProgress ||
              ((this._changeInProgress = !0), M.updateOffset(this, !0), (this._changeInProgress = null))),
        this
      );
    }),
    (n.utc = function (e) {
    ...
    (n.parseZone = function () {
      ...
      return (
        null != this._tzm
          ...
          : 'string' == typeof this._i && (null != (e = Ga(we, this._i)) ? this.utcOffset(e) : this.utcOffset(0, !0)),
        this
      );
    }),
            ...
            ? ((e = (a._isUTC ? U : S)(a._a)),
              (this._isDSTShifted =
                ...
                0 <
                  (function (e, a, t) {
                    for (
                      var s = Math.min(e.length, a.length), n = Math.abs(e.length - a.length), r = 0, d = 0;
                      d < s;
                      d++
                    )
  ...
  ((r.calendar = function (e, a, t) {
    ...
    (r.months = function (e, a) {
      return e
        ? (F(this._months)
            ? this._months
            : this._months[(this._months.isFormat || Re).test(a) ? 'format' : 'standalone'])[e.month()]
        : F(this._months)
          ? this._months
    ...
    (r.monthsShort = function (e, a) {
      return e
        ? (F(this._monthsShort) ? this._monthsShort : this._monthsShort[Re.test(a) ? 'format' : 'standalone'])[
            e.month()
          ]
        : F(this._monthsShort)
          ? this._monthsShort
  ...
  function Ot(e, a, t, s) {
    var n = $a(e).abs(),
      ...
      r =
        ...
        (_ < t.d && ['dd', _]);
    return (
      ((r = (r = null != t.w ? r || (m <= 1 && ['w']) || (m < t.w && ['ww', m]) : r) ||
        (o <= 1 && ['M']) ||
        (o < t.M && ['MM', o]) ||
        (n <= 1 && ['y']) || ['yy', n])[2] = a),
      (r[3] = 0 < +e),
  ...
  (M.defineLocale('br', {
    ...
    M.defineLocale('ca', {
      ...
      ordinal: function (e, a) {
        return (
          e + ('w' !== a && 'W' !== a ? (1 === e ? 'r' : 2 === e ? 'n' : 3 === e ? 'r' : 4 === e ? 't' : '\xe8') : 'a')
        );
      },
      week: { dow: 1, doy: 4 }
    }));
  ...
  var rn = {
    ...
    hn =
      ...
      M.defineLocale('oc-lnc', {
        months: {
          standalone:
            'geni\xe8r_febri\xe8r_mar\xe7_abril_mai_junh_julhet_agost_setembre_oct\xf2bre_novembre_decembre'.split('_'),
          format:
        ...
        ordinal: function (e, a) {
          return (
            e +
            ('w' !== a && 'W' !== a ? (1 === e ? 'r' : 2 === e ? 'n' : 3 === e ? 'r' : 4 === e ? 't' : '\xe8') : 'a')
          );
        },
        week: { dow: 1, doy: 4 }
      }),
  ...
  function pn(e, a, t) {
    return (
      ...
      { ss: 'secunde', mm: 'minute', hh: 'ore', dd: 'zile', ww: 's\u0103pt\u0103m\xe2ni', MM: 'luni', yy: 'ani' }[t]
    );
  }
  function kn(e, a, t) {
    return 'm' === t
          ...
          return 1 === t.length
            ? 'y' === t && a
              ...
              : s || a
                ? n[0]
                : n[1]
            : ((s = A.correctGrammaticalCase(e, n)), 'yy' === t && a && 'godinu' === s ? e + ' godina' : e + ' ' + s);
        }
      }),
    wn =
      (M.defineLocale('sr', {
