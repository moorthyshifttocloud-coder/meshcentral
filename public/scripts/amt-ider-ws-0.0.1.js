...
var CreateAmtRemoteIder = function () {
  ...
  // Private method
  function debug() {
    if (urlvars && urlvars['idertrace']) {
      console.log(...arguments);
    }
  }

  // Mode Sense
  var IDE_ModeSence_LS120Disk_Page_Array = String.fromCharCode(
    0x00,
    0x26,
    0x31,
    0x80,
  ...
  var IDE_ModeSence_3F_LS120_Array = String.fromCharCode(
    0x00,
    0x5c,
    0x24,
    0x80,
  ...
  var IDE_ModeSence_FloppyDisk_Page_Array = String.fromCharCode(
    0x00,
    0x26,
    0x24,
    0x80,
  ...
  var IDE_ModeSence_3F_Floppy_Array = String.fromCharCode(
    0x00,
    0x5c,
    0x24,
    0x80,
  ...
  var IDE_ModeSence_CD_1A_Array = String.fromCharCode(
    0x00,
    0x12,
    0x01,
    0x80,
  ...
  var IDE_ModeSence_CD_1D_Array = String.fromCharCode(
    0x00,
    0x12,
    0x01,
    0x80,
  ...
  var IDE_ModeSence_CD_2A_Array = String.fromCharCode(
    0x00,
    0x20,
    0x01,
    0x80,
  ...
  var IDE_ModeSence_3F_CD_Array = String.fromCharCode(
    0x00,
    0x28,
    0x01,
    0x80,
  ...
  var IDE_CD_ConfigArrayRandom = String.fromCharCode(
    0x00,
    0x10,
    0x01,
    0x08,
  ...
  // 0x01 constant data
  var IDE_ModeSence_FloppyError_Recovery_Array = String.fromCharCode(
    0x00,
    0x12,
    0x24,
    0x80,
  ...
  var IDE_ModeSence_Ls120Error_Recovery_Array = String.fromCharCode(
    0x00,
    0x12,
    0x31,
    0x80,
  ...
  var IDE_ModeSence_CDError_Recovery_Array = String.fromCharCode(
    0x00,
    0x0e,
    0x01,
    0x80,
  ...
  obj.Start = function () {
    ...
    obj.SendCommand(
      0x40,
      ShortToStrX(obj.rx_timeout) + ShortToStrX(obj.tx_timeout) + ShortToStrX(obj.heartbeat) + IntToStrX(obj.version)
    );
  ...
  obj.SendCommand = function (cmdid, data, completed, dma) {
    ...
    if (cmdid != 0x4b) {
      debug('IDER-SendData', x.length, rstr2hex(x));
    }
  };
  ...
  obj.SendDisableEnableFeatures = function (type, data) {
    ...
    obj.SendCommand(0x48, String.fromCharCode(type) + data);
  };
    ...
    switch (cdb.charCodeAt(0)) {
      ...
      case 0x23: // READ_FORMAT_CAPACITIES (Floppy only)
        ...
        obj.SendDataToHost(
          dev,
          true,
          IntToStr(8) + String.fromCharCode(0x00, 0x00, 0x0b, 0x40, 0x02, 0x00, 0x02, 0x00),
          featureRegister & 1
        );
        break;
      case 0x25: // READ_CAPACITY
        ...
        obj.SendDataToHost(
          deviceFlags,
          true,
          IntToStr(len) + String.fromCharCode(0, 0, dev == 0xb0 ? 0x08 : 0x02, 0),
          featureRegister & 1
        );
        break;
      case 0x28: // READ_10
      ...
      case 0x46: // GET_CONFIGURATION
        ...
        if (buflen == 0) {
          obj.SendDataToHost(dev, true, IntToStr(0x003c) + IntToStr(0x0008), featureRegister & 1);
          return -1;
