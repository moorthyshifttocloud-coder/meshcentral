...
!(function (t, e) {
  ...
  var t = 'ol-ctx-menu',
    ...
    u = { width: 150, scrollAt: 4, eventType: c.CONTEXTMENU, defaultItems: !0 },
    d = [
      {
        text: 'Zoom In',
    ...
    p = {
      ...
      addClass: function (t, e, n) {
        ...
        for (var s = Array.isArray(e) ? e : e.split(/\s+/), o = s.length; o--; )
          i.hasClass(t, s[o]) || i._addClass(t, s[o], n);
      },
      ...
      removeClass: function (t, e, n) {
        ...
        for (var s = Array.isArray(e) ? e : e.split(/\s+/), o = s.length; o--; )
          i.hasClass(t, s[o]) && i._removeClass(t, s[o], n);
      },
      _removeClass: function (t, e, n) {
        var i = this;
        (t.classList ? t.classList.remove(e) : (t.className = t.className.replace(this.classRegex(e), ' ').trim()),
          n &&
            this.isNumeric(n) &&
            window.setTimeout(function () {
              i._addClass(t, e);
      ...
      isElement: function (t) {
        return 'HTMLElement' in window
          ...
          : !!t && 'object' == typeof t && 1 === t.nodeType && !!t.nodeName;
      },
      find: function (t, e, n) {
    ...
    m = function (t) {
      return (
        ...
        (this.items = {}),
        (this.opened = !1),
        (this.submenu = { left: t.options.width - 15 + 'px', lastLeft: '' }),
  ...
  ((m.prototype.init = function (t) {
    ...
    (m.prototype.positionContainer = function (t) {
      var e = this,
        ...
        o = s - t[1],
        a = i - t[0],
        r = { w: this.Base.container.offsetWidth, h: Math.round(this.lineHeight * this.getItemsLength()) },
        l = p.find('li.' + h.submenu + '> div', this.Base.container, !0);
      (a >= r.w
        ? ((this.Base.container.style.right = 'auto'), (this.Base.container.style.left = t[0] + 5 + 'px'))
        : ((this.Base.container.style.left = 'auto'), (this.Base.container.style.right = '15px')),
        o >= r.h
          ? ((this.Base.container.style.bottom = 'auto'), (this.Base.container.style.top = t[1] - 10 + 'px'))
          : ((this.Base.container.style.top = 'auto'), (this.Base.container.style.bottom = 0)),
        p.removeClass(this.Base.container, h.hidden),
        l.length &&
          (a < 2 * r.w ? (this.submenu.lastLeft = '-' + r.w + 'px') : (this.submenu.lastLeft = this.submenu.left),
    ...
    (m.prototype.openMenu = function (t, e) {
      (this.Base.dispatchEvent({ type: c.OPEN, pixel: t, coordinate: e }),
        (this.opened = !0),
        this.positionContainer(t));
    }),
    (m.prototype.closeMenu = function () {
      ((this.opened = !1), p.addClass(this.Base.container, h.hidden), this.Base.dispatchEvent({ type: c.CLOSE }));
    }),
    ...
    (m.prototype.handleEvent = function (t) {
      ...
      ((this.coordinateClicked = this.map.getEventCoordinate(t)),
        ...
        this.Base.dispatchEvent({ type: c.BEFOREOPEN, pixel: this.pixelClicked, coordinate: this.coordinateClicked }),
        this.Base.disabled ||
          (this.Base.options.eventType === c.CONTEXTMENU && (t.stopPropagation(), t.preventDefault()),
    ...
    (m.prototype.setItemListener = function (t, e) {
      var n = this;
      t &&
        'function' == typeof this.items[e].callback &&
        !(function (i) {
          t.addEventListener(
            'click',
            function (t) {
              t.preventDefault();
              var s = { coordinate: n.getCoordinateClicked(), data: n.items[e].data || null };
  ...
  ((f.prototype.createContainer = function (t) {
    ...
    (f.prototype.createMenu = function () {
      var t = [];
      return (
        'items' in this.Base.options
          ? (t = this.Base.options.defaultItems ? this.Base.options.items.concat(d) : this.Base.options.items)
          : this.Base.options.defaultItems && (t = d),
    ...
    (f.prototype.addMenuEntry = function (t) {
      ...
      if (t.items && Array.isArray(t.items)) {
        ((t.classname = t.classname || ''),
          p.contains(h.submenu, t.classname) || (t.classname = t.classname.length ? ' ' + h.submenu : h.submenu));
    ...
    (f.prototype.generateHtmlAndPublish = function (t, e, n) {
      ...
      return (
        'string' == typeof e && '-' === e.trim()
          ? ((i = ['<li id="', r, '" class="', h.separator, '">', '<hr></li>'].join('')),
            (s = p.createFragment(i)),
            (o = [].slice.call(s.childNodes, 0)[0]),
          ...
          : ((e.classname = e.classname || ''),
            ...
            e.icon &&
              ('' === e.classname
                ? (e.classname = h.icon)
                : e.classname.indexOf(h.icon) === -1 && (e.classname += ' ' + h.icon),
              o.setAttribute('style', 'background-image:url(' + e.icon + ')')),
            (o.id = r),
            (o.className = e.classname),
            o.appendChild(s),
            t.firstChild.appendChild(o)),
        (this.Base.Internal.items[r] = {
          id: r,
          submenu: n || 0,
          separator: a,
          callback: e.callback,
        ...
        this.Base.Internal.setItemListener(o, r),
        o
      );
    }),
  ...
  var y = (function (t) {
    function e(e) {
      (void 0 === e && (e = {}),
        p.assert('object' == typeof e, '@param `opt_options` should be object type!'),
        'default_items' in e && (u.defaultItems = e.default_items),
        (this.options = p.mergeOptions(u, e)),
        (this.disabled = !1),
        (this.Internal = new m(this)),
        (this.Html = new f(this)),
        t.call(this, { element: this.container }));
    }
    return (
      t && (e.__proto__ = t),
      ...
      (e.prototype.updatePosition = function (t) {
        (p.assert(Array.isArray(t), '@param `pixel` should be an Array.'),
      ...
      (e.prototype.setMap = function (t) {
        (ol.control.Control.prototype.setMap.call(this, t),
          t ? this.Internal.init(t, this) : this.Internal.removeListeners());
      }),
      e
    );
  })(ol.control.Control);
