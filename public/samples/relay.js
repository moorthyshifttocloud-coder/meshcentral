...
var createMeshConnection = function (connectionId) {
  ...
  obj.connect = function () {
    if (obj.state == 0) {
      ...
      obj.websocket.onopen = function (e) {
      ...
      obj.websocket.onmessage = function (e) {
        ...
        if ((obj.state = 1) && e.data == 'c') {
          ...
          if (obj.onStateChanged) {
            onStateChanged(obj, 2);
          }
          console.log('WebSocket Peer Connection', e);
          obj.send('bob');
        } else {
          if (obj.onData != null) {
            obj.onData(obj, e.data);
          }
        }
      };
      obj.websocket.onclose = function (e) {
        ...
        obj.state = 0;
        if (obj.onStateChanged) {
          onStateChanged(obj, 0);
        }
      };
      obj.websocket.onerror = function (e) {
        console.log('WebSocket Error', e);
      };
      obj.state = 1;
      if (obj.onStateChanged) {
        onStateChanged(obj, 1);
      }
    }
    return obj;
  };
  ...
  obj.send = function (data) {
    if (obj.state == 2 && obj.websocket != null) {
