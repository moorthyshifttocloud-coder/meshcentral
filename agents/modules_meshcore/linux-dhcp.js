...
// DHCP Information
if (Function.prototype.internal == null) {
  Object.defineProperty(Function.prototype, 'internal', {
    get: function () {
      return this;
    }
  });
...
function createPacket(messageType, data) {
  ...
  switch (messageType) {
    case 0x08:
      if (data.ciaddress == null) {
        throw 'ciadress missing';
      }
      if (data.chaddress == null) {
        throw 'chaddress missing';
      }
    ...
    for (i = 0; i < f[interfaceName].length; ++i) {
      if (f[interfaceName][i].family == 'IPv4' && f[interfaceName][i].mac != '00:00:00:00:00:00') {
        try {
          ...
          _hide(
            raw(f[interfaceName][i].address, port, b, function infoHandler(msg) {
              try {
                var res = parseDHCP(msg);
                if (
                  res.chaddr.toUpperCase() == this.hwaddr.toUpperCase() &&
                  res.options != null &&
                  res.options.lease != null
                ) {
                  ...
                  }, this.socket); // Works around bug in older dgram.js
                  this._res(res);
                }
              } catch (z) {}
            })
