...
function parseLine(entry) {
  ...
  if (test == null) {
    ...
    if (test != null) {
      ...
      if (file != null) {
        this.results.peek().f = file[0].trim();
      }
      if (line != null) {
        this.results.peek().l = line[0];
      }
      if (fn != null) {
        this.results.peek().fn = fn[0];
      }
    } else {
      ...
      if (test != null) {
        ...
        if (test != null) {
          if (this.results.peek().sx == null) {
            this.results.peek().sx = [];
          }
...
function readLogEx(path) {
  ...
  try {
    ...
    s.resume();
    if (s.buffered != null) {
      readLog_data.call(s, s.buffered);
      s.buffered = null;
    }
