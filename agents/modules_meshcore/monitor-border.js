...
function linux_monitorborder() {
    ...
    if (!this._isUnity) {
      for (var i = 0; i < this.displays.length; ++i) {
        if (this.displays[i].GC1 && this.displays[i].rootWindow) {
          ...
          self._info._X11.XDrawLine(
            self.displays[i].display,
            self.displays[i].rootWindow,
            self.displays[i].GC1,
            0,
            0,
            self.displays[i].right,
            0
          );
          self._info._X11.XDrawLine(
            self.displays[i].display,
    ...
    this._info.getInfo().then(function (mon) {
      ...
      for (var i = 0; i < mon.length; ++i) {
        ...
        if (self._isUnity) {
          ...
          // Top
          mon[i].window_top = self._info._X11.XCreateSimpleWindow(
            mon[i].display,
            mon[i].rootWindow,
            0,
            0,
          ...
          // Right
          mon[i].window_right = self._info._X11.XCreateSimpleWindow(
            mon[i].display,
            mon[i].rootWindow,
            mon[i].right - 5,
            0,
          ...
          // Left
          mon[i].window_left = self._info._X11.XCreateSimpleWindow(
            mon[i].display,
            mon[i].rootWindow,
            0,
            0,
          ...
          // Bottom
          mon[i].window_bottom = self._info._X11.XCreateSimpleWindow(
            mon[i].display,
            mon[i].rootWindow,
            0,
            mon[i].bottom - 5,
          ...
          self._info._X11.XSetForeground(
            mon[i].display,
            mon[i].GC1,
            self._info._X11.XWhitePixel(mon[i].display, mon[i].screenId).Val
          ); // White
  ...
  this.timeoutHandler = function () {
    for (var i = 0; i < self.displays.length; ++i) {
      ...
      self._info._X11.XSetForeground(
        self.displays[i].display,
        self.displays[i].GC1,
        self.displays[i].borderState == 0 || self.displays[i].borderState == 4 ? 0xffff00 : 0xff0000
      );
      self._info._X11.XDrawLine(
        self.displays[i].display,
        self.displays[i].rootWindow,
        ...
        0,
        0,
        self.displays[i].right / 2,
        0
      );
      self._info._X11.XSetForeground(
        self.displays[i].display,
        self.displays[i].GC1,
        self.displays[i].borderState == 1 || self.displays[i].borderState == 5 ? 0xffff00 : 0xff0000
      );
      self._info._X11.XDrawLine(
        self.displays[i].display,
        self.displays[i].rootWindow,
      ...
      self._info._X11.XSetForeground(
        self.displays[i].display,
        self.displays[i].GC1,
        self.displays[i].borderState == 2 || self.displays[i].borderState == 6 ? 0xffff00 : 0xff0000
      );
      self._info._X11.XDrawLine(
        self.displays[i].display,
        self.displays[i].rootWindow,
        ...
        0,
        self.displays[i].right,
        self.displays[i].bottom / 2
      );
      self._info._X11.XSetForeground(
        self.displays[i].display,
        self.displays[i].GC1,
        self.displays[i].borderState == 3 || self.displays[i].borderState == 7 ? 0xffff00 : 0xff0000
      );
      self._info._X11.XDrawLine(
        self.displays[i].display,
        self.displays[i].rootWindow,
      ...
      self._info._X11.XSetForeground(
        self.displays[i].display,
        self.displays[i].GC1,
        self.displays[i].borderState == 5 || self.displays[i].borderState == 1 ? 0xffff00 : 0xff0000
      );
      self._info._X11.XDrawLine(
        self.displays[i].display,
        self.displays[i].rootWindow,
      ...
      self._info._X11.XSetForeground(
        self.displays[i].display,
        self.displays[i].GC1,
        self.displays[i].borderState == 4 || self.displays[i].borderState == 0 ? 0xffff00 : 0xff0000
      );
      self._info._X11.XDrawLine(
        self.displays[i].display,
        self.displays[i].rootWindow,
      ...
      self._info._X11.XSetForeground(
        self.displays[i].display,
        self.displays[i].GC1,
        self.displays[i].borderState == 7 || self.displays[i].borderState == 3 ? 0xffff00 : 0xff0000
      );
      self._info._X11.XDrawLine(
        self.displays[i].display,
        self.displays[i].rootWindow,
      ...
      self._info._X11.XSetForeground(
        self.displays[i].display,
        self.displays[i].GC1,
        self.displays[i].borderState == 6 || self.displays[i].borderState == 2 ? 0xffff00 : 0xff0000
      );
      self._info._X11.XDrawLine(
        self.displays[i].display,
        self.displays[i].rootWindow,
  ...
  this.unity_drawBorder = function unity_drawBorder() {
    for (var i = 0; i < self.displays.length; ++i) {
      ...
      self._info._X11.XSetForeground(
        self.displays[i].display,
        self.displays[i].window_top.gc,
        self.displays[i].borderState == 0 || self.displays[i].borderState == 4 ? 0xffff00 : 0xff0000
      );
      self._info._X11.XDrawLine(
        self.displays[i].display,
        self.displays[i].window_top,
        self.displays[i].window_top.gc,
        0,
        0,
        self.displays[i].right / 2,
      ...
      self._info._X11.XSetForeground(
        self.displays[i].display,
        self.displays[i].window_right.gc,
        self.displays[i].borderState == 2 || self.displays[i].borderState == 6 ? 0xffff00 : 0xff0000
      );
      self._info._X11.XDrawLine(
        self.displays[i].display,
        self.displays[i].window_right,
        self.displays[i].window_right.gc,
        0,
        0,
        0,
      ...
      self._info._X11.XSetForeground(
        self.displays[i].display,
        self.displays[i].window_bottom.gc,
        self.displays[i].borderState == 5 || self.displays[i].borderState == 1 ? 0xffff00 : 0xff0000
      );
      self._info._X11.XDrawLine(
        self.displays[i].display,
        self.displays[i].window_bottom,
        self.displays[i].window_bottom.gc,
        0,
        0,
        self.displays[i].right / 2,
      ...
      self._info._X11.XSetForeground(
        self.displays[i].display,
        self.displays[i].window_left.gc,
        self.displays[i].borderState == 7 || self.displays[i].borderState == 3 ? 0xffff00 : 0xff0000
      );
      self._info._X11.XDrawLine(
        self.displays[i].display,
        self.displays[i].window_left,
        self.displays[i].window_left.gc,
        0,
        0,
        0,
