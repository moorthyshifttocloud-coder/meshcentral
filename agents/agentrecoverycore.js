                ...
                tunnel.on('upgrade', function (response, s, head) {
                  ...
                  s.on('end', function () {
                    ...
                    if (this.httprequest.uploadFile) {
                      ...
                      this.httprequest.uploadFile = undefined;
                    }
                    if (this.httprequest.downloadFile) {
                      fs.closeSync(this.httprequest.downloadFile);
                      this.httprequest.downloadFile = undefined;
                    }
                  ...
                  s.on('data', function (data) {
                    ...
                    if (this.httprequest.uploadFile) {
                      ...
                      this.write(
                        new Buffer(JSON.stringify({ action: 'uploadack', reqid: this.httprequest.uploadFileid }))
                      ); // Ask for more data
                      return;
                    }
                    ...
                    if (this.httprequest.state == 0) {
                      ...
                      if (data == 'c') {
                        ...
                        sendConsoleText(
                          'Tunnel #' + this.httprequest.index + ' now active',
                          this.httprequest.sessionid
                        );
                      }
                    } else {
                      // Handle tunnel data
                        ...
                        switch (cmd.action) {
                          ...
                          case 'upload': {
                            ...
                            try {
                              ...
                              this.write(new Buffer(JSON.stringify({ action: 'uploaderror', reqid: cmd.reqid })));
                              break;
                            }
