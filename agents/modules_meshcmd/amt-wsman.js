...
function WsmanStackCreateService(/*CreateWsmanComm, host, port, user, pass, tls, extra*/) {
  ...
  if (arguments.length == 1 && typeof (arguments[0] == 'object')) {
    ...
    if (CreateWsmanComm) {
      obj.comm = new CreateWsmanComm(arguments[0]);
    }
  } else {
    var CreateWsmanComm = arguments[0];
    if (CreateWsmanComm) {
      obj.comm = new CreateWsmanComm(
        arguments[1],
        arguments[2],
        arguments[3],
        arguments[4],
  ...
  obj.PerformAjax = function PerformAjax(postdata, callback, tag, pri, namespaces) {
    ...
    obj.comm.PerformAjax(
      ...
      function (data, status, tag) {
        if (status != 200) {
          callback(obj, null, data != null ? data : { Header: { HttpError: status } }, status, tag);
          return;
        }
  ...
  obj.CancelAllQueries = function CancelAllQueries(s) {
  ...
  obj.ExecSubscribe = function ExecSubscribe(resuri, delivery, url, callback, tag, pri, selectors, opaque, user, pass) {
    ...
    if (user != null && pass != null) {
      digest =
        '<t:IssuedTokens xmlns:t="http://schemas.xmlsoap.org/ws/2005/02/trust" xmlns:se="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd"><t:RequestSecurityTokenResponse><t:TokenType>http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#UsernameToken</t:TokenType><t:RequestedSecurityToken><se:UsernameToken><se:Username>' +
        user +
      ...
      digest2 = '<w:Auth Profile="http://schemas.dmtf.org/wbem/wsman/1/wsman/secprofile/http/digest"/>';
    }
    if (opaque != null) {
      opaque = '<a:ReferenceParameters><m:arg>' + opaque + '</m:arg></a:ReferenceParameters>';
    }
    if (delivery == 'PushWithAck') {
      delivery = 'dmtf.org/wbem/wsman/1/wsman/PushWithAck';
    } else if (delivery == 'Push') {
      delivery = 'xmlsoap.org/ws/2004/08/eventing/DeliveryModes/Push';
    }
    var data =
